...
! function(e) {
    ...
    function o(t) {
        ...
        o.rel = "stylesheet", o.type = "text/css", o.href = "//cdn.wanted5games.com/api/game.css", n.appendChild(o);
        var a = document.createElement("div");
        a.setAttribute("id", "cg-background");
        var i = document.createElement("div");
        if (i.setAttribute("id", "cg-splashscreen"), t.image && t.background && (a.setAttribute("style", "background: " + t.background + ";"), i.setAttribute("style", "background:" + t.background + " url('" + t.image + "') center no-repeat;background-size:80%;")), document.body.appendChild(a), document.body.appendChild(i), i.addEventListener("mousedown", function(e) {
                e.stopPropagation()
            }), i.addEventListener("mouseup", function(e) {
                e.stopPropagation()
            }), i.addEventListener("click", function(n) {
                n.stopPropagation(), h.links.active() && t.link && e.open(t.link), h.links.active() && !t.link && e.open("http://wanted5games.com/play?utm_source=" + t.distribution + "&utm_medium=onlinegame&utm_content=splash&utm_campaign=html5game")
            }), t.sound) {
            var s = document.createElement("audio");
            s.setAttribute("id", "cg-sound"), s.setAttribute("autoplay", !0);
            var r = document.createElement("source");
            r.setAttribute("src", t.sound), r.setAttribute("type", "audio/mpeg"), s.appendChild(r), document.body.appendChild(s)
        }
        i.addEventListener("animationend", function() {
            a.setAttribute("style", "display:none;"), i.setAttribute("style", "display:none;")
        })
    }
        ...
        h = {
            ...
            gameOver: function() {
                if (t("Function gameOver called."), r("GAME_OVER"), 156 == u.portal && n("pp_account") && n("pp_game")) {
                    ...
                    e.open("GET", "https://www.pointsprizes.com/api/callbacks/cloudgames?account=" + n("pp_account") + "&game=" + n("pp_game") + "&event=game_over"), e.send()
                }
                var o = a();
                if (o) {
