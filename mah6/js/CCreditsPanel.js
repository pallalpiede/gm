function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _oMsgText = new createjs.Text("Presented by", "36px " + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
 ...
 /*       oSprite = s_oSpriteLibrary.getSprite('logo_ctl');
        ...
        _oLink = new createjs.Text("FreeGames.org", "36px " + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        _oLink.textAlign = "center";
        _oLink.textBaseline = "alphabetic";
	_oLink.x = CANVAS_WIDTH_HALF;
        _oLink.y = CANVAS_HEIGHT_HALF + 50;
    ...
    this._onLogoButRelease = function(){
        window.open("https://freegames.org/","_blank");
    };
