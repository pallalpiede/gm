!function(e, t) {
    ...
    d.extend = d.fn.extend = function() {
        ...
        a--); u > a; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = s[t],
                    s !== (r = e[t]) && (l && r && (d.isPlainObject(r) || (i = d.isArray(r))) ? (i ? (i = !1,
                    o = n && d.isArray(n) ? n : []) : o = n && d.isPlainObject(n) ? n : {},
                    s[t] = d.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }
    ,
    d.extend({
        ...
        globalEval: function(e) {
            var t, n = eval;
            (e = d.trim(e)) && (1 === e.indexOf("use strict") ? ((t = f.createElement("script")).text = e,
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (y(Object(e)) ? d.merge(n, "string" == typeof e ? [e] : e) : o.call(n, e)),
            n
        },
        ...
        proxy: function(e, t) {
            ...
            t = e,
            e = n),
            d.isFunction(e) ? (i = r.call(arguments, 2),
            (o = function() {
    ...
    var x = function(e) {
        var t, n, r, i, o, s, a, u, l, c, f, p, d, h, g, m, v, y, x, b = "sizzle" + -new Date, w = e.document, T = 0, C = 0, N = oe(), k = oe(), E = oe(), S = function(e, t) {
            return e === t && (f = !0),
            0
        }, j = "undefined", D = 1 << 31, A = {}.hasOwnProperty, L = [], q = L.pop, H = L.push, O = L.push, F = L.slice, P = L.indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , M = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", W = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", $ = W.replace("w", "w#"), B = "\\[" + R + "*(" + W + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + $ + "))|)" + R + "*\\]", I = ":(" + W + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + B + ")*)|.*)\\)|)", _ = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), z = new RegExp("^" + R + "*," + R + "*"), X = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), U = new RegExp("=" + R + "*([^\\]'\"]*?)" + R + "*\\]","g"), V = new RegExp(I), Y = new RegExp("^" + $ + "$"), G = {
            ID: new RegExp("^#(" + W + ")"),
            CLASS: new RegExp("^\\.(" + W + ")"),
        ...
        function ie(e, t, r, i) {
            ...
            if (g && !i) {
                if (o = Z.exec(e))
                    if (l = o[1]) {
                        ...
                        if (o[2])
                            ...
                            r;
                        if ((l = o[3]) && n.getElementsByClassName && t.getElementsByClassName)
                ...
                if (n.qsa && (!m || !m.test(e))) {
                    ...
                    if (C)
                        try {
                            return O.apply(r, T.querySelectorAll(C)),
                            r
                        } catch (e) {} finally {
        ...
        p = ie.setDocument = function(e) {
            var t, i = e ? e.ownerDocument || e : w, s = i.defaultView;
            ...
            v = [],
            m = [],
            (n.qsa = K.test(i.querySelectorAll)) && (ae(function(e) {
                e.innerHTML = "<select msallowclip=''><option selected=''></option></select>",
                e.querySelectorAll("[msallowclip^='']").length && m.push("[*^$]=" + R + "*(?:''|\"\")"),
            ...
            : function(e, t) {
                if (e === t)
                    return f = !0,
                    0;
                var n, r = 0, o = e.parentNode, s = t.parentNode, a = [e], u = [t];
                if (!o || !s)
                    return e === i ? -1 : t === i ? 1 : o ? -1 : s ? 1 : c ? P.call(c, e) - P.call(c, t) : 0;
                if (o === s)
                    return le(e, t);
        ...
        (r = ie.selectors = {
            ...
            pseudos: {
                ...
                lang: se(function(e) {
                    return Y.test(e || "") || ie.error("unsupported lang: " + e),
            ...
            se(function(o, s, a, u) {
                var l, c, f, p = [], d = [], h = s.length, g = o || function(e, t, n) {
                    for (var r = 0, i = t.length; i > r; r++)
                        ie(e, t[r], n);
                    return n
                }(t || "*", a.nodeType ? [a] : a, []), m = !e || !o && t ? g : ye(g, p, e, a, u), v = n ? i || (o ? e : h || r) ? [] : s : m;
                if (n && n(m, v, a, u),
                r)
                    for (l = ye(v, d),
                    r(l, [], a, u),
                ...
                if (o) {
                    if (i || e) {
                        ...
                        for (c = v.length; c--; )
                            (f = v[c]) && (l = i ? P.call(o, f) : p[c]) > -1 && (o[l] = !(s[l] = f))
                    }
                } else
        ...
        u = ie.select = function(e, t, i, o) {
            ...
            return (d || a(e, h))(o, t, !g, i, ee.test(e) && de(t.parentNode) || t),
            i
        }
        ,
    ...
    d.fn.extend({
        find: function(e) {
            ...
            for (t = 0; n > t; t++)
                d.find(e, i[t], r);
            return (r = this.pushStack(n > 1 ? d.unique(r) : r)).selector = this.selector ? this.selector + " " + e : e,
            r
        },
        filter: function(e) {
    ...
    (d.fn.init = function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                ...
                d.merge(this, d.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : f, !0)),
    ...
    d.Callbacks = function(e) {
        var t, n, r, i, o, s, a = [], u = !(e = "string" == typeof e ? L[e] || function(e) {
            var t = L[e] = {};
            return d.each(e.match(A) || [], function(e, n) {
                t[n] = !0
            }),
            t
        }(e) : d.extend({}, e)).once && [], l = function(f) {
            for (t = e.memory && f,
            n = !0,
            s = i || 0,
            i = 0,
    ...
    d.extend({
        ...
        when: function(e) {
            var t, n, i, o = 0, s = r.call(arguments), a = s.length, u = 1 !== a || e && d.isFunction(e.promise) ? a : 0, l = 1 === u ? e : d.Deferred(), c = function(e, n, i) {
                return function(o) {
                    n[e] = this,
            ...
            if (a > 1)
                ...
                n = new Array(a),
                i = new Array(a); a > o; o++)
                    s[o] && d.isFunction(s[o].promise) ? s[o].promise().done(c(o, i, s)).fail(l.reject).progress(c(o, n, t)) : --u;
    ...
    d.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --d.readyWait > 0 || (D.resolveWith(f, [d]),
            d.fn.triggerHandler && (d(f).triggerHandler("ready"),
            d(f).off("ready"))))
        }
    }),
    d.ready.promise = function(t) {
        return D || (D = d.Deferred(),
        "complete" === f.readyState ? setTimeout(d.ready) : (f.addEventListener("DOMContentLoaded", q, !1),
    ...
    O.prototype = {
        ...
        access: function(e, t, n) {
            var r;
            return void 0 === t || t && "string" == typeof t && void 0 === n ? void 0 !== (r = this.get(e, t)) ? r : this.get(e, d.camelCase(t)) : (this.set(e, t, n),
            void 0 !== n ? n : t)
        },
        remove: function(e, t) {
            ...
            if (void 0 === t)
                ...
                d.isArray(t) ? r = t.concat(t.map(d.camelCase)) : (i = d.camelCase(t),
                t in s ? r = [t, i] : r = (r = i)in s ? [r] : r.match(A) || []),
                n = r.length;
                for (; n--; )
                    delete s[r[n]]
            }
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !F.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && (0 === (r = s[n].name).indexOf("data-") && (r = d.camelCase(r.slice(5)),
                        W(o, r, i[r])));
    ...
    d.extend({
        queue: function(e, t, n) {
            ...
            r = F.get(e, t),
            n && (!r || d.isArray(n) ? r = F.access(e, t, d.makeArray(n)) : r.push(n)),
            r || []) : void 0
        },
    ...
    d.fn.extend({
        ...
        promise: function(e, t) {
            var n, r = 1, i = d.Deferred(), o = this, s = this.length, a = function() {
                --r || i.resolveWith(o, [o])
            };
    ...
    d.event = {
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(A) || [""]).length; l--; )
                    ...
                    h) {
                        ...
                        s && !p.length && (f.teardown && !1 !== f.teardown.call(e, g, v.handle) || d.removeEvent(e, h, v.handle),
                        delete u[h])
                    } else
                        for (h in u)
                            d.event.remove(e, h + t[l], n, r, !0);
                d.isEmptyObject(u) && (delete v.handle,
                F.remove(e, "events"))
            }
        },
        trigger: function(t, n, r, i) {
            var o, s, a, u, c, p, h, g = [r || f], m = l.call(t, "type") ? t.type : t, v = l.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = r = r || f,
            3 !== r.nodeType && 8 !== r.nodeType && !V.test(m + d.event.triggered) && (m.indexOf(".") >= 0 && (m = (v = m.split(".")).shift(),
            v.sort()),
            c = m.indexOf(":") < 0 && "on" + m,
            (t = t[d.expando] ? t : new d.Event(m,"object" == typeof t && t)).isTrigger = i ? 2 : 3,
            t.namespace = v.join("."),
            ...
            i || !h.trigger || !1 !== h.trigger.apply(r, n))) {
                ...
                for (o = 0; (s = g[o++]) && !t.isPropagationStopped(); )
                    ...
                    (p = (F.get(s, "events") || {})[t.type] && F.get(s, "handle")) && p.apply(s, n),
                    (p = c && s[c]) && p.apply && d.acceptData(s) && (t.result = p.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = m,
                i || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(g.pop(), n) || !d.acceptData(r) || c && d.isFunction(r[m]) && !d.isWindow(r) && ((a = r[c]) && (r[c] = null),
                d.event.triggered = m,
                r[m](),
        ...
        dispatch: function(e) {
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
                for (a = d.event.handlers.call(this, e, l),
                t = 0; (o = a[t++]) && !e.isPropagationStopped(); )
                    ...
                    n = 0; (s = o.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        ...
                        e.data = s.data,
                        void 0 !== (i = ((d.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, u)) && !1 === (e.result = i) && (e.preventDefault(),
                        e.stopPropagation()));
            ...
            if (a && u.nodeType && (!e.button || "click" !== e.type))
                for (; u !== this; u = u.parentNode || this)
                    if (!0 !== u.disabled || "click" !== e.type) {
                        for (r = [],
                        n = 0; a > n; n++)
                            void 0 === r[i = (o = t[n]).selector + " "] && (r[i] = o.needsContext ? d(i, this).index(u) >= 0 : d.find(i, this, null, [u]).length),
                            r[i] && r.push(o);
                        r.length && s.push({
                            elem: u,
                            handlers: r
    ...
    c.focusinBubbles || d.each({
        ...
        d.event.special[t] = {
            ...
            teardown: function() {
                var r = this.ownerDocument || this
                  , i = F.access(r, t) - 1;
                i ? F.access(r, t, i) : (r.removeEventListener(e, n, !0),
                F.remove(r, t))
            }
        }
    }),
    ...
    d.extend({
        clone: function(e, t, n) {
            var r, i, o, s, a = e.cloneNode(!0), u = d.contains(e.ownerDocument, e);
            if (!(c.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || d.isXMLDoc(e)))
                for (s = pe(a),
                r = 0,
                i = (o = pe(e)).length; i > r; r++)
                    de(o[r], s[r]);
            if (t)
                if (n)
                    for (o = o || pe(e),
                    ...
                    fe(e, a);
            return (s = pe(a, "script")).length > 0 && ce(s, !u && pe(e, "script")),
            a
        },
        buildFragment: function(e, t, n, r) {
            ...
            for (c.textContent = "",
            p = 0; i = f[p++]; )
                if ((!r || -1 === d.inArray(i, r)) && (u = d.contains(i.ownerDocument, i),
    ...
    d.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = e ? d.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                ...
                n.parentNode && (t && d.contains(n.ownerDocument, n) && ce(pe(n, "script")),
                n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (d.cleanData(pe(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return H(this, function(e) {
                ...
                if ("string" == typeof e && !te.test(e) && !se[(Z.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; r > n; n++)
                            1 === (t = this[n] || {}).nodeType && (d.cleanData(pe(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        domManip: function(e, t) {
            e = i.apply([], e);
            var n, r, o, s, a, u, l = 0, f = this.length, p = this, h = f - 1, g = e[0], m = d.isFunction(g);
            ...
            if (f && (r = (n = d.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild,
            1 === n.childNodes.length && (n = r),
            r)) {
                for (s = (o = d.map(pe(n, "script"), ue)).length; f > l; l++)
                    a = n,
                    l !== h && (a = d.clone(a, !0, !0),
                    s && d.merge(o, pe(a, "script"))),
                    t.call(this[l], a, l);
                if (s)
                    ...
                    l = 0; s > l; l++)
                        a = o[l],
                        re.test(a.type || "") && !F.access(a, "globalEval") && d.contains(u, a) && (a.src ? d._evalUrl && d._evalUrl(a.src) : d.globalEval(a.textContent.replace(oe, "")))
            }
            return this
        }
    }),
    ...
    function ve(e) {
        var t = f
          , n = ge[e];
        return n || ("none" !== (n = me(e, t)) && n || ((t = (he = (he || d("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(),
        t.close(),
        n = me(e, t),
        he.detach()),
        ge[e] = n),
    ...
    function we(e, t, n) {
        ...
        n && ("" !== s || d.contains(e.ownerDocument, e) || (s = d.style(e, t)),
        xe.test(s) && ye.test(t) && (r = a.width,
        i = a.minWidth,
        o = a.maxWidth,
    ...
    function Le(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            ...
            r ? ("content" === n && (s -= d.css(e, "padding" + B[o], !0, i)),
            "margin" !== n && (s -= d.css(e, "border" + B[o] + "Width", !0, i))) : (s += d.css(e, "padding" + B[o], !0, i),
            "padding" !== n && (s += d.css(e, "border" + B[o] + "Width", !0, i)));
        return s
    }
    function qe(e, t, n) {
        var r = !0
        ...
        if (0 >= i || null == i) {
            if ((0 > (i = we(e, t, o)) || null == i) && (i = e.style[t]),
            xe.test(i))
                return i;
    ...
    function He(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
            ...
            "" === r.style.display && I(r) && (o[s] = F.access(r, "olddisplay", ve(r.nodeName)))) : (i = I(r),
            "none" === n && i || F.set(r, "olddisplay", i ? n : d.css(r, "display"))));
        for (s = 0; a > s; s++)
    ...
    d.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = d.camelCase(t), u = e.style;
                return t = d.cssProps[a] || (d.cssProps[a] = De(u, a)),
                s = d.cssHooks[t] || d.cssHooks[a],
                void 0 === n ? s && "get"in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : ("string" === (o = typeof n) && (i = ke.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(d.css(e, t)),
                o = "number"),
                void (null != n && n == n && ("number" !== o || d.cssNumber[a] || (n += "px"),
        ...
        css: function(e, t, n, r) {
            ...
            return t = d.cssProps[a] || (d.cssProps[a] = De(e.style, a)),
            (s = d.cssHooks[t] || d.cssHooks[a]) && "get"in s && (i = s.get(e, !0, n)),
            void 0 === i && (i = we(e, t, r)),
            "normal" === i && t in Se && (i = Se[t]),
            "" === n || n ? (o = parseFloat(i),
            !0 === n || d.isNumeric(o) ? o || 0 : i) : i
        }
    }),
    ...
    Oe.prototype = {
        ...
        run: function(e) {
            ...
            return this.pos = t = this.options.duration ? d.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e,
    ...
    d.fx.step = {};
    var Fe, Pe, Me = /^(?:toggle|show|hide)$/, Re = new RegExp("^(?:([+-])=|)(" + $ + ")([a-z%]*)$","i"), We = /queueHooks$/, $e = [function(e, t, n) {
        var r, i, o, s, a, u, l, c = this, f = {}, p = e.style, h = e.nodeType && I(e), g = F.get(e, "fxshow");
        for (r in n.queue || (null == (a = d._queueHooks(e, "fx")).unqueued && (a.unqueued = 0,
        u = a.empty.fire,
        ...
        l = d.css(e, "display"),
        "inline" === ("none" === l ? F.get(e, "olddisplay") || ve(e.nodeName) : l) && "none" === d.css(e, "float") && (p.display = "inline-block")),
        ...
        if (d.isEmptyObject(f))
            ...
            for (r in g ? "hidden"in g && (h = g.hidden) : g = F.access(e, "fxshow", {}),
            o && (g.hidden = !h),
            h ? d(e).show() : c.done(function() {
                d(e).hide()
            }),
            c.done(function() {
                var t;
                for (t in F.remove(e, "fxshow"),
                f)
                    d.style(e, t, f[t])
            }),
            f)
    ...
    function Xe(e, t, n) {
        var r, i, o = 0, s = $e.length, a = d.Deferred().always(function() {
            delete u.elem
        }), u = function() {
            if (i)
                return !1;
    ...
    d.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = F.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = d.timers, s = r ? r.length : 0;
                for (n.finish = !0,
                d.queue(this, e, []),
    ...
    d.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === z ? d.prop(e, t, n) : (1 === o && d.isXMLDoc(e) || (t = t.toLowerCase(),
                r = d.attrHooks[t] || (d.expr.match.bool.test(t) ? Ue : void 0)),
                void 0 === n ? r && "get"in r && null !== (i = r.get(e, t)) ? i : null == (i = d.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set"in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""),
                n) : void d.removeAttr(e, t))
        },
        ...
        toggleClass: function(e, t) {
            ...
            : function() {
                if ("string" === n)
                    ...
                    (n === z || "boolean" === n) && (this.className && F.set(this, "__className__", this.className),
                    this.className = this.className || !1 === e ? "" : F.get(this, "__className__") || "")
            }
            )
        },
        hasClass: function(e) {
    ...
    ;
    var Ze, et, tt = /#.*$/, nt = /([?&])_=[^&]*/, rt = /^(.*?):[ \t]*([^\r\n]*)$/gm, it = /^(?:GET|HEAD)$/, ot = /^\/\//, st = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, at = {}, ut = {}, lt = "*/".concat("*");
    try {
        et = location.href
    } catch (e) {
        (et = f.createElement("a")).href = "",
        et = et.href
    }
    function ct(e) {
        return function(t, n) {
    ...
    d.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var n, r, i, o, s, a, u, l, c = d.ajaxSetup({}, t), f = c.context || c, p = c.context && (f.nodeType || f.jquery) ? d(f) : d.event, h = d.Deferred(), g = d.Callbacks("once memory"), m = c.statusCode || {}, v = {}, y = {}, x = 0, b = "canceled", w = {
                readyState: 0,
            ...
            null == c.crossDomain && (a = st.exec(c.url.toLowerCase()),
            c.crossDomain = !(!a || a[1] === Ze[1] && a[2] === Ze[2] && (a[3] || ("http:" === a[1] ? "80" : "443")) === (Ze[3] || ("http:" === Ze[1] ? "80" : "443")))),
            c.data && c.processData && "string" != typeof c.data && (c.data = d.param(c.data, c.traditional)),
            ft(at, c, t, w),
            2 === x)
                return w;
            for (l in (u = c.global) && 0 == d.active++ && d.event.trigger("ajaxStart"),
            c.type = c.type.toUpperCase(),
            c.hasContent = !it.test(c.type),
            r = c.url,
            c.hasContent || (c.data && (r = c.url += (Ke.test(r) ? "&" : "?") + c.data,
            delete c.data),
            !1 === c.cache && (c.url = nt.test(r) ? r.replace(nt, "$1_=" + Je++) : r + (Ke.test(r) ? "&" : "?") + "_=" + Je++)),
            c.ifModified && (d.lastModified[r] && w.setRequestHeader("If-Modified-Since", d.lastModified[r]),
            ...
            function T(e, t, o, a) {
                ...
                l ? (c.ifModified && ((T = w.getResponseHeader("Last-Modified")) && (d.lastModified[r] = T),
            ...
            send: function(n, r) {
                ...
                t = function(e) {
                    return function() {
                        ...
                        "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(wt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                            text: o.responseText
    ...
    d.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = d.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
        a ? t[a] = t[a].replace(Nt, "$1" + i) : !1 !== t.jsonp && (t.url += (Ke.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
        t.converters["script json"] = function() {
            return s || d.error(i + " was not called"),
            s[0]
        }
        ,
        t.dataTypes[0] = "json",
    ...
    d.parseHTML = function(e, t, n) {
        ...
        var r = w.exec(e)
          , i = !n && [];
        return r ? [t.createElement(r[1])] : (r = d.buildFragment([e], t, i),
    ...
    d.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, s, a, u, l = d.css(e, "position"), c = d(e), f = {};
    ...
    d.fn.extend({
        offset: function(e) {
            ...
            d.contains(t, r) ? (typeof r.getBoundingClientRect !== z && (i = r.getBoundingClientRect()),
            n = St(o),
            {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || Et; e && !d.nodeName(e, "html") && "static" === d.css(e, "position"); )
                    e = e.offsetParent;
                return e || Et
            })
        }
    ...
    d.each(["top", "left"], function(e, t) {
        d.cssHooks[t] = Te(c.pixelPosition, function(e, n) {
            return n ? (n = we(e, t),
            xe.test(n) ? d(e).position()[t] + "px" : n) : void 0
        })
    }),
    d.each({
        Height: "height",
        ...
        d.each({
            ...
            d.fn[r] = function(r, i) {
                ...
                return H(this, function(t, n, r) {
                    ...
                    Math.max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : void 0 === r ? d.css(t, n, s) : d.style(t, n, r, s)
                }, t, o ? r : void 0, o, null)
            }
        })
    }),
...
function() {
    ...
    ,
    cr.vector2 = t,
    cr.segments_intersect = function(t, e, i, r, n, s, a, o) {
        var h, c, l, u, p, d, f, g;
        if (t < i ? (c = t,
        h = i) : (c = i,
        h = t),
    ...
    i.prototype.contains_pt = function(t, e) {
        var i, r, n, s = this.tlx, a = this.tly, o = this.trx - s, h = this.try_ - a, c = this.brx - s, l = this.bry - a, u = t - s, p = e - a, d = c * c + l * l, f = c * u + l * p, g = 1 / ((i = o * o + h * h) * d - (r = o * c + h * l) * r), y = (d * (n = o * u + h * p) - r * f) * g, m = (i * f - r * n) * g;
        return y >= 0 && m > 0 && y + m < 1 || (m = ((i = (o = this.blx - s) * o + (h = this.bly - a) * h) * f - (r = o * c + h * l) * (n = o * u + h * p)) * (g = 1 / (i * d - r * r)),
        (y = (d * n - r * f) * g) >= 0 && m > 0 && y + m < 1)
    }
    ,
    ...
    i.prototype.intersects_segment = function(t, e, i, r) {
        if (this.contains_pt(t, e) || this.contains_pt(i, r))
            return !0;
        var n, s, a, o, h;
        for (h = 0; h < 4; h++)
            if (n = this.at(h, !0),
            ...
            a = this.at(h + 1, !0),
            o = this.at(h + 1, !1),
            cr.segments_intersect(t, e, i, r, n, s, a, o))
                return !0;
        return !1
    }
    ,
    i.prototype.intersects_quad = function(t) {
        var e, i, r, n, s, a, o, h, c, l, u = t.midX(), p = t.midY();
        ...
        for (c = 0; c < 4; c++)
            for (l = 0; l < 4; l++)
                ...
                o = t.at(l + 1, !0),
                h = t.at(l + 1, !1),
                cr.segments_intersect(e, i, r, n, s, a, o, h))
                    return !0;
        return !1
    }
    ,
    ...
    var o = !1
      , h = !1
      , c = !1;
    "undefined" != typeof window && (o = !(/chrome/i.test(navigator.userAgent) || /chromium/i.test(navigator.userAgent)) && /safari/i.test(navigator.userAgent),
    ...
    u.prototype.update_cache = function() {
        if (!this.cache_valid) {
            if (l)
                ...
                cr.clearArray(t);
                var e, i = 0, r = this.items;
                if (r)
                    for (e in r)
                        r.hasOwnProperty(e) && (t[i++] = r[e])
            }
            this.cache_valid = !0
        }
    }
    ...
    m.prototype.update_bbox = function() {
        for (var t, e, i, r = this.pts_cache, n = r[0], s = n, a = r[1], o = a, h = 1, c = this.pts_count; h < c; ++h)
            t = r[i = 2 * h],
            e = r[i + 1],
            t < n && (n = t),
            t > s && (s = t),
    ...
    m.prototype.contains_pt = function(t, e) {
        ...
        if (t === i[0] && e === i[1])
            return !0;
        var r, n, s, a, o, h, c, l = this.pts_count, u = this.bboxLeft - 110, p = this.bboxTop - 101, d = this.bboxRight + 131, f = this.bboxBottom + 120, g = 0, y = 0;
        for (r = 0; r < l; r++)
            s = (r + 1) % l * 2,
            a = i[n = 2 * r],
            o = i[n + 1],
            h = i[s],
            c = i[s + 1],
            cr.segments_intersect(u, p, t, e, a, o, h, c) && g++,
            cr.segments_intersect(d, f, t, e, a, o, h, c) && y++;
        return g % 2 == 1 || y % 2 == 1
    }
    ,
    m.prototype.intersects_poly = function(t, e, i) {
        var r, n, s, a, o, h, c, l, u, p, d, f, g, y, m, _, v = t.pts_cache, b = this.pts_cache;
    ...
    m.prototype.intersects_segment = function(t, e, i, r, n, s) {
        ...
        if (this.contains_pt(i - t, r - e))
            return !0;
        for (a = 0,
        o = this.pts_count; a < o; a++)
            if (c = (a + 1) % o * 2,
            l = f[h = 2 * a] + t,
            u = f[h + 1] + e,
            p = f[c] + t,
            d = f[c + 1] + e,
            cr.segments_intersect(i, r, n, s, l, u, p, d))
                return !0;
        return !1
    }
    ,
    m.prototype.mirror = function(t) {
        ...
        i = this.pts_count; e < i; ++e)
            r = 2 * e,
            this.pts_cache[r] = 2 * t - this.pts_cache[r]
    }
    ,
    ...
    m.prototype.diag = function() {
        ...
        e = this.pts_count; t < e; ++t)
            r = (i = 2 * t) + 1,
            n = this.pts_cache[i],
            this.pts_cache[i] = this.pts_cache[r],
            this.pts_cache[r] = n
    }
    ,
    cr.CollisionPoly = m,
    ...
    _.prototype.getCell = function(t, e, i) {
        ...
        return n ? (r = n[e]) || (i ? (r = w(this, t, e),
        this.cells[t][e] = r,
        r) : null) : i ? (r = w(this, t, e),
        this.cells[t] = {},
        this.cells[t][e] = r,
        r) : null
    }
    ...
    _.prototype.update = function(t, e, i) {
        ...
        if (e)
            ...
            n = e.right; r <= n; ++r)
                for (s = e.top,
                a = e.bottom; s <= a; ++s)
                    i && i.contains_pt(r, s) || (o = this.getCell(r, s, !1)) && (o.remove(t),
                    o.isEmpty() && (x(o),
                    this.cells[r][s] = null));
        if (i)
            for (r = i.left,
            n = i.right; r <= n; ++r)
                for (s = i.top,
                a = i.bottom; s <= a; ++s)
                    e && e.contains_pt(r, s) || this.getCell(r, s, !0).insert(t)
    }
    ,
    _.prototype.queryRange = function(t, e) {
        var i, r, n, s, a, o;
        for (i = this.XToCell(t.left),
        n = this.YToCell(t.top),
        r = this.XToCell(t.right),
        a = this.YToCell(t.bottom); i <= r; ++i)
            for (s = n; s <= a; ++s)
                (o = this.getCell(i, s, !1)) && o.dump(e)
    }
    ,
    cr.SparseGrid = _,
    ...
    v.prototype.getCell = function(t, e, i) {
        var r, n = this.cells[t];
        return n ? (r = n[e]) || (i ? (r = O(this, t, e),
        this.cells[t][e] = r,
        r) : null) : i ? (r = O(this, t, e),
        this.cells[t] = {},
        this.cells[t][e] = r,
        r) : null
    }
    ...
    v.prototype.queryRange = function(t, e, i, r, n) {
        ...
        o = this.YToCell(e),
        a = this.XToCell(i),
        c = this.YToCell(r); s <= a; ++s)
            for (h = o; h <= c; ++h)
                (l = this.getCell(s, h, !1)) && l.dump(n)
    }
    ,
    v.prototype.markRangeChanged = function(t) {
        ...
        s = t.bottom; e <= i; ++e)
            for (n = r; n <= s; ++n)
                (a = this.getCell(e, n, !1)) && (a.is_sorted = !1)
    }
    ,
    cr.RenderGrid = v;
    var b = [];
    function w(t, e, i) {
        ...
        b.length ? ((r = b.pop()).grid = t,
        r.x = e,
        r.y = i,
        r) : new cr.GridCell(t,e,i)
    }
    function x(t) {
    ...
    function O(t, e, i) {
        ...
        T.length ? ((r = T.pop()).grid = t,
        r.x = e,
        r.y = i,
        r) : new cr.RenderCell(t,e,i)
    }
    function C(t) {
        v.prototype.totalCellCount--,
        t.reset(),
        T.length < 1e3 && T.push(t)
    }
    function A(t, e, i) {
        this.grid = t,
        this.x = e,
    ...
    A.prototype.ensure_sorted = function() {
        this.is_sorted || (this.objects.sort(k),
        this.is_sorted = !0)
    }
    ,
...
vec3.direction = function(t, e, i) {
    ...
    var r = t[0] - e[0]
      , n = t[1] - e[1];
    t = t[2] - e[2];
    return (e = Math.sqrt(r * r + n * n + t * t)) ? (e = 1 / e,
    i[0] = r * e,
    i[1] = n * e,
    i[2] = t * e,
    i) : (i[0] = 0,
...
mat4.multiply = function(t, e, i) {
    ...
    i[8] = C * r + A * o + k * u + E * g,
    i[9] = C * n + A * h + k * p + E * y,
    i[10] = C * s + A * c + k * d + E * m,
    i[11] = C * a + A * l + k * f + E * t,
    i[12] = P * r + L * o + I * u + e * g,
    i[13] = P * n + L * h + I * p + e * y,
    i[14] = P * s + L * c + I * d + e * m,
    i[15] = P * a + L * l + I * f + e * t,
    i
}
,
mat4.multiplyVec3 = function(t, e, i) {
    ...
    var r = e[0]
      , n = e[1];
    e = e[2];
    return i[0] = t[0] * r + t[4] * n + t[8] * e + t[12],
    i[1] = t[1] * r + t[5] * n + t[9] * e + t[13],
    i[2] = t[2] * r + t[6] * n + t[10] * e + t[14],
    i
}
,
mat4.multiplyVec4 = function(t, e, i) {
    ...
    var r = e[0]
      ...
      , s = e[2];
    e = e[3];
    return i[0] = t[0] * r + t[4] * n + t[8] * s + t[12] * e,
    i[1] = t[1] * r + t[5] * n + t[9] * s + t[13] * e,
    i[2] = t[2] * r + t[6] * n + t[10] * s + t[14] * e,
    i[3] = t[3] * r + t[7] * n + t[11] * s + t[15] * e,
    i
}
,
mat4.translate = function(t, e, i) {
    var r, n, s, a, o, h, c, l, u, p, d, f, g = e[0], y = e[1];
    e = e[2];
    return i && t !== i ? (r = t[0],
    n = t[1],
    s = t[2],
    ...
    i[10] = d,
    i[11] = f,
    i[12] = r * g + o * y + u * e + t[12],
    i[13] = n * g + h * y + p * e + t[13],
    i[14] = s * g + c * y + d * e + t[14],
    i[15] = a * g + l * y + f * e + t[15],
...
mat4.rotate = function(t, e, i, r) {
    var n, s, a, o, h, c, l, u, p, d, f, g, y, m, _, v, b, w, x, S, T = i[0], O = i[1], C = (i = i[2],
    Math.sqrt(T * T + O * O + i * i));
...
mat4.lookAt = function(t, e, i, r) {
    r || (r = mat4.create());
    var n, s, a, o, h, c, l, u, p = t[0], d = t[1];
    t = t[2];
    return s = i[0],
    a = i[1],
    n = i[2],
    i = e[1],
    c = e[2],
    p === e[0] && d === i && t === c ? mat4.identity(r) : (i = p - e[0],
    c = d - e[1],
    l = t - e[2],
    e = a * (l *= u = 1 / Math.sqrt(i * i + c * c + l * l)) - n * (c *= u),
    n = n * (i *= u) - s * l,
    s = s * c - a * i,
    (u = Math.sqrt(e * e + n * n + s * s)) ? (e *= u = 1 / u,
    n *= u,
    s *= u) : s = n = e = 0,
    a = c * s - l * n,
    o = l * e - i * s,
    h = i * n - c * e,
    (u = Math.sqrt(a * a + o * o + h * h)) ? (a *= u = 1 / u,
    o *= u,
    h *= u) : h = o = a = 0,
    r[0] = e,
    r[1] = a,
...
quat4.calculateW = function(t, e) {
    ...
    e) : (t[3] = -Math.sqrt(Math.abs(1 - i * i - r * r - n * n)),
    t)
}
,
...
quat4.slerp = function(t, e, i, r) {
    ...
    return Math.abs(a) >= 1 ? (r !== t && (r[0] = t[0],
    r[1] = t[1],
    r[2] = t[2],
    r[3] = t[3]),
    r) : (n = Math.acos(a),
    s = Math.sqrt(1 - a * a),
    Math.abs(s) < .001 ? (r[0] = .5 * t[0] + .5 * e[0],
    r[1] = .5 * t[1] + .5 * e[1],
    r[2] = .5 * t[2] + .5 * e[2],
    r[3] = .5 * t[3] + .5 * e[3],
    r) : (a = Math.sin((1 - i) * n) / s,
    i = Math.sin(i * n) / s,
    r[0] = t[0] * a + e[0] * i,
    r[1] = t[1] * a + e[1] * i,
    r[2] = t[2] * a + e[2] * i,
...
function() {
    ...
    e.prototype.initState = function() {
        ...
        this.pointPtr = 0,
        this.shaderPrograms = [],
        r = ["varying mediump vec2 vTex;", "uniform lowp float opacity;", "uniform lowp sampler2D samplerFront;", "void main(void) {", "\tgl_FragColor = texture2D(samplerFront, vTex);", "\tgl_FragColor *= opacity;", "}"].join("\n"),
        ...
        r = ["uniform mediump sampler2D samplerFront;", "varying lowp float opacity;", "void main(void) {", "\tgl_FragColor = texture2D(samplerFront, gl_PointCoord);", "\tgl_FragColor *= opacity;", "}"].join("\n");
        ...
        this.shaderPrograms.push(a),
        r = ["varying mediump vec2 vTex;", "uniform lowp sampler2D samplerFront;", "void main(void) {", "\tif (texture2D(samplerFront, vTex).a < 1.0)", "\t\tdiscard;", "}"].join("\n");
        a = this.createShaderProgram({
            src: r
        }, n, "<earlyz>");
        this.shaderPrograms.push(a),
        r = ["uniform lowp vec4 colorFill;", "void main(void) {", "\tgl_FragColor = colorFill;", "}"].join("\n");
        a = this.createShaderProgram({
            src: r
        }, n, "<fill>");
        for (var h in this.shaderPrograms.push(a),
        cr.shaders)
            cr.shaders.hasOwnProperty(h) && this.shaderPrograms.push(this.createShaderProgram(cr.shaders[h], n, h));
    ...
    i.prototype.updateMatMV = function(t) {
        r(this.lpMatMV, t) || (mat4.set(t, this.lpMatMV),
    ...
    e.prototype.createShaderProgram = function(t, e, r) {
        ...
        if (n.shaderSource(s, t.src),
        n.compileShader(s),
        !n.getShaderParameter(s, n.COMPILE_STATUS)) {
            var a = n.getShaderInfoLog(s);
            throw n.deleteShader(s),
            new Error("error compiling fragment shader: " + a)
        }
        var o = n.createShader(n.VERTEX_SHADER);
        if (n.shaderSource(o, e),
        n.compileShader(o),
        !n.getShaderParameter(o, n.COMPILE_STATUS)) {
            a = n.getShaderInfoLog(o);
            throw n.deleteShader(s),
            n.deleteShader(o),
            new Error("error compiling vertex shader: " + a)
        }
        var h = n.createProgram();
        if (n.attachShader(h, s),
        n.attachShader(h, o),
        n.linkProgram(h),
        !n.getProgramParameter(h, n.LINK_STATUS)) {
            a = n.getProgramInfoLog(h);
            throw n.deleteShader(s),
            n.deleteShader(o),
            n.deleteProgram(h),
            new Error("error linking shader program: " + a)
        }
        n.useProgram(h),
        n.deleteShader(s),
        n.deleteShader(o);
        ...
        l = u.parameters.length; c < l; c++)
            u.parameters[c][1] = n.getUniformLocation(h, u.parameters[c][0]),
            u.lastCustomParams.push(0),
            n.uniform1f(u.parameters[c][1], 0);
        return cr.seal(u),
        u
    }
    ,
    ...
    e.prototype.project = function(t, e, i) {
        var r = this.matMV
          , n = this.matP
          , s = [0, 0, 0, 0, 0, 0, 0, 0];
        s[0] = r[0] * t + r[4] * e + r[12],
        s[1] = r[1] * t + r[5] * e + r[13],
        s[2] = r[2] * t + r[6] * e + r[14],
        s[3] = r[3] * t + r[7] * e + r[15],
        s[4] = n[0] * s[0] + n[4] * s[1] + n[8] * s[2] + n[12] * s[3],
        s[5] = n[1] * s[0] + n[5] * s[1] + n[9] * s[2] + n[13] * s[3],
        s[6] = n[2] * s[0] + n[6] * s[1] + n[10] * s[2] + n[14] * s[3],
        s[7] = -s[2],
        0 !== s[7] && (s[7] = 1 / s[7],
        s[4] *= s[7],
        s[5] *= s[7],
    ...
    e.prototype.setSize = function(t, e, i) {
        if (this.width !== t || this.height !== e || i) {
            ...
            this.enableFrontToBack)
                ...
                this.project(0, 0, o),
                this.project(1, 1, h),
                this.worldScale[0] = 1 / (h[0] - o[0]),
                this.worldScale[1] = -1 / (h[1] - o[1])
            }
            for (r = 0,
            n = this.shaderPrograms.length; r < n; r++)
                (s = this.shaderPrograms[r]).hasCurrentMatMV = !1,
                s.locMatP && (a.useProgram(s.shaderProgram),
                a.uniformMatrix4fv(s.locMatP, !1, this.matP));
            a.useProgram(this.shaderPrograms[this.lastProgram].shaderProgram),
            ...
            this.lastTexture0 = null,
            this.lastTexture1 = null,
            this.depthBuffer && (a.bindFramebuffer(a.FRAMEBUFFER, this.fbo),
            a.bindRenderbuffer(a.RENDERBUFFER, this.depthBuffer),
            a.renderbufferStorage(a.RENDERBUFFER, a.DEPTH_COMPONENT16, this.width, this.height),
            this.attachedDepthBuffer || (a.framebufferRenderbuffer(a.FRAMEBUFFER, a.DEPTH_ATTACHMENT, a.RENDERBUFFER, this.depthBuffer),
    ...
    n.prototype.doUpdateModelView = function() {
        var t, e, i, r = this.glwrap.shaderPrograms, n = this.glwrap.currentProgram;
        for (t = 0,
        e = r.length; t < e; t++)
            i = r[t],
            t === n && i.locMatMV ? (i.updateMatMV(this.mat4param),
    ...
    n.prototype.doSetProgramParameters = function() {
        var t, e, i = this.glwrap.currentShader, r = this.gl, n = this.mat4param;
        i.locSamplerBack && this.glwrap.lastTexture1 !== this.texParam && (r.activeTexture(r.TEXTURE1),
        r.bindTexture(r.TEXTURE_2D, this.texParam),
        this.glwrap.lastTexture1 = this.texParam,
        r.activeTexture(r.TEXTURE0));
        var s, a = n[0];
        if (i.locPixelWidth && a !== i.lpPixelWidth && (i.lpPixelWidth = a,
        r.uniform1f(i.locPixelWidth, a)),
        a = n[1],
        i.locPixelHeight && a !== i.lpPixelHeight && (i.lpPixelHeight = a,
        r.uniform1f(i.locPixelHeight, a)),
        a = n[2],
        s = n[3],
        !i.locDestStart || a === i.lpDestStartX && s === i.lpDestStartY || (i.lpDestStartX = a,
        i.lpDestStartY = s,
        r.uniform2f(i.locDestStart, a, s)),
        a = n[4],
        s = n[5],
        !i.locDestEnd || a === i.lpDestEndX && s === i.lpDestEndY || (i.lpDestEndX = a,
        i.lpDestEndY = s,
        r.uniform2f(i.locDestEnd, a, s)),
        a = n[6],
        i.locLayerScale && a !== i.lpLayerScale && (i.lpLayerScale = a,
        r.uniform1f(i.locLayerScale, a)),
        a = n[7],
        i.locLayerAngle && a !== i.lpLayerAngle && (i.lpLayerAngle = a,
        r.uniform1f(i.locLayerAngle, a)),
        a = n[8],
        s = n[9],
        !i.locViewOrigin || a === i.lpViewOriginX && s === i.lpViewOriginY || (i.lpViewOriginX = a,
        i.lpViewOriginY = s,
        r.uniform2f(i.locViewOrigin, a, s)),
        a = n[10],
        s = n[11],
        !i.locScrollPos || a === i.lpScrollPosX && s === i.lpScrollPosY || (i.lpScrollPosX = a,
        i.lpScrollPosY = s,
        r.uniform2f(i.locScrollPos, a, s)),
        a = n[12],
        i.locSeconds && a !== i.lpSeconds && (i.lpSeconds = a,
        r.uniform1f(i.locSeconds, a)),
        i.parameters.length)
            for (t = 0,
            e = i.parameters.length; t < e; t++)
                (a = this.shaderParams[t]) !== i.lastCustomParams[t] && (i.lastCustomParams[t] = a,
                r.uniform1f(i.parameters[t][1], a))
    }
    ,
    e.prototype.pushBatch = function() {
        return this.batchPtr === this.batch.length && this.batch.push(new n(0,this)),
    ...
    e.prototype.endBatch = function() {
        if (0 !== this.batchPtr && !this.gl.isContextLost()) {
            var t, e, i, r = this.gl;
            if (this.pointPtr > 0 && (r.bindBuffer(r.ARRAY_BUFFER, this.pointBuffer),
            r.bufferSubData(r.ARRAY_BUFFER, 0, this.pointData.subarray(0, this.pointPtr)),
            n && n.locAPos >= 0 && "<point>" === n.name && r.vertexAttribPointer(n.locAPos, 4, r.FLOAT, !1, 0, 0)),
            this.vertexPtr > 0) {
                var n = this.currentShader;
                r.bindBuffer(r.ARRAY_BUFFER, this.vertexBuffers[this.curBuffer]),
                r.bufferSubData(r.ARRAY_BUFFER, 0, this.vertexData.subarray(0, this.vertexPtr)),
                n && n.locAPos >= 0 && "<point>" !== n.name && r.vertexAttribPointer(n.locAPos, this.enableFrontToBack ? 3 : 2, r.FLOAT, !1, 0, 0),
                r.bindBuffer(r.ARRAY_BUFFER, this.texcoordBuffers[this.curBuffer]),
                r.bufferSubData(r.ARRAY_BUFFER, 0, this.texcoordData.subarray(0, this.texPtr)),
                n && n.locATex >= 0 && "<point>" !== n.name && r.vertexAttribPointer(n.locATex, 2, r.FLOAT, !1, 0, 0)
            }
            for (t = 0,
    ...
    e.prototype.convexPoly = function(t) {
        var e, i, r, n, s, a, o, h, c = t.length / 2 - 2, l = c - 1, u = t[0], p = t[1];
        for (e = 0; e < c; e += 2)
            r = t[(i = 2 * e) + 2],
            n = t[i + 3],
            s = t[i + 4],
            a = t[i + 5],
            e === l ? this.quad(u, p, r, n, s, a, s, a) : (o = t[i + 6],
            h = t[i + 7],
            this.quad(u, p, r, n, s, a, o, h))
    }
    ;
    ...
    e.prototype.loadTexture = function(t, e, i, r, n, o) {
        ...
        var h = t.src + "," + e + "," + i + (e ? "," + n : "")
          , c = null;
        if (void 0 !== t.src && a.hasOwnProperty(h))
            return (c = a[h]).c2refcount++,
            c;
        this.endBatch();
        var l = this.gl
        ...
        return e ? "repeat-x" === n ? (l.texParameteri(l.TEXTURE_2D, l.TEXTURE_WRAP_S, l.REPEAT),
        l.texParameteri(l.TEXTURE_2D, l.TEXTURE_WRAP_T, l.CLAMP_TO_EDGE)) : "repeat-y" === n ? (l.texParameteri(l.TEXTURE_2D, l.TEXTURE_WRAP_S, l.CLAMP_TO_EDGE),
        ...
        (u || this.version >= 2) && this.enable_mipmaps && !o ? (l.texParameteri(l.TEXTURE_2D, l.TEXTURE_MIN_FILTER, l.LINEAR_MIPMAP_LINEAR),
    ...
    e.prototype.createEmptyTexture = function(t, e, i, r, n) {
        ...
        return a.bindTexture(a.TEXTURE_2D, o),
        a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, t, e, 0, a.RGBA, r ? a.UNSIGNED_SHORT_4_4_4_4 : a.UNSIGNED_BYTE, null),
        n ? (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.REPEAT),
        a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.REPEAT)) : (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE),
        a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE)),
        a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, i ? a.LINEAR : a.NEAREST),
    ...
    e.prototype.deleteTexture = function(t) {
        ...
        void 0 !== t.c2texkey && delete a[t.c2texkey],
...
function() {
    ...
    e.prototype.requestProjectData = function() {
        ...
        if (this.isWKWebView)
            ...
            if (!this.isDomFree && "response"in e && "responseType"in e)
                try {
                    e.responseType = "json",
                    r = "json" === e.responseType
                } catch (t) {
                    r = !1
                }
            if (!r && "responseType"in e)
                try {
                    e.responseType = "text"
                } catch (t) {}
    ...
    e.prototype.initRendererAndLoader = function() {
        ...
        if (this.gl) {
            ...
            e = this.types_by_index.length; t < e; t++)
                for (i = 0,
                r = (a = this.types_by_index[t]).effect_types.length; i < r; i++)
                    (o = a.effect_types[i]).shaderindex = this.glwrap.getShaderIndex(o.id),
                    o.preservesOpaqueness = this.glwrap.programPreservesOpaqueness(o.shaderindex),
                    this.uses_background_blending = this.uses_background_blending || this.glwrap.programUsesDest(o.shaderindex);
            for (t = 0,
            e = this.layouts_by_index.length; t < e; t++) {
                for (i = 0,
                r = (h = this.layouts_by_index[t]).effect_types.length; i < r; i++)
                    (o = h.effect_types[i]).shaderindex = this.glwrap.getShaderIndex(o.id),
                    o.preservesOpaqueness = this.glwrap.programPreservesOpaqueness(o.shaderindex);
                for (h.updateActiveEffects(),
                i = 0,
                r = h.layers.length; i < r; i++) {
                    for (n = 0,
                    s = (c = h.layers[i]).effect_types.length; n < s; n++)
                        (o = c.effect_types[n]).shaderindex = this.glwrap.getShaderIndex(o.id),
                        o.preservesOpaqueness = this.glwrap.programPreservesOpaqueness(o.shaderindex),
                        this.uses_background_blending = this.uses_background_blending || this.glwrap.programUsesDest(o.shaderindex);
    ...
    e.prototype.setSize = function(t, e, i) {
        ...
        if (this.lastWindowWidth !== t || this.lastWindowHeight !== e || i) {
            ...
            if (u || 0 !== this.fullscreen_mode || i) {
                ...
                l >= 4 ? (c = t / e) > (h = this.original_width / this.original_height) ? (s = e * h,
                5 === l ? ((o = s * p / this.original_width) > 1 ? o = Math.floor(o) : o < 1 && (o = 1 / Math.ceil(1 / o)),
                r = (t - (s = this.original_width * o / p)) / 2,
                n = (e - (a = this.original_height * o / p)) / 2,
                t = s,
                e = a) : (r = (t - s) / 2,
                t = s)) : (a = t / h,
                5 === l ? ((o = a * p / this.original_height) > 1 ? o = Math.floor(o) : o < 1 && (o = 1 / Math.ceil(1 / o)),
                r = (t - (s = this.original_width * o / p)) / 2,
                n = (e - (a = this.original_height * o / p)) / 2,
                t = s,
                e = a) : (n = (e - a) / 2,
                e = a)) : this.isNWjs && this.isNodeFullscreen && 0 === this.fullscreen_mode_set && (r = Math.floor((t - this.original_width) / 2),
                n = Math.floor((e - this.original_height) / 2),
                ...
                this.isEjecta ? (this.canvas.style.left = Math.floor(r) + "px",
                this.canvas.style.top = Math.floor(n) + "px",
    ...
    e.prototype.setSuspended = function(t) {
        ...
        if (t && !this.isSuspended)
            ...
            e = 0,
            r = this.suspend_events.length; e < r; e++)
    ...
    e.prototype.loadProject = function(t) {
        ...
        i = f[2].length; e < i; e++)
            o = f[2][e],
            u = this.GetObjectReference(o[0]),
            cr.add_common_aces(o, u.prototype),
            (p = new u(this)).singleglobal = o[1],
            p.is_world = o[2],
            p.is_rotatable = o[5],
            p.must_predraw = o[9],
        ...
        i = f[3].length; e < i; e++) {
            for (o = f[3][e],
            d = this.GetObjectReference(o[1]),
            p = null,
            r = 0,
            n = this.plugins.length; r < n; r++)
            ...
            for (k.name = o[0],
            k.is_family = o[2],
            k.instvar_sids = o[3].slice(0),
            k.vars_count = o[3].length,
            k.behs_count = o[4],
            k.fx_count = o[5],
            k.sid = o[11],
            k.is_family ? (k.members = [],
            k.family_index = this.family_count++,
            k.families = null) : (k.members = null,
            k.family_index = -1,
            k.families = []),
            k.family_var_map = null,
            k.family_beh_map = null,
            k.family_fx_map = null,
            k.is_contained = !1,
            k.container = null,
            o[6] ? (k.texture_file = o[6][0],
            k.texture_filesize = o[6][1],
            k.texture_pixelformat = o[6][2]) : (k.texture_file = null,
            k.texture_filesize = 0,
            k.texture_pixelformat = 0),
            o[7] ? k.animations = o[7] : k.animations = null,
            k.index = e,
            k.instances = [],
            k.deadCache = [],
            k.solstack = [new cr.selection(k)],
            k.cur_sol = 0,
            k.default_instance = null,
            k.default_layerindex = 0,
            k.stale_iids = !0,
            k.updateIIDs = cr.type_updateIIDs,
            k.getFirstPicked = cr.type_getFirstPicked,
            k.getPairedInstance = cr.type_getPairedInstance,
            k.getCurrentSol = cr.type_getCurrentSol,
            k.pushCleanSol = cr.type_pushCleanSol,
            k.pushCopySol = cr.type_pushCopySol,
            k.popSol = cr.type_popSol,
            k.getBehaviorByName = cr.type_getBehaviorByName,
            k.getBehaviorIndexByName = cr.type_getBehaviorIndexByName,
            k.getEffectIndexByName = cr.type_getEffectIndexByName,
            k.applySolToContainer = cr.type_applySolToContainer,
            k.getInstanceByIID = cr.type_getInstanceByIID,
            k.collision_grid = new cr.SparseGrid(this.original_width,this.original_height),
            k.any_cell_changed = !0,
            k.any_instance_parallaxed = !1,
            k.extra = {},
            k.toString = cr.type_toString,
            k.behaviors = [],
            r = 0,
            n = o[8].length; r < n; r++) {
                h = o[8][r];
                var E = this.GetObjectReference(h[1])
                  , P = null;
                for (s = 0,
                a = this.behaviors.length; s < a; s++)
                    if (this.behaviors[s]instanceof E) {
                        P = this.behaviors[s];
                        break
                    }
                P || ((P = new E(this)).my_types = [],
                ...
                -1 === P.my_types.indexOf(k) && P.my_types.push(k);
            ...
            if (k.tile_poly_data = o[13],
            this.uses_loader_layout && !k.is_family && !k.isOnLoaderLayout && p.is_world || (k.onCreate(),
            cr.seal(k)),
            k.name && (this.types[k.name] = k),
            this.types_by_index.push(k),
            p.singleglobal) {
                var I = new p.Instance(k);
                I.uid = this.next_uid++,
                I.puid = this.next_puid++,
                I.iid = 0,
                I.get_iid = cr.inst_get_iid,
                I.toString = cr.inst_toString,
                I.properties = o[14],
                I.onCreate(),
                cr.seal(I),
                k.instances.push(I),
                this.objectsByUid[I.uid.toString()] = I
            }
        }
        for (e = 0,
        i = f[4].length; e < i; e++) {
            var R, N = f[4][e], B = this.types_by_index[N[0]];
            for (r = 1,
            n = N.length; r < n; r++)
                (R = this.types_by_index[N[r]]).families.push(B),
                B.members.push(R)
        }
        for (e = 0,
        i = f[28].length; e < i; e++) {
            ...
            for (r = 0,
            n = M.length; r < n; r++)
                F.push(this.types_by_index[M[r]]);
            for (r = 0,
            n = F.length; r < n; r++)
                F[r].is_contained = !0,
                F[r].container = F
            ...
            i = this.types_by_index.length; e < i; e++)
                if (!(c = this.types_by_index[e]).is_family && c.families.length) {
                    ...
                    var j = []
                      ...
                      , G = 0;
                    for (r = 0,
                    n = c.families.length; r < n; r++)
                        for (l = c.families[r],
                        c.family_var_map[l.family_index] = D,
                        D += l.vars_count,
                        c.family_beh_map[l.family_index] = W,
                        W += l.behs_count,
                        c.family_fx_map[l.family_index] = G,
                        G += l.fx_count,
                        s = 0,
                        a = l.effect_types.length; s < a; s++)
                            j.push(cr.shallowCopy({}, l.effect_types[s]));
                    for (c.effect_types = j.concat(c.effect_types),
                    r = 0,
                    n = c.effect_types.length; r < n; r++)
                        c.effect_types[r].index = r
                }
        for (e = 0,
        i = f[5].length; e < i; e++) {
            o = f[5][e];
        ...
        i = f[6].length; e < i; e++) {
            ...
            cr.seal(z),
            this.eventsheets[z.name] = z,
            this.eventsheets_by_index.push(z)
        }
        for (e = 0,
    ...
    e.prototype.areAllTexturesAndSoundsLoaded = function() {
        var t, e, i, r = a, n = 0, s = 0, h = !0;
        for (t = 0,
        e = this.wait_for_textures.length; t < e; t++) {
            var c = (i = this.wait_for_textures[t]).cr_filesize;
            (!c || c <= 0) && (c = 5e4),
            r += c,
            i.src && (i.complete || i.loaded) && !i.c2error ? n += c : h = !1
        }
        return h && this.preloadSounds && this.audioInstance && (o || (this.audioInstance.startPreloads(),
        o = !0),
        n += s = this.audioInstance.getPreloadedSize(),
        s < a && (h = !1)),
        this.progress = 0 == r ? 1 : n / r,
        h
    }
    ;
    var h = !1;
    e.prototype.go = function() {
        if (this.ctx || this.glwrap) {
            ...
            this.lastWindowWidth === i && this.lastWindowHeight === n || this.setSize(i, n),
            this.progress = 0,
            ...
            if (this.areAllTexturesAndSoundsLoaded() && (4 !== this.loaderstyle || h))
                ...
                if (e) {
                    ...
                    if (this.loaderstyle < 3 && (this.isCocoonJs || a >= 500 && this.last_progress != this.progress)) {
                        e.clearRect(0, 0, o, c);
                        var u, p = o / 2, d = c / 2, f = 0 === this.loaderstyle && this.loaderlogos.logo.complete, g = 40 * l, y = 0, m = 80 * l;
                        if (f) {
    ...
    e.prototype.draw_c2_splash_loader = function(t) {
        if (!h) {
            for (var e = Math.ceil(this.width), i = Math.ceil(this.height), n = (this.devicePixelRatio,
            this.loaderlogos.logo), s = this.loaderlogos.powered, a = this.loaderlogos.website, o = 0; o < 4; ++o)
                if (!n[o].complete || !s[o].complete || !a[o].complete)
                    return;
            0 === _ && (c = Date.now());
            var b, w, x = Date.now(), S = !1, T = t;
            ...
            T.drawImage(v(s, b), .5 * e - b / 2, .2 * i - w / 2, b, w),
            w = b = Math.min(.395 * i, .95 * e),
            T.drawImage(v(n, b), .5 * e - b / 2, .485 * i - w / 2, b, w),
            w = .25 * (b = cr.clamp(.22 * i, 105, .6 * e)),
            T.drawImage(v(a, b), .5 * e - b / 2, .868 * i - w / 2, b, w),
            T.fillStyle = "#3C3C3C",
            b = e,
            w = Math.max(.005 * i, 2),
            T.fillRect(0, .8 * i - w / 2, b, w),
            T.fillStyle = r ? "red" : "#E0FF65",
            b = e * this.progress,
            T.fillRect(.5 * e - b / 2, .8 * i - w / 2, b, w)) : (w = b = .55 * i,
            T.drawImage(v(n, b), .5 * e - b / 2, .45 * i - w / 2, b, w),
            T.fillStyle = "#3C3C3C",
            b = e,
            w = Math.max(.005 * i, 2),
            T.fillRect(0, .85 * i - w / 2, b, w),
            T.fillStyle = r ? "red" : "#E0FF65",
            b = e * this.progress,
            T.fillRect(.5 * e - b / 2, .85 * i - w / 2, b, w)),
            S && (u ? t.globalAlpha = 0 === _ ? 0 : Math.min((x - c) / 300, 1) : p && (t.globalAlpha = Math.max(1 - (x - f) / 300, 0)),
    ...
    e.prototype.tick = function(e, i, r) {
        if (this.running_layout) {
            ...
            if (r || !this.isSuspended || e) {
                ...
                if ((h || this.isNodeFullscreen) && this.fullscreen_scaling > 0 && (o = this.fullscreen_scaling),
                o > 0) {
    ...
    e.prototype.logic = function(t) {
        ...
        i = this.types_by_index.length; e < i; e++)
            if (!(o = this.types_by_index[e]).is_family && (o.behaviors.length || o.families.length))
                for (r = 0,
                n = o.instances.length; r < n; r++)
                    for (s = 0,
                    a = (y = o.instances[r]).behavior_insts.length; s < a; s++)
        ...
        e = this.types_by_index.length; t < e; t++)
            if (!(a = this.types_by_index[t]).is_family)
                ...
                r = a.instances.length; i < r; i++)
                    if ((o = a.instances[i]).onWindowBlur && o.onWindowBlur(),
                    o.behavior_insts)
                        for (n = 0,
                        s = o.behavior_insts.length; n < s; n++)
                            (h = o.behavior_insts[n]).onWindowBlur && h.onWindowBlur()
    }
    ,
    e.prototype.doChangeLayout = function(t) {
        ...
        this.glwrap)
            for (e = 0,
            i = this.types_by_index.length; e < i; e++)
                (r = this.types_by_index[e]).is_family || !r.unloadTextures || r.global && 0 !== r.instances.length || -1 !== t.initial_types.indexOf(r) || r.unloadTextures();
    ...
    e.prototype.runLayoutChangeMethods = function(t) {
        ...
        i = this.types_by_index.length; e < i; e++)
            if ((n = this.types_by_index[e]).global || n.plugin.singleglobal)
                for (s = 0,
                a = n.instances.length; s < a; s++)
                    if (o = n.instances[s],
                    t ? o.onBeforeLayoutChange && o.onBeforeLayoutChange() : o.onLayoutChange && o.onLayoutChange(),
                    o.behavior_insts)
                        for (h = 0,
                        c = o.behavior_insts.length; h < c; h++)
                            l = o.behavior_insts[h],
    ...
    e.prototype.DestroyInstance = function(t) {
        var e, i, r = t.type.name, n = null;
        if (this.deathRow.hasOwnProperty(r)) {
            if ((n = this.deathRow[r]).contains(t))
                return
        } else
            n = b.length ? b.pop() : new cr.ObjectSet,
            this.deathRow[r] = n;
        if (n.add(t),
    ...
    e.prototype.ClearDeathRow = function() {
        if (this.hasPendingInstances) {
            ...
            n = this.createRow.length; i < n; ++i)
                ...
                r = 0,
                s = e.families.length; r < s; ++r)
                    e.families[r].instances.push(t),
                    e.families[r].stale_iids = !0;
    ...
    e.prototype.ClearDeathRowForType = function(t) {
        var e, i, r, n, s, a, o, h, c = t.valuesRef(), l = c[0].type;
        ...
        i = l.families.length; e < i; ++e)
            a = l.families[e],
            cr.arrayRemoveAllFromObjectSet(a.instances, t),
            a.stale_iids = !0;
        for (e = 0,
        i = this.system.waits.length; e < i; ++e)
            ...
            !l.is_family)
                for (r = 0,
                n = l.families.length; r < n; ++r)
                    a = l.families[r],
                    s.sols.hasOwnProperty(a.index) && cr.arrayRemoveAllFromObjectSet(s.sols[a.index].insts, t);
        var u, p = c[0].layer;
        if (p) {
            if (p.useRenderCells)
                for (e = 0,
                i = (o = p.instances).length; e < i; ++e)
                    h = o[e],
    ...
    e.prototype.ClearDeathRowForSingleInstance = function(t, e) {
        var i, r, n;
        for (i = 0,
        r = this.destroycallbacks.length; i < r; ++i)
        ...
        t.behavior_insts)
            for (i = 0,
            r = t.behavior_insts.length; i < r; ++i)
                (n = t.behavior_insts[i]).onDestroy && n.onDestroy(),
                n.behavior.my_instances.remove(t);
        this.objects_to_pretick.remove(t),
        this.objects_to_tick.remove(t),
        this.objects_to_tick2.remove(t),
    ...
    e.prototype.createInstanceFromInit = function(t, e, i, r, n, s) {
        ...
        a = 0,
        o = this.createRow.length; a < o; ++a)
            this.createRow[a].type === u && d.iid++;
        ...
        if (d.recycled)
            ...
            "undefined" != typeof cr_is_preview)
                ...
                a = 0,
                o = y.length; a < o; a++)
                    d.instance_var_names[a] = y[a][1];
            d.instance_vars = [],
            d.instance_vars.length = y.length
        }
        for (a = 0,
        o = y.length; a < o; a++)
            d.instance_vars[a] = y[a][0];
        if (p) {
            var m = t[0];
            if (d.x = cr.is_undefined(r) ? m[0] : r,
            d.y = cr.is_undefined(n) ? m[1] : n,
            d.z = m[2],
            d.width = m[3],
            d.height = m[4],
            d.depth = m[5],
            ...
            d.recycled) {
                ...
                o = m[12].length; a < o; a++)
                    for (h = 0,
                    c = m[12][a].length; h < c; h++)
                        d.effect_params[a][h] = m[12][a][h];
                d.bbox.set(0, 0, 0, 0),
                ...
                a = 0,
                o = d.effect_params.length; a < o; a++)
                    d.effect_params[a] = m[12][a].slice(0);
            ...
            a = 0,
            o = u.effect_types.length; a < o; a++)
                d.active_effect_flags[a] = !0;
        ...
        for (cr.clearArray(w),
        a = 0,
        o = u.families.length; a < o; a++)
            w.push.apply(w, u.families[a].behaviors);
        if (w.push.apply(w, u.behaviors),
        d.recycled)
            for (a = 0,
            o = w.length; a < o; a++) {
                var _ = w[a];
                for ((v = d.behavior_insts[a]).recycled = !0,
                _.behavior.Instance.call(v, _, d),
                h = 0,
                c = (g = t[4][a]).length; h < c; h++)
                    v.properties[h] = g[h];
                v.onCreate(),
            ...
            o = w.length; a < o; a++) {
                var v;
                (v = new (_ = w[a]).behavior.Instance(_,d)).recycled = !1,
                v.properties = t[4][a].slice(0),
                v.onCreate(),
                cr.seal(v),
        ...
        u.is_contained) {
            ...
            !i && !s) {
                for (a = 0,
                o = u.container.length; a < o; a++)
                    if (u.container[a] !== u) {
                        if (!u.container[a].default_instance)
                            return null;
                        d.siblings.push(this.createInstanceFromInit(u.container[a].default_instance, f, !1, p ? d.x : r, p ? d.y : n, !0))
                    }
                for (a = 0,
                o = d.siblings.length; a < o; a++)
                    for (d.siblings[a].siblings.push(d),
                    h = 0; h < o; h++)
                        a !== h && d.siblings[a].siblings.push(d.siblings[h])
            }
        } else
            d.is_contained = !1,
            d.siblings = null;
        ...
        a = 0,
        o = d.behavior_insts.length; a < o; a++)
            d.behavior_insts[a].postCreate && d.behavior_insts[a].postCreate();
        return d
    }
    ,
    ...
    e.prototype.updateAllCells = function(t) {
        if (t.any_cell_changed) {
            ...
            for (e = 0,
            i = r.length; e < i; ++e)
                r[e].update_collision_cell();
            var n = this.createRow;
            for (e = 0,
            i = n.length; e < i; ++e)
                n[e].type === t && n[e].update_collision_cell();
    ...
    e.prototype.getCollisionCandidates = function(t, e, i, r) {
        ...
        if (e.is_family)
            for (n = 0,
            s = e.members.length; n < s; ++n)
                a = e.members[n],
                o || a.any_instance_parallaxed ? cr.appendArray(r, a.instances) : (this.updateAllCells(a),
                a.collision_grid.queryRange(i, r));
        else
            o || e.any_instance_parallaxed ? cr.appendArray(r, e.instances) : (this.updateAllCells(e),
            e.collision_grid.queryRange(i, r))
    }
    ,
    e.prototype.getTypesCollisionCandidates = function(t, e, i, r) {
        ...
        for (n = 0,
        s = e.length; n < s; ++n)
            this.getCollisionCandidates(t, e[n], i, r)
    }
    ,
    ...
    e.prototype.testAndSelectCanvasPointOverlap = function(t, e, i, r) {
        var n, s, a, o, h, c, l, u = t.getCurrentSol(), p = this.getCurrentEventStack().current_event.orblock;
        if (u.select_all)
            for (r || (u.select_all = !1,
            cr.clearArray(u.instances)),
            n = 0,
            o = t.instances.length; n < o; n++)
                if ((a = t.instances[n]).update_bbox(),
                h = a.layer.canvasToLayer(e, i, !0),
                c = a.layer.canvasToLayer(e, i, !1),
                a.contains_pt(h, c)) {
                    if (r)
                        return !1;
                    u.instances.push(a)
                } else
                    p && u.else_instances.push(a);
        else {
            for (s = 0,
            n = 0,
            o = (l = p ? u.else_instances : u.instances).length; n < o; n++)
                if ((a = l[n]).update_bbox(),
                h = a.layer.canvasToLayer(e, i, !0),
                c = a.layer.canvasToLayer(e, i, !1),
                a.contains_pt(h, c)) {
                    if (r)
                        return !1;
                    p ? u.instances.push(a) : (u.instances[s] = u.instances[n],
                    s++)
                }
            r || (l.length = s)
        }
    ...
    e.prototype.testOverlap = function(t, e) {
        ...
        t.update_bbox(),
        e.update_bbox();
        var i, r, n, s, a, o, h, c, l, u, p = t.layer, d = e.layer;
        if (p !== d && (p.parallaxX !== d.parallaxX || d.parallaxY != d.parallaxY || p.scale !== d.scale || p.angle !== d.angle || p.zoomRate !== d.zoomRate)) {
            ...
            r = l.pts_count; i < r; i++)
                ...
                a = l.pts_cache[n],
                o = l.pts_cache[s],
                l.pts_cache[n] = p.layerToCanvas(a + t.x, o + t.y, !0),
                l.pts_cache[s] = p.layerToCanvas(a + t.x, o + t.y, !1);
            for (l.update_bbox(),
            i = 0,
            r = u.pts_count; i < r; i++)
                s = (n = 2 * i) + 1,
                a = u.pts_cache[n],
                o = u.pts_cache[s],
                u.pts_cache[n] = d.layerToCanvas(a + e.x, o + e.y, !0),
                u.pts_cache[s] = d.layerToCanvas(a + e.x, o + e.y, !1);
    ...
    e.prototype.testTilemapOverlap = function(t, e) {
        var i, r, n, s, a = e.bbox, o = t.x, h = t.y;
        ...
        r = c.length; i < r; ++i)
            if (s = (n = c[i]).rc,
            a.intersects_rect_off(s, o, h) && (x.set_from_rect(s),
            x.offset(o, h),
            x.intersects_quad(e.bquad)))
                if (l) {
                    if (e.collision_poly.cache_poly(e.width, e.height, e.angle),
                    n.poly) {
                        if (n.poly.intersects_poly(e.collision_poly, e.x - (o + s.left), e.y - (h + s.top)))
                            return cr.clearArray(T),
                            !0
                    ...
                    n.poly.intersects_poly(this.temp_poly, -(o + s.left), -(h + s.top)))
                        return cr.clearArray(T),
                        !0
                }
        return cr.clearArray(T),
    ...
    e.prototype.testRectOverlap = function(t, e) {
        ...
        if (e.tilemap_exists) {
            ...
            var i, r, n, s, a = T, o = e.x, h = e.y;
            for (i = 0,
            r = a.length; i < r; ++i)
                if (s = (n = a[i]).rc,
                t.intersects_rect_off(s, o, h)) {
                    if (!n.poly)
                        return cr.clearArray(T),
                        !0;
    ...
    e.prototype.testSegmentOverlap = function(t, e, i, r, n) {
        ...
        n.update_bbox();
        n.layer;
        if (S.set(cr.min(t, i), cr.min(e, r), cr.max(t, i), cr.max(e, r)),
        !n.bbox.intersects_rect(S))
            return !1;
        if (n.tilemap_exists) {
            n.getCollisionRectCandidates(S, T);
            var s, a, o, h, c = T, l = n.x, u = n.y;
            for (s = 0,
            a = c.length; s < a; ++s)
                if (h = (o = c[s]).rc,
                S.intersects_rect_off(h, l, u) && (x.set_from_rect(h),
                x.offset(l, u),
                x.intersects_segment(t, e, i, r))) {
                    if (!o.poly)
                        return cr.clearArray(T),
                        !0;
                    if (o.poly.intersects_segment(l + h.left, u + h.top, t, e, i, r))
                        return cr.clearArray(T),
                        !0
                }
            return cr.clearArray(T),
        ...
        return !!n.bquad.intersects_segment(t, e, i, r) && (!(n.collision_poly && !n.collision_poly.is_empty()) || (n.collision_poly.cache_poly(n.width, n.height, n.angle),
        n.collision_poly.intersects_segment(n.x, n.y, t, e, i, r)))
    }
    ,
    e.prototype.typeHasBehavior = function(t, e) {
        ...
        var i, r, n, s, a;
        for (i = 0,
        r = t.behaviors.length; i < r; i++)
            if (t.behaviors[i].behavior instanceof e)
                return !0;
        if (!t.is_family)
            for (i = 0,
            r = t.families.length; i < r; i++)
                for (n = 0,
                s = (a = t.families[i]).behaviors.length; n < s; n++)
                    if (a.behaviors[n].behavior instanceof e)
                        return !0;
        return !1
    }
    ,
    ...
    e.prototype.testOverlapSolid = function(t) {
        ...
        e = 0,
        i = O.length; e < i; ++e)
            if ((r = O[e]).extra.solidEnabled && this.testOverlap(t, r))
    ...
    e.prototype.testRectOverlapSolid = function(t) {
        ...
        e = 0,
        i = O.length; e < i; ++e)
            if ((r = O[e]).extra.solidEnabled && this.testRectOverlap(t, r))
                return cr.clearArray(O),
                r;
        return cr.clearArray(O),
        null
    ...
    e.prototype.pushOutSolid = function(t, e, i, r, n, s) {
        var a, o = r || 50, h = t.x, c = t.y, l = null, u = null;
        for (a = 0; a < o; a++)
            if (t.x = h + e * a,
            t.y = c + i * a,
            t.set_bbox_changed(),
            !this.testOverlap(t, l) && ((l = this.testOverlapSolid(t)) && (u = l),
            !l && (n && (l = s ? this.testOverlap(t, s) ? s : null : this.testOverlapJumpThru(t)) && (u = l),
            !l)))
    ...
    e.prototype.pushInFractional = function(t, e, i, r, n) {
        for (var s, a = 2, o = !1, h = !1, c = t.x, l = t.y; a <= n; )
            s = 1 / a,
            a *= 2,
            t.x += e * s * (o ? 1 : -1),
            t.y += i * s * (o ? 1 : -1),
            t.set_bbox_changed(),
            this.testOverlap(t, r) ? (o = !0,
            h = !0) : (o = !1,
            h = !1,
            c = t.x,
            l = t.y);
    ...
    e.prototype.addRegisteredCollisionCandidates = function(t, e, i) {
        var r, n, s, a;
        for (r = 0,
        n = this.registered_collisions.length; r < n; ++r) {
    ...
    e.prototype.checkRegisteredCollision = function(t, e) {
        var i, r, n;
        for (i = 0,
        r = this.registered_collisions.length; i < r; i++)
            if ((n = this.registered_collisions[i])[0] === t && n[1] === e || n[0] === e && n[1] === t)
                return !0;
        return !1
    }
    ,
    e.prototype.calculateSolidBounceAngle = function(t, e, i, r) {
        ...
        for (c = 1; c < 36; c++)
            ...
            t.y = i + Math.sin(l) * a,
            t.set_bbox_changed(),
            !this.testOverlap(t, d) && !(d = r ? null : this.testOverlapSolid(t))) {
                u = l;
                break
            }
        ...
        if (36 === c && (p = cr.clamp_angle(o + cr.PI)),
        t.x = n,
        t.y = s,
        t.set_bbox_changed(),
        p === u)
    ...
    e.prototype.trigger = function(t, e, i) {
        ...
        for (s = 0,
        a = h.length; s < a; ++s)
            n = this.triggerOnSheet(t, e, h[s], i),
            o = o || n;
        return n = this.triggerOnSheet(t, e, r, i),
        A--,
        o = o || n
    }
    ,
    e.prototype.triggerOnSheet = function(t, e, i, r) {
        var n, s, a, o, h = !1;
        if (e)
            for (a = this.triggerOnSheetForTypeName(t, e, e.type.name, i, r),
            h = h || a,
            n = 0,
            s = (o = e.type.families).length; n < s; ++n)
                a = this.triggerOnSheetForTypeName(t, e, o[n].name, i, r),
                h = h || a;
        else
            a = this.triggerOnSheetForTypeName(t, e, "system", i, r),
            h = h || a;
        return h
    }
    ,
    e.prototype.triggerOnSheetForTypeName = function(t, e, i, r, n) {
        var s, a, o, h, c = !1, l = !1, u = void 0 !== n, p = (u ? r.fasttriggers : r.triggers)[i];
        if (!p)
            return c;
        var d, f = null;
        for (s = 0,
        ...
        a = d.length; s < a; s++)
            o = d[s][0],
            h = d[s][1],
            l = this.executeSingleTrigger(e, i, o, h),
            c = c || l;
        return c
    }
    ,
    e.prototype.executeSingleTrigger = function(t, e, i, r) {
        ...
        i.orblock ? i.run_orblocktrigger(r) : i.run(),
        a = a || c.last_event_true),
        this.popEventStack(),
        h && this.popLocalVarStack(),
        this.popSol(i.solModifiersIncludingParents),
        o && this.popSol(o.solModifiersIncludingParents),
        this.hasPendingInstances && 0 === this.isInOnDestroy && 0 === A && !this.isRunningEvents && this.ClearDeathRow(),
        this.trigger_depth--,
        a
    }
    ,
    ...
    e.prototype.getEventVariableByName = function(t, e) {
        for (var i, r, n, s, a, o; e; ) {
            for (i = 0,
            r = e.subevents.length; i < r; i++)
                if ((o = e.subevents[i])instanceof cr.eventvariable && cr.equals_nocase(t, o.name))
                    return o;
            e = e.parent
        }
        for (i = 0,
        r = this.eventsheets_by_index.length; i < r; i++)
            for (n = 0,
            s = (a = this.eventsheets_by_index[i]).events.length; n < s; n++)
                if ((o = a.events[n])instanceof cr.eventvariable && cr.equals_nocase(t, o.name))
                    return o;
        return null
    }
    ,
            ...
            k() && !this.isCocoonJs)
                !function(t, e, i, r) {
                    ...
                    try {
                        ...
                        cr.logexport("Failed to save game state: " + r + "; " + e),
        ...
        if (r.length) {
            if (k() && !this.isCocoonJs)
                !function(t, e, i) {
                    ...
                    e ? (t.loadFromJson = e,
                    cr.logexport("Loaded state from IndexedDB storage (" + t.loadFromJson.length + " bytes)")) : (t.loadFromJson = localStorage.getItem("__c2save_" + r) || "",
                    ...
                    t.loadFromJson = localStorage.getItem("__c2save_" + r) || "",
                    cr.logexport("Loaded state from WebStorage (" + t.loadFromJson.length + " bytes)"),
                    t.suspendDrawing = !1,
                    t.loadFromJson || (t.loadFromJson = null,
                    t.trigger(cr.system_object.prototype.cnds.OnLoadFailed, null))
                ...
                try {
                    this.loadFromJson = localStorage.getItem("__c2save_" + r) || "",
    ...
    e.prototype.saveToJSONString = function() {
        ...
        e = this.types_by_index.length; t < e; t++)
            if (!(n = this.types_by_index[t]).is_family && !this.typeHasNoSaveBehavior(n)) {
                ...
                cr.hasAnyOwnProperty(n.extra) && (a.ex = L(n.extra)),
                i = 0,
                r = n.instances.length; i < r; i++)
                    a.instances.push(this.saveInstanceToJSON(n.instances[i]));
        ...
        e = this.allGroups.length; t < e; t++)
            d[(o = this.allGroups[t]).sid.toString()] = this.groups_by_name[o.group_name].group_active;
        var f = p.events.cnds;
    ...
    e.prototype.loadFromJSONString = function(t) {
        ...
        for (c in x)
            if (x.hasOwnProperty(c)) {
                ...
                p = x[c].instances,
                r = 0,
                n = cr.min(u.length, p.length); r < n; r++)
                    this.loadInstanceFromJSON(u[r], p[r]);
                for (r = p.length,
                n = u.length; r < n; r++)
                    this.DestroyInstance(u[r]);
                for (r = u.length,
                n = p.length; r < n; r++)
                    y = null,
                    l.plugin.is_world && !(y = this.running_layout.getLayerBySid(p[r].w.l)) || (d = this.createInstanceFromInit(l.default_instance, y, !1, 0, 0, !0),
                    this.loadInstanceFromJSON(d, p[r]));
                l.stale_iids = !0
            }
        this.ClearDeathRow(),
        this.refreshUidMap();
        ...
        for (c in T)
            T.hasOwnProperty(c) && (m = this.getGroupBySid(parseInt(c, 10))) && this.groups_by_name[m.group_name] && this.groups_by_name[m.group_name].setGroupActive(T[c]);
        var O = e.events.cnds;
        for (c in this.cndsBySid)
            this.cndsBySid.hasOwnProperty(c) && (O.hasOwnProperty(c) ? this.cndsBySid[c].extra = O[c].ex : this.cndsBySid[c].extra = {});
        var C = e.events.acts;
        ...
        var A = e.events.vars;
        for (c in A)
            A.hasOwnProperty(c) && this.varsBySid.hasOwnProperty(c) && (this.varsBySid[c].data = A[c]);
        for (this.next_uid = i.next_uid,
        this.isLoadingState = !1,
        r = 0,
        n = this.fireOnCreateAfterLoad.length; r < n; ++r)
            d = this.fireOnCreateAfterLoad[r],
        ...
        r = 0,
        n = this.types_by_index.length; r < n; r++)
            if (!(l = this.types_by_index[r]).is_family && !this.typeHasNoSaveBehavior(l))
                for (s = 0,
                a = l.instances.length; s < a; s++) {
                    if (d = l.instances[s],
                    l.is_contained)
                        for (_ = d.get_iid(),
                        cr.clearArray(d.siblings),
                        o = 0,
                        h = l.container.length; o < h; o++)
                            l !== (v = l.container[o]) && d.siblings.push(v.instances[_]);
                    if (d.afterLoad && d.afterLoad(),
                    d.behavior_insts)
                        for (o = 0,
                        h = d.behavior_insts.length; o < h; o++)
                            (f = d.behavior_insts[o]).afterLoad && f.afterLoad()
                }
    ...
    e.prototype.saveInstanceToJSON = function(t, e) {
        var i, r, n, s, a, o = t.type, h = o.plugin, c = {};
        if (e ? c.c2 = !0 : c.uid = t.uid,
        cr.hasAnyOwnProperty(t.extra) && (c.ex = L(t.extra)),
        t.instance_vars && t.instance_vars.length)
            for (c.ivs = {},
            i = 0,
            r = t.instance_vars.length; i < r; i++)
        ...
        if (h.is_world) {
            ...
            o.effect_types.length)
                for (n.fx = [],
                i = 0,
                r = o.effect_types.length; i < r; i++)
                    a = o.effect_types[i],
                    n.fx.push({
                        name: a.name,
    ...
    e.prototype.loadInstanceFromJSON = function(t, e, i) {
        var r, n, s, a, o, h, c, l, u, p, d, f = t.type, g = f.plugin;
        if (i) {
            if (!e.c2)
                return
        } else
        ...
        o = e.ivs)
            for (r in o)
                if (o.hasOwnProperty(r)) {
                    if ((a = this.getInstanceVarIndexBySid(f, parseInt(r, 10))) < 0 || a >= t.instance_vars.length)
                        continue;
                    null === (p = o[r]) && (p = NaN),
                    t.instance_vars[a] = p
                }
        if (g.is_world) {
            ...
            h.hasOwnProperty("fx"))
                for (n = 0,
                s = h.fx.length; n < s; n++)
                    (c = f.getEffectIndexByName(h.fx[n].name)) < 0 || (t.active_effect_flags[c] = h.fx[n].active,
        ...
        if (l = e.behs)
            for (r in l)
                if (l.hasOwnProperty(r)) {
                    if ((u = this.getBehaviorIndexBySid(t, parseInt(r, 10))) < 0)
                        continue;
    ...
    e.prototype.fetchLocalFileViaCordovaAsArrayBuffer = function(t, e, i) {
        ...
        I.push({
            ...
            successCallback: function(t) {
                R--,
                r.maybeStartNextArrayBufferRead(),
                e(t)
            },
    ...
    e.prototype.fetchLocalFileViaCordovaAsURL = function(t, e, i) {
        ...
        ".mp4" === s ? r = "video/mp4" : ".webm" === a ? r = "video/webm" : ".m4a" === s ? r = "audio/mp4" : ".mp3" === s && (r = "audio/mpeg"),
...
function() {
    function t(t, e) {
        ...
        r = a.length; i < r; i++) {
            ...
            h.default_instance || (h.default_instance = o),
            this.initial_nonworld.push(o),
    ...
    t.prototype.getEffectByName = function(t) {
        ...
        i = this.effect_types.length; e < i; e++)
            if ((r = this.effect_types[e]).name === t)
                return r;
        return null
    }
    ;
    ...
    t.prototype.startRunning = function() {
        ...
        if (!this.first_visit) {
            for (f in this.persist_data)
                if (this.persist_data.hasOwnProperty(f)) {
                    if (!(o = this.runtime.getObjectTypeBySid(parseInt(f, 10))) || o.is_family || !this.runtime.typeHasPersistBehavior(o))
                        continue;
                    for (t = 0,
                    s = (g = this.persist_data[f]).length; t < s; t++)
                        y = null,
                        o.plugin.is_world && !(y = this.getLayerBySid(g[t].w.l)) || (l = this.runtime.createInstanceFromInit(o.default_instance, y, !1, 0, 0, !0),
        ...
        t = 0; t < e.length; t++)
            if ((l = e[t]).type.is_contained)
                for (u = l.get_iid(),
                n = 0,
                a = l.type.container.length; n < a; n++)
                    p = l.type.container[n],
        ...
        s = this.initial_nonworld.length; t < s; t++)
            ...
            (o = this.runtime.types_by_index[c[1]]).is_contained || (l = this.runtime.createInstanceFromInit(this.initial_nonworld[t], null, !0));
    ...
    t.prototype.createGlobalNonWorlds = function() {
        ...
        i = this.initial_nonworld.length; t < i; t++)
            r = this.initial_nonworld[t],
            (n = this.runtime.types_by_index[r[1]]).global ? n.is_contained || this.runtime.createInstanceFromInit(r, null, !0) : (this.initial_nonworld[e] = r,
            e++);
    ...
    t.prototype.stopRunning = function() {
        ...
        !this.first_visit)
            ...
            e = this.layers.length; t < e; t++)
                ...
                i = 0,
                n = (s = this.layers[t].instances).length; i < n; i++)
                    (a = s[i]).type.global || this.runtime.typeHasPersistBehavior(a.type) && this.saveObjectToPersist(a);
        for (t = 0,
        e = this.layers.length; t < e; t++) {
            for (i = 0,
            n = (s = this.layers[t].instances).length; i < n; i++)
                (a = s[i]).type.global || this.runtime.DestroyInstance(a);
            this.runtime.ClearDeathRow(),
            cr.clearArray(s),
            this.layers[t].zindices_stale = !0
        }
    ...
    function s(t, e) {
        ...
        r = n.length; i < r; i++) {
            ...
            a.default_instance || (a.default_instance = s,
            a.default_layerindex = this.index),
            this.initial_instances.push(s),
            -1 === this.layout.initial_types.indexOf(a) && this.layout.initial_types.push(a)
        }
    ...
    t.prototype.recreateInitialObjects = function(t, e, i, r, s) {
        ...
        for (n.set(e, i, r, s),
        a = 0,
        o = this.layers.length; a < o; a++)
            this.layers[a].recreateInitialObjects(t, n)
    }
    ,
    t.prototype.draw = function(t) {
        var e, i, r, n, s = t, a = !1, o = !this.runtime.fullscreenScalingQuality;
        for (o && (this.runtime.layout_canvas || (this.runtime.layout_canvas = document.createElement("canvas"),
        ...
        a = !0),
        a && this.runtime.setCtxImageSmoothingEnabled(s, this.runtime.linearSampling)),
        s.globalAlpha = 1,
        ...
        i = 0,
        r = this.layers.length; i < r; i++)
            (n = this.layers[i]).visible && n.opacity > 0 && 11 !== n.blend_mode && (n.instances.length || !n.transparent) ? n.draw(s) : n.updateViewport(null);
    ...
    t.prototype.drawGL = function(t) {
        ...
        for (n ? (this.runtime.layout_tex || (this.runtime.layout_tex = t.createEmptyTexture(this.runtime.draw_width, this.runtime.draw_height, this.runtime.linearSampling)),
        this.runtime.layout_tex.c2width === this.runtime.draw_width && this.runtime.layout_tex.c2height === this.runtime.draw_height || (t.deleteTexture(this.runtime.layout_tex),
        this.runtime.layout_tex = t.createEmptyTexture(this.runtime.draw_width, this.runtime.draw_height, this.runtime.linearSampling)),
        t.setRenderingToTexture(this.runtime.layout_tex),
        ...
        i = this.layers.length; e < i; e++)
            (r = this.layers[e]).visible && r.opacity > 0 && (r.instances.length || !r.transparent) ? r.drawGL(t) : r.updateViewport(null);
        if (n)
    ...
    t.prototype.getMinLayerScale = function() {
        ...
        for (t = 1,
        e = this.layers.length; t < e; t++)
            0 === (i = this.layers[t]).parallaxX && 0 === i.parallaxY || i.getScale() < r && (r = i.getScale());
        return r
    }
    ,
    ...
    t.prototype.renderEffectChain = function(t, e, i, r) {
        ...
        c = e.viewRight,
        l = e.viewBottom);
        var u, p, d, f, g, y = this.runtime.fx_tex, m = 0, _ = 1, v = this.runtime.draw_width, b = this.runtime.draw_height, w = v / 2, x = b / 2, S = e ? e.rcTex : this.rcTex, T = e ? e.rcTex2 : this.rcTex2, O = 0, C = 0, A = 0, k = 0, E = v, P = v, L = b, I = b, R = 0, N = 0, B = i ? i.layer.getAngle() : 0;
        if (i) {
            for (u = 0,
            p = n.length; u < p; u++)
                R += t.getProgramBoxExtendHorizontal(n[u].shaderindex),
                N += t.getProgramBoxExtendVertical(n[u].shaderindex);
            var M = i.bbox;
            if (O = e.layerToCanvas(M.left, M.top, !0, !0),
            A = e.layerToCanvas(M.left, M.top, !1, !0),
            E = e.layerToCanvas(M.right, M.bottom, !0, !0),
            L = e.layerToCanvas(M.right, M.bottom, !1, !0),
            0 !== B) {
        ...
        t.setAlphaBlend(),
        G && (y[m] || (y[m] = t.createEmptyTexture(v, b, this.runtime.linearSampling)),
        ...
        p = n.length; u < p; u++) {
            ...
            y[m].c2width === v && y[m].c2height === b || (t.deleteTexture(y[m]),
            y[m] = t.createEmptyTexture(v, b, this.runtime.linearSampling)),
            t.switchProgram(n[u].shaderindex),
            U = n[u].index,
            t.programIsAnimated(n[u].shaderindex) && (this.runtime.redraw = !0),
            0 != u || G)
                t.setProgramParameters(r, 1 / v, 1 / b, T.left, T.top, T.right, T.bottom, s, a, o, h, (o + c) / 2, (h + l) / 2, this.runtime.kahanTime.sum, i ? i.effect_params[U] : e ? e.effect_params[U] : this.effect_params[U]),
                t.setTexture(null),
                u !== V || z ? (t.setRenderingToTexture(y[m]),
                f = b - k - (g = I - k),
                t.clearRect(C, f, P - C, g)) : (i ? t.setBlend(i.srcBlend, i.destBlend) : e && t.setBlend(e.srcBlend, e.destBlend),
                t.setRenderingToTexture(r)),
                t.setTexture(y[_]),
                t.resetModelView(),
                t.translate(-w, -x),
                t.updateModelView(),
                t.quadTex(O, L, E, L, E, A, O, A, S),
                u !== V || z || t.setTexture(null);
            else {
                ...
                i) {
                    ...
                    if (i.curFrame && i.curFrame.texture_img) {
                        ...
                        X = 1 / i.width,
                        q = 1 / i.height;
                    t.setProgramParameters(r, X, q, T.left, T.top, T.right, T.bottom, s, a, o, h, (o + c) / 2, (h + l) / 2, this.runtime.kahanTime.sum, i.effect_params[U]),
                    i.drawGL(t)
                } else
                    t.setProgramParameters(r, 1 / v, 1 / b, 0, 0, 1, 1, s, a, o, h, (o + c) / 2, (h + l) / 2, this.runtime.kahanTime.sum, e ? e.effect_params[U] : this.effect_params[U]),
        ...
        O = 0,
        A = 0,
        E = this.runtime.width,
        L = this.runtime.height),
        t.setRenderingToTexture(r),
        t.setTexture(y[_]),
        t.resetModelView(),
        t.translate(-w, -x),
        t.updateModelView(),
        i && 1 === n.length && !G ? t.quadTex(O, A, E, A, E, L, O, L, S) : t.quadTex(O, L, E, L, E, A, O, A, S),
        t.setTexture(null))
    }
    ,
    ...
    t.prototype.saveToJSON = function() {
        ...
        e = this.layers.length; t < e; t++)
            i = this.layers[t],
            n.layers[i.sid.toString()] = i.saveToJSON();
        return n
    }
    ,
    t.prototype.loadFromJSON = function(t) {
        ...
        for (e = 0,
        i = a.length; e < i; e++)
            (r = this.getEffectByName(a[e].name)) && (r.active = a[e].active,
            this.effect_params[r.index] = a[e].params);
        this.updateActiveEffects();
        var o = t.layers;
        for (n in o)
            if (o.hasOwnProperty(n)) {
                if (!(s = this.getLayerBySid(parseInt(n, 10))))
                    continue;
                s.loadFromJSON(o[n])
            }
    }
    ...
    s.prototype.createInitialInstances = function() {
        ...
        for (t = 0,
        i = 0,
        r = this.initial_instances.length; t < r; t++) {
            if (s = this.initial_instances[t],
            a = this.runtime.types_by_index[s[1]],
            o = !0,
            !this.runtime.typeHasPersistBehavior(a) || this.layout.first_visit) {
                if (!(n = this.runtime.createInstanceFromInit(s, this, !0)))
                    continue;
                e.push(n),
                n.type.global && (o = !1,
                this.created_globals.push(n.uid))
            }
            o && (this.initial_instances[i] = this.initial_instances[t],
            i++)
        }
    ...
    s.prototype.recreateInitialObjects = function(t, e) {
        var i, r, n, s, a, o, h, c, l, u, p, d = this.runtime.types_by_index, f = t.is_family, g = t.members;
        for (i = 0,
        r = this.initial_instances.length; i < r; ++i)
            if (o = (a = (n = this.initial_instances[i])[0])[0],
            h = a[1],
            e.contains_pt(o, h)) {
                if ((s = d[n[1]]) !== t) {
                    if (!f)
                ...
                if (c = this.runtime.createInstanceFromInit(n, this, !1),
    ...
    s.prototype.moveInstanceAdjacent = function(t, e, i) {
        var r = t.get_zindex()
          , n = e.get_zindex();
        cr.arrayRemove(this.instances, r),
        r < n && n--,
        i && n++,
        n === this.instances.length ? this.instances.push(t) : this.instances.splice(n, 0, t),
        this.setZIndicesStaleFrom(r < n ? r : n)
    }
    ,
    ...
    function c(t, e, i) {
        var r, n, s = 0, a = 0, o = 0, h = t.length, c = e.length;
        for (i.length = h + c; s < h && a < c; ++o)
            r = t[s],
            n = e[a],
            r.zindex < n.zindex ? (i[o] = r,
            ++s) : (i[o] = n,
            ++a);
        for (; s < h; ++s,
        ++o)
    ...
    function u(t, e) {
        var i, r, n, s, a;
        for (i = 0,
        r = t.length; i < r - 1; i += 2)
            c(n = t[i], s = t[i + 1], a = o()),
            e || (h(n),
            h(s)),
            l.push(a);
        r % 2 == 1 && (e ? (n = o(),
        cr.shallowAssignArray(n, t[r - 1]),
        l.push(n)) : l.push(t[r - 1])),
    ...
    s.prototype.draw = function(t) {
        ...
        e.height !== this.runtime.draw_height && (e.height = this.runtime.draw_height,
        r = !0),
        r && this.runtime.setCtxImageSmoothingEnabled(i, this.runtime.linearSampling),
        ...
        a = this.getRenderCellInstancesToDraw(),
        this.render_list_stale = !1,
        this.last_render_cells.copy(this.cur_render_cells)) : a = this.last_render_list) : a = this.instances;
        var c, l, u, p = null;
        for (c = 0,
        l = a.length; c < l; ++c)
            (u = a[c]) !== p && (this.drawInstance(u, i),
            p = u);
        this.useRenderCells && (this.last_render_list = a),
        i.restore(),
    ...
    s.prototype.rotateViewport = function(t, e, i) {
        ...
        this.viewLeft = t,
        this.viewTop = e,
        this.viewRight = t + this.runtime.draw_width * (1 / n),
        this.viewBottom = e + this.runtime.draw_height * (1 / n),
        this.viewLeft > this.viewRight && (r = this.viewLeft,
        this.viewLeft = this.viewRight,
        this.viewRight = r),
        this.viewTop > this.viewBottom && (r = this.viewTop,
    ...
    s.prototype.drawGL_earlyZPass = function(t) {
        ...
        for (s = r.length - 1; s >= 0; --s)
            (a = r[s]) !== o && (this.drawInstanceGL_earlyZPass(r[s], t),
            o = a);
    ...
    s.prototype.drawGL = function(t) {
        ...
        for (o = 0,
        c = s.length; o < c; ++o)
            (l = s[o]) !== u && (this.drawInstanceGL(s[o], t),
            u = l);
        ...
        this.render_offscreen)
            ...
            0 === this.active_effect_types.length || 1 === this.active_effect_types.length && !t.programUsesCrossSampling(e) && 1 === this.opacity) {
                ...
                t.setProgramParameters(this.layout.getRenderTarget(), 1 / this.runtime.draw_width, 1 / this.runtime.draw_height, 0, 0, 1, 1, a, this.getAngle(), this.viewLeft, this.viewTop, (this.viewLeft + this.viewRight) / 2, (this.viewTop + this.viewBottom) / 2, this.runtime.kahanTime.sum, this.effect_params[i]),
    ...
    s.prototype.drawInstanceWithShadersGL = function(t, e) {
        ...
        if (1 !== t.active_effect_types.length || e.programUsesCrossSampling(i) || e.programExtendsBox(i) || (t.angle || t.layer.getAngle()) && e.programUsesDest(i) || 1 !== t.opacity || t.type.plugin.must_predraw)
            ...
            if (t.curFrame && t.curFrame.texture_img) {
                ...
                s = 1 / t.width,
                a = 1 / t.height;
            e.setProgramParameters(this.render_offscreen ? this.runtime.layer_tex : this.layout.getRenderTarget(), s, a, o, h, c, l, n, this.getAngle(), this.viewLeft, this.viewTop, (this.viewLeft + this.viewRight) / 2, (this.viewTop + this.viewBottom) / 2, this.runtime.kahanTime.sum, t.effect_params[r]),
            t.drawGL(e)
        }
    }
    ,
    s.prototype.canvasToLayer = function(t, e, i, r) {
        ...
        var s = this.runtime.parallax_x_origin
          ...
          , l = h
          , u = 1 / this.getScale(!r);
        r ? (c -= this.runtime.draw_width * u / 2,
    ...
    s.prototype.loadFromJSON = function(t) {
        ...
        for (e = 0,
        n = this.created_globals.length; e < n; ++e)
            a.add(this.created_globals[e]);
        for (e = 0,
        r = 0,
        n = this.initial_instances.length; e < n; ++e)
            a.contains(this.initial_instances[e][2]) || (this.initial_instances[r] = this.initial_instances[e],
            ++r);
        cr.truncateArray(this.initial_instances, r);
        var o = t.fx;
        for (e = 0,
        n = o.length; e < n; e++)
            (s = this.getEffectByName(o[e].name)) && (s.active = o[e].active,
            this.effect_params[s.index] = o[e].params);
        this.updateActiveEffects(),
...
function() {
    ...
    function r(r) {
        var n, s, a, o, h;
        for (2 === r.length ? r[0].index > r[1].index && (o = r[0],
        r[0] = r[1],
        r[1] = o) : r.length > 2 && r.sort(i),
        r.length >= t.length && (t.length = r.length + 1),
        t[r.length] || (t[r.length] = []),
        n = 0,
        s = (h = t[r.length]).length; n < s; n++)
            if (e(r, a = h[n]))
                return a;
        return h.push(r),
        r
    ...
    function a(t, e, i) {
        ...
        if (8 === i.length) {
            ...
            for (r = 0,
            n = c.length; r < n; r++)
                this.sheet.init_event(c[r], this, this.subevents)
        }
    ...
    n.prototype.init_event = function(t, e, i) {
        ...
        case 0:
            ...
            s.orblock)
                for (i.push(s),
                r = 0,
                n = s.conditions.length; r < n; r++)
                    s.conditions[r].trigger && this.init_trigger(s, r);
            else
    ...
    n.prototype.addDeepIncludes = function(t) {
        var e, i, r, n, s = t.deep_includes, a = t.already_included_sheets, o = this.includes.valuesRef();
        for (e = 0,
        i = o.length; e < i; ++e)
            n = (r = o[e]).include_sheet,
            !r.isActive() || t === n || a.indexOf(n) > -1 || (a.push(n),
            n.addDeepIncludes(t),
            s.push(n))
    }
    ,
    ...
    n.prototype.init_trigger = function(t, e) {
        ...
        if (n) {
            ...
            u = a.length; l < u; l++)
                if (a[l].method == o)
                    return void ((h = a[l].evs)[p] ? h[p].push([t, e]) : h[p] = [[t, e]]);
            (h = {})[p] = [[t, e]],
            a.push({
                method: o,
                evs: h
    ...
    a.prototype.postInit = function(t) {
        ...
        n = this.parent; n; ) {
            for (e = 0,
            i = n.solModifiers.length; e < i; e++)
                this.addParentSolModifier(n.solModifiers[e]);
            n = n.parent
        }
        for (this.solModifiers = r(this.solModifiers),
    ...
    a.prototype.run = function() {
        var t, e, i = !1, r = this.runtime, n = this.runtime.getCurrentEventStack();
        ...
        this.orblock) {
            for (0 === s.length && (i = !0),
            n.cndindex = 0,
            t = s.length; n.cndindex < t; n.cndindex++)
                (e = s[n.cndindex]).trigger || e.run() && (i = !0);
            n.last_event_true = i,
            ...
            t = s.length; n.cndindex < t; n.cndindex++)
                if (!s[n.cndindex].run())
                    ...
                    void (this.toplevelevent && r.hasPendingInstances && r.ClearDeathRow());
            n.last_event_true = !0,
        ...
        if (this.subevents.length) {
            ...
            this.solWriterAfterCnds)
                ...
                e = this.subevents.length; t < e; t++)
                    i = this.subevents[t],
                    (r = !this.toplevelgroup || !this.group && t < n) && this.runtime.pushCopySol(i.solModifiers),
                    i.run(),
                    r ? this.runtime.popSol(i.solModifiers) : this.runtime.clearSol(i.solModifiers);
            else
                for (t = 0,
                e = this.subevents.length; t < e; t++)
    ...
    h.prototype.run_object = function() {
        var t, e, i, r, n, s, a, o, h, c, l, u, p = this.type, d = p.getCurrentSol(), f = this.block.orblock && !this.trigger, g = 0, y = p.is_contained, m = p.is_family, _ = p.family_index, v = this.beh_index, b = v > -1, w = this.anyParamVariesPerInstance, x = this.parameters, S = this.results, T = this.inverted, O = this.func;
        if (w)
            for (e = 0,
            n = x.length; e < n; ++e)
                (s = x[e]).variesPerInstance || (S[e] = s.get(0));
        else
            for (e = 0,
            n = x.length; e < n; ++e)
                S[e] = x[e].get(0);
        if (d.select_all) {
            ...
            t = 0,
            r = (l = p.instances).length; t < r; ++t) {
                if (o = l[t],
                w)
                    for (e = 0,
                    n = x.length; e < n; ++e)
                        (s = x[e]).variesPerInstance && (S[e] = s.get(t));
                b ? (g = 0,
                m && (g = o.type.family_beh_map[_]),
                a = O.apply(o.behavior_insts[v + g], S)) : a = O.apply(o, S),
                cr.xor(a, T) ? d.instances.push(o) : f && d.else_instances.push(o)
            }
        ...
        var C = f && !this.block.isFirstConditionOfType(this)
          , A = !1;
        for (t = 0,
        r = (l = C ? d.else_instances : d.instances).length; t < r; ++t) {
            if (o = l[t],
            w)
                for (e = 0,
                n = x.length; e < n; ++e)
            ...
            cr.xor(a, T))
                if (A = !0,
                C) {
                    if (d.instances.push(o),
                    y)
                        for (e = 0,
                        n = o.siblings.length; e < n; e++)
                            (h = o.siblings[e]).type.getCurrentSol().instances.push(h)
                } else {
                    if (l[i] = o,
                    y)
                        for (e = 0,
                        n = o.siblings.length; e < n; e++)
                            (h = o.siblings[e]).type.getCurrentSol().instances[i] = h;
                    i++
                }
            else if (C) {
                if (l[i] = o,
                y)
                    for (e = 0,
                    n = o.siblings.length; e < n; e++)
                        (h = o.siblings[e]).type.getCurrentSol().else_instances[i] = h;
                i++
            } else if (f && (d.else_instances.push(o),
            y))
                for (e = 0,
                n = o.siblings.length; e < n; e++)
                    (h = o.siblings[e]).type.getCurrentSol().else_instances.push(h)
        }
        if (cr.truncateArray(l, i),
        y)
            for (t = 0,
            r = (u = p.container).length; t < r; t++)
                c = u[t].getCurrentSol(),
                C ? cr.truncateArray(c.else_instances, i) : cr.truncateArray(c.instances, i);
        var k = A;
        if (C && !A)
            for (t = 0,
            r = d.instances.length; t < r; t++) {
                if (o = d.instances[t],
                w)
                    for (e = 0,
                    n = x.length; e < n; e++)
                        (s = x[e]).variesPerInstance && (S[e] = s.get(t));
                if (a = b ? O.apply(o.behavior_insts[v], S) : O.apply(o, S),
                cr.xor(a, T)) {
                    A = !0;
                    break
                }
            }
        return p.finish && p.finish(k || f),
        f ? A : d.hasObjects()
    }
    ,
    cr.condition = h,
    ...
    c.prototype.run_system = function() {
        var t, e, i = this.runtime, r = this.parameters, n = this.results;
        for (t = 0,
        e = r.length; t < e; ++t)
            n[t] = r[t].get();
    ...
    c.prototype.run_object = function() {
        var t, e, i, r, n, s, a, o = this.type, h = this.beh_index, c = o.family_index, l = this.anyParamVariesPerInstance, u = this.parameters, p = this.results, d = this.func, f = o.getCurrentSol().getObjects(), g = o.is_family, y = h > -1;
        if (l)
            for (e = 0,
            r = u.length; e < r; ++e)
        ...
        i = f.length; t < i; ++t) {
            ...
            y ? (a = 0,
            g && (a = s.type.family_beh_map[c]),
            d.apply(s.behavior_insts[h + a], p)) : d.apply(s, p)
        }
        return !1
    }
    ,
    ...
    f.prototype.get_familyvar = function(t) {
        ...
        if (s.length)
            ...
            r = n.else_instances[e % n.else_instances.length].type;
        else {
...
function() {
    function t(t, e) {
        ...
        case 19:
            ...
            this.parameters = [],
            3 === e.length ? (n = e[2],
            this.results.length = n.length + 1) : this.results.length = 1;
            break;
        case 20:
        ...
        n)
            for (i = 0,
            r = n.length; i < r; i++)
                this.parameters.push(new cr.expNode(t,n[i]));
        cr.seal(this)
    }
    ...
    t.prototype.eval_instvar_exp = function(t) {
        var e, i = this.instance_expr, s = this.object_type, a = this.varindex, o = this.owner.solindex, h = s.getCurrentSol(), c = h.getObjects();
        if (!c.length) {
...
cr.system_object.prototype.saveToJSON = function() {
    ...
    e = this.waits.length; t < e; t++) {
        ...
        i = 0,
        r = s.solModifiers.length; i < r; i++)
            c.sm.push(s.solModifiers[i].sid);
        for (n in s.sols)
            if (s.sols.hasOwnProperty(n)) {
                for (a = this.runtime.types_by_index[parseInt(n, 10)],
                o = {
                    sa: s.sols[n].sa,
                    insts: []
                },
                i = 0,
                r = s.sols[n].insts.length; i < r; i++)
                    o.insts.push(s.sols[n].insts[i].uid);
...
cr.system_object.prototype.loadFromJSON = function(t) {
    ...
    i = f.length; e < i; e++)
        if (a = f[e],
        h = this.runtime.blocksBySid[a.ev.toString()]) {
            for (c = -1,
            r = 0,
            n = h.actions.length; r < n; r++)
            ...
            if (-1 !== c) {
                ...
                r = 0,
                n = a.sm.length; r < n; r++)
                    (l = this.runtime.getObjectTypeBySid(a.sm[r])) && o.solModifiers.push(l);
                for (s in a.sols)
                    if (a.sols.hasOwnProperty(s)) {
                        ...
                        r = 0,
                        n = u.insts.length; r < n; r++)
                            (d = this.runtime.getObjectByUID(u.insts[r])) && p.insts.push(d);
...
function() {
    ...
    e.prototype.CompareTime = function(t, e) {
        ...
        if (0 === t) {
            ...
            return !r.extra.CompareTime_executed && i >= e && (r.extra.CompareTime_executed = !0,
            !0)
        }
    ...
    e.prototype.Repeat = function(t) {
        var e, i = this.runtime.getCurrentEventStack(), r = i.current_event, n = i.isModifierAfterCnds(), s = this.runtime.pushLoopStack();
        if (n)
    ...
    e.prototype.For = function(t, e, i) {
        var r, n = this.runtime.getCurrentEventStack(), s = n.current_event, a = n.isModifierAfterCnds(), o = this.runtime.pushLoopStack(t);
        if (i < e)
            if (a)
                for (r = e; r >= i && !o.stopped; --r)
    ...
    e.prototype.ForEach = function(t) {
        ...
        var s, a, o, h, c, l, u, p = this.runtime.getCurrentEventStack(), d = p.current_event, f = p.isModifierAfterCnds(), g = this.runtime.pushLoopStack(), y = t.is_contained;
        if (f)
            for (s = 0,
            a = n.length; s < a && !g.stopped; s++) {
                ...
                y)
                    for (o = 0,
                    h = c.siblings.length; o < h; o++)
                        (u = (l = c.siblings[o]).type.getCurrentSol()).select_all = !1,
                        cr.clearArray(u.instances),
                        u.instances[0] = l;
                g.index = s,
                d.retrigger(),
    ...
    e.prototype.ForEachOrdered = function(t, e, s) {
        ...
        for (h = 0,
        c = o.length; h < c; h++)
            o[h].extra.c2_feo_val = m.parameters[1].get(h);
        o.sort(n),
        1 === s && o.reverse();
        var b = t.is_contained;
        if (_)
            for (h = 0,
            c = o.length; h < c && !v.stopped; h++) {
    ...
    e.prototype.PickByComparison = function(t, e, n, s) {
        ...
        if (t) {
            ...
            o = l.length; a < o; a++)
                c = l[a],
                l[h] = c,
                e = p.parameters[1].get(a),
                s = p.parameters[3].get(a),
                cr.do_cmp(e, n, s) ? h++ : u.else_instances.push(c);
    ...
    e.prototype.PickByEvaluate = function(t, e) {
        ...
        if (t) {
            ...
            s = h.length; n < s; n++)
                o = h[n],
                h[a] = o,
                l.parameters[1].get(n) ? a++ : c.else_instances.push(o);
            return cr.truncateArray(h, a),
            c.select_all = !1,
    ...
    e.prototype.Every = function(t) {
        ...
        return r >= i + n ? (e.extra.Every_lastTime = i + n,
        r >= e.extra.Every_lastTime + .04 && (e.extra.Every_lastTime = r),
        e.extra.Every_seconds = t,
        !0) : (r < i - .1 && (e.extra.Every_lastTime = r),
        !1)
    }
    ,
    ...
    var s = null
      ...
      , o = "";
    function h(t, e) {
        return s && t === a && e === o || (s = new RegExp(t,e),
        a = t,
        o = e),
        s.lastIndex = 0,
        s
    ...
    e.prototype.PickOverlappingPoint = function(t, e, i) {
        if (!t)
            return !1;
        var r, n, s, a = t.getCurrentSol(), o = a.getObjects(), h = this.runtime.getCurrentEventStack().current_event.orblock, l = this.runtime.getCurrentCondition();
        for (a.select_all ? (cr.shallowAssignArray(c, o),
        cr.clearArray(a.else_instances),
        a.select_all = !1,
        cr.clearArray(a.instances)) : h ? (cr.shallowAssignArray(c, a.else_instances),
        cr.clearArray(a.else_instances)) : (cr.shallowAssignArray(c, o),
        cr.clearArray(a.instances)),
        r = 0,
        n = c.length; r < n; ++r)
            (s = c[r]).update_bbox(),
            cr.xor(s.contains_pt(e, i), l.inverted) ? a.instances.push(s) : a.else_instances.push(s);
        return t.applySolToContainer(),
        cr.xor(!!a.instances.length, l.inverted)
    }
    ,
        ...
        if (e && t) {
            ...
            if (n) {
                ...
                n.is_contained)
                    for (s = 0,
                    a = n.siblings.length; s < a; s++)
                        (h = (o = n.siblings[s]).type.getCurrentSol()).select_all = !1,
                        cr.clearArray(h.instances),
                        h.instances[0] = o
            }
        }
    ...
    l.prototype.Wait = function(t) {
        if (!(t < 0)) {
            var e, i, r, n, s, a = this.runtime.getCurrentEventStack(), o = p();
            for (o.time = this.runtime.kahanTime.sum + t,
            o.signaltag = "",
            o.signalled = !1,
            o.ev = a.current_event,
            o.actindex = a.actindex + 1,
            e = 0,
            i = this.runtime.types_by_index.length; e < i; e++)
                (r = (n = this.runtime.types_by_index[e]).getCurrentSol()).select_all && -1 === a.current_event.solModifiers.indexOf(n) || (o.solModifiers.push(n),
                (s = g()).sa = r.select_all,
    ...
    l.prototype.Signal = function(t) {
        ...
        i = this.waits.length; e < i; ++e)
            -1 === (r = this.waits[e]).time && r.signaltag === n && (r.signalled = !0)
    }
    ,
    ...
    l.prototype.SetLayerParallax = function(t, e, i) {
        if (t && (t.parallaxX !== e / 100 || t.parallaxY !== i / 100)) {
            ...
            1 !== t.parallaxX || 1 !== t.parallaxY) {
                ...
                for (r = 0,
                n = s.length; r < n; ++r)
                    s[r].type.any_instance_parallaxed = !0
            }
            this.runtime.redraw = !0
        }
    }
    ...
    l.prototype.SetLayerBackground = function(t, e) {
        if (t) {
            var i = cr.GetRValue(e)
              , r = cr.GetGValue(e)
              , n = cr.GetBValue(e);
            t.background_color[0] === i && t.background_color[1] === r && t.background_color[2] === n || (t.background_color[0] = i,
            t.background_color[1] = r,
            t.background_color[2] = n,
            this.runtime.redraw = !0)
        }
    }
    ,
    ...
    l.prototype.RestartLayout = function(t) {
        ...
        if (!this.runtime.isloading && (!this.runtime.changelayout && this.runtime.running_layout))
            ...
            i = this.runtime.allGroups.length; e < i; e++)
                (r = this.runtime.allGroups[e]).setGroupActive(r.initially_activated)
    }
    ,
    ...
    l.prototype.SetLayoutEffectParam = function(t, e, i) {
        if (this.runtime.running_layout && this.runtime.glwrap) {
            ...
            if (r) {
                ...
                (e = Math.floor(e)) < 0 || e >= n.length || (1 === this.runtime.glwrap.getProgramParameterType(r.shaderindex, e) && (i /= 100),
                n[e] !== i && (n[e] = i,
    ...
    l.prototype.SetLayerEffectParam = function(t, e, i, r) {
        if (t && this.runtime.glwrap) {
            ...
            if (n) {
                ...
                (i = Math.floor(i)) < 0 || i >= s.length || (1 === this.runtime.glwrap.getProgramParameterType(n.shaderindex, i) && (r /= 100),
                s[i] !== r && (s[i] = r,
    ...
    l.prototype.SortZOrderByInstVar = function(t, e) {
        if (t) {
            var i, r, n, s, a, o, h = t.getCurrentSol().getObjects(), c = [], l = [], u = this.runtime.running_layout, p = t.is_family, d = t.family_index;
            for (i = 0,
            r = h.length; i < r; ++i)
                (n = h[i]).layer && (s = p ? n.instance_vars[e + n.type.family_var_map[d]] : n.instance_vars[e],
                c.push([n.layer.index, n.get_zindex()]),
                l.push([n, s]));
            if (c.length)
                for (c.sort(m),
                l.sort(_),
                ...
                r = c.length; i < r; ++i)
                    ...
                    a = u.layers[c[i][0]],
                    o = c[i][1],
                    a.instances[o] !== n && (a.instances[o] = n,
                    n.layer = a,
                    a.setZIndicesStaleFrom(o))
        }
    }
    ,
    t.acts = new l,
    ...
    v.prototype.max = function(t) {
        ...
        i = arguments.length; e < i; e++)
            "number" == typeof (r = arguments[e]) && n < r && (n = r);
        t.set_float(n)
    }
    ,
        ...
        if (this.runtime.loop_stack.length)
            if (e) {
                for (r = this.runtime.loop_stack_index; r >= 0; --r)
                    if ((i = this.runtime.loop_stack[r]).name === e)
    ...
    v.prototype.anglerotate = function(t, e, i, r) {
        ...
        i = cr.to_radians(i),
        r = cr.to_radians(r),
        t.set_float(cr.to_clamped_degrees(cr.angleRotate(e, i, r)))
    }
    ,
    v.prototype.zeropad = function(t, e, i) {
        var r = e < 0 ? "-" : "";
        e < 0 && (e = -e);
        for (var n = i - e.toString().length, s = 0; s < n; s++)
            r += "0";
    ...
    v.prototype.regexmatchat = function(t, e, i, r, n) {
        ...
        h(i, r);
        T(e.toString(), i, r),
        !b || n < 0 || n >= b.length ? t.set_string("") : t.set_string(b[n])
    }
    ,
    ...
    t.runWaits = function() {
        ...
        i = this.waits.length; t < i; t++) {
            if (-1 === (r = this.waits[t]).time) {
                if (!r.signalled)
                    continue
            } else if (r.time > this.runtime.kahanTime.sum)
                continue;
            for (n in o.current_event = r.ev,
            o.actindex = r.actindex,
            o.cndindex = 0,
            r.sols)
                r.sols.hasOwnProperty(n) && (s = this.runtime.types_by_index[parseInt(n, 10)].getCurrentSol(),
                a = r.sols[n],
                s.select_all = a.sa,
                cr.shallowAssignArray(s.instances, a.insts),
                y(a));
...
function() {
    cr.add_common_aces = function(t, e) {
        ...
        c.PickDistance = function(t, e, i) {
            ...
            if (!n.length)
                return !1;
            var s, a, o, h = n[0], c = h, l = cr.distanceTo(h.x, h.y, e, i);
            for (s = 1,
            a = n.length; s < a; s++)
                h = n[s],
                o = cr.distanceTo(h.x, h.y, e, i),
                (0 === t && o < l || 1 === t && o > l) && (l = o,
                c = h);
            return r.pick_one(c),
            !0
        ...
        l.SetPosToObject = function(t, e) {
            ...
            n && (n.getImagePoint ? (i = n.getImagePoint(e, !0),
            r = n.getImagePoint(e, !1)) : (i = n.x,
            r = n.y),
            this.x === i && this.y === r || (this.x = i,
            this.y = r,
            this.set_bbox_changed()))
        }
        ,
        ...
        l.RotateTowardPosition = function(t, e, i) {
            ...
            isNaN(a) || this.angle !== a && (this.angle = a,
            this.set_bbox_changed())
        }
        ,
        l.SetTowardPosition = function(t, e) {
            var i = t - this.x
              , r = e - this.y
              , n = Math.atan2(r, i);
            isNaN(n) || this.angle !== n && (this.angle = n,
            this.set_bbox_changed())
        }
        ,
        u.Angle = function(t) {
        ...
        c.PickInstVarHiLow = function(t, e) {
            ...
            if (!r.length)
                return !1;
            var n, s, a, o = r[0], h = o, c = o.instance_vars[e];
            for (n = 1,
            s = r.length; n < s; n++)
                a = (o = r[n]).instance_vars[e],
                (0 === t && a < c || 1 === t && a > c) && (c = a,
                h = o);
            return i.pick_one(h),
            !0
        ...
        c.PickByUID = function(t) {
            ...
            if (this.runtime.getCurrentCondition().inverted) {
                if ((o = this.getCurrentSol()).select_all) {
                    ...
                    e = 0,
                    i = (a = this.instances).length; e < i; e++)
                        (n = a[e]).uid === t ? o.else_instances.push(n) : o.instances.push(n);
                    return this.applySolToContainer(),
                    !!o.instances.length
                }
                for (e = 0,
                r = 0,
                i = o.instances.length; e < i; e++)
                    n = o.instances[e],
                    o.instances[r] = n,
                    n.uid === t ? o.else_instances.push(n) : r++;
                return cr.truncateArray(o.instances, r),
                this.applySolToContainer(),
                !!o.instances.length
            }
            if (!(n = this.runtime.getObjectByUID(t)))
                return !1;
            if (!(o = this.getCurrentSol()).select_all && -1 === o.instances.indexOf(n))
                return !1;
            if (this.is_family) {
                for (e = 0,
                i = (s = n.type.families).length; e < i; e++)
                    if (s[e] === this)
                        return o.pick_one(n),
                        this.applySolToContainer(),
                        !0
        ...
        l.LoadFromJsonString || (l.LoadFromJsonString = function(t) {
            ...
            this.behavior_insts)
                for (i = 0,
                r = this.behavior_insts.length; i < r; ++i)
        ...
        u.Count = function(t) {
            ...
            i = this.runtime.createRow.length; e < i; e++)
                r = this.runtime.createRow[e],
                t.object_class.is_family ? r.type.families.indexOf(t.object_class) >= 0 && n++ : r.type === t.object_class && n++;
            t.set_int(n)
        }
        ,
        ...
        c.PickTopBottom = function(t) {
            ...
            n = i.length; r < n; r++)
                s = i[r],
                0 === t ? (s.layer.index > a.layer.index || s.layer.index === a.layer.index && s.get_zindex() > a.get_zindex()) && (a = s) : (s.layer.index < a.layer.index || s.layer.index === a.layer.index && s.get_zindex() < a.get_zindex()) && (a = s);
            return e.pick_one(a),
            !0
        }
        ,
        ...
        l.ZMoveToObject = function(t, e) {
            ...
            if (e) {
                ...
                r && r.uid !== this.uid && (this.layer.index !== r.layer.index && (this.layer.removeFromInstanceList(this, !0),
                this.layer = r.layer,
                r.layer.appendToInstanceList(this, !0)),
                this.layer.moveInstanceAdjacent(this, r, i),
                this.runtime.redraw = !0)
            }
        }
        ,
        ...
        h && (l.SetEffectEnabled = function(t, e) {
            if (this.runtime.glwrap) {
                ...
                if (!(i < 0)) {
                    var r = 1 === t;
                    this.active_effect_flags[i] !== r && (this.active_effect_flags[i] = r,
                    this.updateActiveEffects(),
                    this.runtime.redraw = !0)
                }
            }
        ...
        l.SetEffectParam = function(t, e, i) {
            if (this.runtime.glwrap) {
                ...
                if (!(r < 0)) {
                    ...
                    (e = Math.floor(e)) < 0 || e >= s.length || (1 === this.runtime.glwrap.getProgramParameterType(n.shaderindex, e) && (i /= 100),
                    s[e] !== i && (s[e] = i,
                    n.active && (this.runtime.redraw = !0)))
                }
            }
    ...
    cr.inst_updateActiveEffects = function() {
        ...
        e = this.active_effect_flags.length; t < e; t++)
            ...
            i.preservesOpaqueness || (r = !1));
        this.uses_shaders = !!this.active_effect_types.length,
        this.shaders_preserve_opaqueness = r
    }
    ,
    ...
    cr.type_pushCopySol = function() {
        ...
        e.select_all ? (t.select_all = !0,
        cr.clearArray(t.else_instances)) : (t.select_all = !1,
        cr.shallowAssignArray(t.instances, e.instances),
        cr.shallowAssignArray(t.else_instances, e.else_instances))
    }
    ,
    ...
    cr.type_getBehaviorByName = function(t) {
        ...
        if (!this.is_family)
            ...
            i = this.families.length; e < i; e++)
                for (r = 0,
                n = (s = this.families[e]).behaviors.length; r < n; r++) {
                    if (t === s.behaviors[r].name)
                        return this.extra.lastBehIndex = a,
                        s.behaviors[r];
                    a++
                }
        for (e = 0,
    ...
    cr.type_applySolToContainer = function() {
        if (this.is_contained && !this.is_family) {
            ...
            e = this.container.length; t < e; t++)
                if ((n = this.container[t]) !== this && (n.updateIIDs(),
                (a = n.getCurrentSol()).select_all = o,
                !o)) {
                    for (cr.clearArray(a.instances),
                    i = 0,
                    r = s.instances.length; i < r; ++i)
                        a.instances[i] = n.getInstanceByIID(s.instances[i].iid);
                    if (c)
                        for (cr.clearArray(a.else_instances),
                        i = 0,
                        r = s.else_instances.length; i < r; ++i)
                            a.else_instances[i] = n.getInstanceByIID(s.else_instances[i].iid)
                }
        }
    }
    ,
...
function() {
    ...
    e.onCreate = function() {
        ...
        this.recycled || (this.arr = r());
        var t, e, i, n = this.arr;
        for (n.length = this.cx,
        t = 0; t < this.cx; t++)
            for (n[t] || (n[t] = r()),
            n[t].length = this.cy,
            e = 0; e < this.cy; e++)
                for (n[t][e] || (n[t][e] = r()),
                n[t][e].length = this.cz,
                i = 0; i < this.cz; i++)
                    n[t][e][i] = 0;
        this.forX = [],
        this.forY = [],
    ...
    e.at = function(t, e, i) {
        ...
        e = Math.floor(e),
        i = Math.floor(i),
        isNaN(t) || t < 0 || t > this.cx - 1 ? 0 : isNaN(e) || e < 0 || e > this.cy - 1 ? 0 : isNaN(i) || i < 0 || i > this.cz - 1 ? 0 : this.arr[t][e][i]
    }
    ,
    e.set = function(t, e, i, r) {
        ...
        e = Math.floor(e),
        i = Math.floor(i),
        isNaN(t) || t < 0 || t > this.cx - 1 || isNaN(e) || e < 0 || e > this.cy - 1 || isNaN(i) || i < 0 || i > this.cz - 1 || (this.arr[t][e][i] = r)
    }
    ,
    ...
    e.setSize = function(t, e, i) {
        ...
        this.cx !== t || this.cy !== e || this.cz !== i) {
            ...
            for (o.length = t,
            n = 0; n < this.cx; n++)
                for (cr.is_undefined(o[n]) && (o[n] = r()),
                o[n].length = e,
                s = 0; s < this.cy; s++)
                    for (cr.is_undefined(o[n][s]) && (o[n][s] = r()),
                    o[n][s].length = i,
                    a = 0; a < this.cz; a++)
                        cr.is_undefined(o[n][s][a]) && (o[n][s][a] = 0)
        }
    }
    ,
    e.getForX = function() {
    ...
    a.prototype.Push = function(t, e, i) {
        ...
        case 0:
            ...
            o.push(r())) : (n = 0,
            o.unshift(r())),
            o[n].length = this.cy; s < this.cy; s++)
                for (o[n][s] = r(),
                o[n][s].length = this.cz,
                a = 0; a < this.cz; a++)
                    o[n][s][a] = e;
            this.cx++;
            break;
        ...
        case 2:
            for (; n < this.cx; n++)
                for (s = 0; s < this.cy; s++)
                    0 === t ? o[n][s].push(e) : o[n][s].unshift(e);
            this.cz++
        }
    }
    ,
    ...
    a.prototype.JSONDownload = function(t) {
        ...
        if (void 0 === e.download) {
            ...
            e.textContent = t,
            e.href = "data:application/json," + encodeURIComponent(this.getAsJSON()),
            e.download = t,
            r.appendChild(e);
    ...
    ,
    t.acts = new a,
    h.prototype.At = function(t, e, i, r) {
        var n = i || 0
          , s = r || 0;
...
function() {
    ...
    function N() {
        ...
        !y)
            for (t = 0,
            e = n.length; t < e; ++t)
                (i = n[t]).stopped || i.is_paused || (r = i.instanceObject.play()) && r.catch(function(t) {
                    I(i)
                })
    }
    function B(t) {
    ...
    function D(t) {
        ...
        j.hasOwnProperty(t) && j[t].length ? j[t][0].getInputNode() : l.destination
    }
    function W() {
        ...
        if (t)
            ...
            0 !== r) {
                ...
                case 1:
                    ...
                    t.linearRampToValueAtTime(e, r);
                    break;
                case 2:
                    t.setValueAtTime(t.value, n),
                    t.exponentialRampToValueAtTime(e, r)
                }
            } else
                t.value = e
    }
    ...
    function H(t, e, i, r, n, s) {
        this.type = "filter",
        this.params = [t, e, i, r, n, s],
        this.inputNode = W(),
        this.wetNode = W(),
        this.wetNode.gain.value = s,
        this.dryNode = W(),
        this.dryNode.gain.value = 1 - s,
        this.filterNode = l.createBiquadFilter(),
    ...
    function J(t, e, i, r) {
        ...
        this.dryNode = W(),
        this.dryNode.gain.value = 1 - i,
        this.convolveNode = l.createConvolver(),
    ...
    function K(t, e, i, r, n) {
        ...
        this.feedbackNode = W(),
        this.feedbackNode.gain.value = r,
        this.delayNode = G(t + e),
        this.delayNode.delayTime.value = t,
        this.oscNode = l.createOscillator(),
    ...
    function et(t, e, i, r, n) {
        ...
        this.waveShaper = l.createWaveShaper(),
    ...
    function st(t, i) {
        ...
        case s:
            ...
            c === a && l.createMediaElementSource && !/wiiu/i.test(navigator.userAgent) && (this.supportWebAudioAPI = !0,
            this.bufferObject.addEventListener("canplay", function() {
                !n.mediaSourceNode && n.bufferObject && (n.mediaSourceNode = l.createMediaElementSource(n.bufferObject),
                n.mediaSourceNode.connect(n.outNode))
            })),
    ...
    function at(t, u) {
        ...
        this.onended_handler = function(t) {
            if (!p.is_paused && !p.resume_me) {
                var n = this;
                n || (n = t.target),
                n === p.active_buffer && (p.hasPlaybackEnded = !0,
                p.stopped = !0,
                r = p.tag,
        ...
        this.isTimescaled = 1 === g && !this.is_music || 2 === g,
        this.mutevol = 1,
        ...
        var d = !1;
        switch (this.myapi !== a || this.buffer.myapi !== s || this.buffer.supportWebAudioAPI || (this.myapi = s),
        this.myapi) {
        case s:
            this.is_music ? (this.instanceObject = t.bufferObject,
            d = !t.added_end_listener,
            ...
            d = !0),
            d && this.instanceObject.addEventListener("ended", function() {
                r = p.tag,
                p.stopped = !0,
                e.trigger(cr.plugins_.Audio.prototype.cnds.OnEnded, i)
            });
        ...
        case a:
            this.gainNode = W(),
            this.gainNode.connect(D(u)),
            this.buffer.myapi === a ? t.bufferObject && (this.instanceObject = l.createBufferSource(),
        ...
        case o:
            this.instanceObject = new window.Media(n + this.src,null,null,function(t) {
                t === window.Media.MEDIA_STOPPED && (p.hasPlaybackEnded = !0,
                p.stopped = !0,
                r = p.tag,
                e.trigger(cr.plugins_.Audio.prototype.cnds.OnEnded, i))
            }
    ...
    H.prototype.setParam = function(t, e, i, r) {
        ...
        case 0:
            ...
            e > 1 && (e = 1),
            this.params[5] = e,
            X(this.wetNode.gain, e, i, r),
            X(this.dryNode.gain, 1 - e, i, r);
            break;
        case 1:
            this.params[1] = e,
            X(this.filterNode.frequency, e, i, r);
            break;
        case 2:
            this.params[2] = e,
            X(this.filterNode.detune, e, i, r);
            break;
        case 3:
            this.params[3] = e,
            X(this.filterNode.Q, e, i, r);
            break;
        case 4:
            this.params[4] = e,
            X(this.filterNode.gain, e, i, r)
        }
    }
    ,
    ...
    Y.prototype.setParam = function(t, e, i, r) {
        ...
        case 4:
            this.params[1] = B(e),
            X(this.delayGainNode.gain, B(e), i, r);
            break;
        case 5:
            this.params[0] = e,
            X(this.delayNode.delayTime, e, i, r)
        }
    }
    ,
    ...
    K.prototype.setParam = function(t, e, i, r) {
        ...
        case 0:
            ...
            e > 1 && (e = 1),
            this.params[4] = e,
            X(this.wetNode.gain, e / 2, i, r),
            X(this.dryNode.gain, 1 - e / 2, i, r);
            break;
        case 6:
            this.params[1] = e / 1e3,
            X(this.oscGainNode.gain, e / 1e3, i, r);
            break;
        case 7:
            this.params[2] = e,
            X(this.oscNode.frequency, e, i, r);
            break;
        case 8:
            this.params[3] = e / 100,
            X(this.feedbackNode.gain, e / 100, i, r)
        }
    }
    ,
    ...
    $.prototype.setParam = function(t, e, i, r) {
        ...
        case 0:
            ...
            e > 1 && (e = 1),
            this.params[1] = e,
            X(this.node.gain.value, 1 - e / 2, i, r),
            X(this.oscGainNode.gain.value, e / 2, i, r);
            break;
        case 7:
            this.params[0] = e,
            X(this.oscNode.frequency, e, i, r)
    ...
    et.prototype.generateColortouchCurve = function(t, e) {
        for (var i = F(t), r = F(e), n = 32768, s = 0, a = 0; a < n; ++a)
            s = a / n,
            s = this.shape(s, i, r),
            this.curve[n + a] = s,
            this.curve[n - a - 1] = -s
    ...
    ,
    it.prototype.setParam = function(t, e, i, r) {}
    ,
    rt.prototype.tick = function() {
        this.node.getFloatFrequencyData(this.freqBins),
        this.node.getByteTimeDomainData(this.signal);
        var t = this.node.fftSize
          , e = 0;
        this.peak = 0;
        for (var i = 0, r = 0; e < t; e++)
            (r = (this.signal[e] - 128) / 128) < 0 && (r = -r),
            this.peak < r && (this.peak = r),
            i += r * r;
        this.peak = M(this.peak),
        this.rms = M(Math.sqrt(i / t))
    }
    ,
    ...
    ,
    rt.prototype.setParam = function(t, e, i, r) {}
    ,
    ...
    st.prototype.decodeAudioBuffer = function() {
        if (!this.bufferObject && this.audioData) {
            var t = this;
            if (l.decodeAudioData)
                l.decodeAudioData(this.audioData, function(i) {
                    var r, n, s, a;
                    if (t.bufferObject = i,
                    t.audioData = null,
                    cr.is_undefined(t.playTagWhenReady) || y) {
                        if (!cr.is_undefined(t.convolveWhenReady)) {
                            var o = t.convolveWhenReady.convolveNode;
                            o.normalize = t.normalizeWhenReady,
                            o.buffer = i
                        }
                    } else if (t.panWhenReady.length) {
                        for (n = 0,
                        s = t.panWhenReady.length; n < s; n++)
                            if (r = t.panWhenReady[n],
                            (a = new at(t,r.thistag)).setPannerEnabled(!0),
                            void 0 === r.objUid || (r.obj = e.getObjectByUID(r.objUid),
                            r.obj)) {
                                if (r.obj) {
                                    ...
                                    a.setPan(h, c, cr.to_degrees(r.obj.angle - r.obj.layer.getAngle()), r.ia, r.oa, r.og),
                                    a.setObject(r.obj)
                                } else
                                    a.setPan(r.x, r.y, r.a, r.ia, r.oa, r.og);
                                a.play(t.loopWhenReady, t.volumeWhenReady, t.seekWhenReady),
                                t.pauseWhenReady && a.pause(),
                                p.push(a)
                            }
                        cr.clearArray(t.panWhenReady)
                    } else
                        (a = new at(t,t.playTagWhenReady || "")).play(t.loopWhenReady, t.volumeWhenReady, t.seekWhenReady),
                        t.pauseWhenReady && a.pause(),
                        p.push(a)
                }, function(e) {
                    t.failedToLoad = !0
                });
            else if (this.bufferObject = l.createBuffer(this.audioData, !1),
            this.audioData = null,
            cr.is_undefined(this.playTagWhenReady) || y) {
    ...
    at.prototype.setPannerEnabled = function(t) {
        if (c === a)
            if (!this.pannerEnabled && t) {
                if (!this.gainNode)
                    return;
                this.pannerNode || (this.pannerNode = l.createPanner(),
                "number" == typeof this.pannerNode.panningModel ? this.pannerNode.panningModel = w : this.pannerNode.panningModel = ["equalpower", "HRTF", "soundfield"][w],
                "number" == typeof this.pannerNode.distanceModel ? this.pannerNode.distanceModel = x : this.pannerNode.distanceModel = ["linear", "inverse", "exponential"][x],
                this.pannerNode.refDistance = S,
                this.pannerNode.maxDistance = T,
                this.pannerNode.rolloffFactor = O),
                this.gainNode.disconnect(),
                this.gainNode.connect(this.pannerNode),
                this.pannerNode.connect(D(this.tag)),
                ...
                this.gainNode.disconnect(),
                this.gainNode.connect(D(this.tag)),
                this.pannerEnabled = !1
            }
    }
    ,
    at.prototype.setPan = function(t, e, i, r, n, s) {
        this.pannerEnabled && c === a && (this.pannerNode.setPosition(t, e, 0),
        this.pannerNode.setOrientation(Math.cos(cr.to_radians(i)), Math.sin(cr.to_radians(i)), 0),
        this.pannerNode.coneInnerAngle = r,
        this.pannerNode.coneOuterAngle = n,
        this.pannerNode.coneOuterGain = s,
        this.panX = t,
        this.panY = e,
        this.panAngle = i,
        this.panConeInner = r,
        this.panConeOuter = n,
        this.panConeOuterGain = s)
    }
    ,
    at.prototype.setObject = function(t) {
        this.pannerEnabled && c === a && (this.objectTracker || (this.objectTracker = new nt),
    ...
    at.prototype.tick = function(t) {
        if (this.pannerEnabled && c === a && this.objectTracker && this.objectTracker.hasObject() && this.isPlaying()) {
            ...
            var n = 0;
            void 0 !== this.objectTracker.obj.angle && (n = e.angle - e.layer.getAngle(),
            this.pannerNode.setOrientation(Math.cos(n), Math.sin(n), 0))
        }
    }
    ,
    at.prototype.play = function(t, i, r, n) {
        ...
        this.myapi) {
        case s:
            if (1 !== c.playbackRate && (c.playbackRate = 1),
            c.volume !== i * m && (c.volume = i * m),
            c.loop !== t && (c.loop = t),
            c.muted && (c.muted = !1),
            c.currentTime !== u)
                try {
        ...
        case a:
            ...
            this.mutevol = 1,
            this.buffer.myapi === a)
                this.gainNode.gain.value = i * m,
                this.fresh || (this.instanceObject = l.createBufferSource(),
                ...
                0 === u ? V(this.instanceObject, n) : z(this.instanceObject, u, this.getDuration(), n);
            else {
                if (1 !== c.playbackRate && (c.playbackRate = 1),
                c.loop !== t && (c.loop = t),
                c.volume = i * m,
            ...
            break;
        case o:
            (!this.fresh && this.stopped || 0 !== u) && c.seekTo(u),
            c.play(),
            this.hasPlaybackEnded = !1;
            break;
        case h:
        ...
        this.playbackRate = 1,
        this.startTime = (this.isTimescaled ? e.kahanTime.sum : e.wallTime.sum) - u,
        this.fresh = !1,
        this.stopped = !1,
        this.is_paused = !1
    }
    ...
    at.prototype.pause = function() {
        if (!(this.fresh || this.stopped || this.hasEnded() || this.is_paused)) {
            ...
            case s:
                ...
                break;
            case a:
                this.buffer.myapi === a ? (this.resume_position = this.getPlaybackTime(!0),
                this.looping && (this.resume_position = this.resume_position % this.getDuration()),
                this.is_paused = !0,
                U(this.instanceObject)) : this.instanceObject.paused || this.instanceObject.pause();
                break;
            case o:
    ...
    at.prototype.resume = function() {
        if (!(this.fresh || this.stopped || this.hasEnded()) && this.is_paused) {
            ...
            case s:
                ...
                break;
            case a:
                this.buffer.myapi === a ? (this.instanceObject = l.createBufferSource(),
                this.instanceObject.buffer = this.buffer.bufferObject,
                this.instanceObject.connect(this.gainNode),
                this.instanceObject.onended = this.onended_handler,
                this.active_buffer = this.instanceObject,
                this.instanceObject.loop = this.looping,
                this.gainNode.gain.value = m * this.volume * this.mutevol,
                this.updatePlaybackRate(),
                this.startTime = (this.isTimescaled ? e.kahanTime.sum : e.wallTime.sum) - this.resume_position / (this.playbackRate || .001),
                z(this.instanceObject, this.resume_position, this.getDuration())) : R(this);
                break;
            case o:
    ...
    at.prototype.reconnect = function(t) {
        this.myapi === a && (this.pannerEnabled ? (this.pannerNode.disconnect(),
    ...
    at.prototype.getPlaybackTime = function(t) {
        ...
        return t && (r *= this.playbackRate),
        !this.looping && r > i && (r = i),
        r
    }
    ,
    ...
    at.prototype.doSetMuted = function(t) {
        ...
        case s:
            ...
            break;
        case a:
            this.buffer.myapi === a ? (this.mutevol = t ? 0 : 1,
            this.gainNode.gain.value = m * this.volume * this.mutevol) : this.instanceObject.muted !== !!t && (this.instanceObject.muted = !!t)
        }
    }
    ,
    ...
    at.prototype.setSuspended = function(t) {
        ...
        case a:
            ...
            this.buffer.myapi === a ? (this.resume_position = this.getPlaybackTime(!0),
            this.looping && (this.resume_position = this.resume_position % this.getDuration()),
            U(this.instanceObject)) : this.instanceObject.pause()) : this.resume_me = !1 : this.resume_me && (this.buffer.myapi === a ? (this.instanceObject = l.createBufferSource(),
            this.instanceObject.buffer = this.buffer.bufferObject,
            this.instanceObject.connect(this.gainNode),
            this.instanceObject.onended = this.onended_handler,
            this.active_buffer = this.instanceObject,
    ...
    t.Instance = function(t) {
        ...
        this.listenerZ = -600,
        this.runtime.isWKWebView && (P = !0),
        !(this.runtime.isiOS || this.runtime.isAndroid && (this.runtime.isChrome || this.runtime.isAndroidStockBrowser)) || this.runtime.isCrosswalk || this.runtime.isDomFree || this.runtime.isAmazonWebApp || P || (k = !0),
        l = null,
        "undefined" != typeof AudioContext ? (c = a,
        l = new AudioContext) : "undefined" != typeof webkitAudioContext && (c = a,
        l = new webkitAudioContext),
        this.runtime.isiOS && l && (l.close && l.close(),
        "undefined" != typeof AudioContext ? l = new AudioContext : "undefined" != typeof webkitAudioContext && (l = new webkitAudioContext)),
        c !== a && (this.runtime.isCordova && void 0 !== window.Media ? c = o : this.runtime.isAppMobi && (c = h)),
        c === o) {
            var r = (n = location.href).lastIndexOf("/");
            r > -1 && (n = n.substr(0, r + 1)),
            n = n.replace("file://", "")
        }
    ...
    ot.onCreate = function() {
        ...
        c === a && (l.listener.setPosition(t / 2, e / 2, this.listenerZ),
        l.listener.setOrientation(0, 0, 1, 0, -1, 0),
        window.c2OnAudioMicStream = function(t, e) {
            C && C.disconnect(),
            A = e.toLowerCase(),
            (C = l.createMediaStreamSource(t)).connect(D(A))
        }
        ),
    ...
    ot.onInstanceDestroyed = function(t) {
        ...
        for (e = 0,
        i = p.length; e < i; e++)
            (r = p[e]).objectTracker && r.objectTracker.obj === t && (r.objectTracker.obj = null,
            r.pannerEnabled && r.isPlaying() && r.looping && r.stop());
    ...
    ot.saveToJSON = function() {
        ...
        for (t = 0,
        e = p.length; t < e; t++)
            (i = p[t]).shouldSave() && 3 !== this.saveload && (i.is_music && 1 === this.saveload || (i.is_music || 2 !== this.saveload) && (a = i.getPlaybackTime(),
            i.looping && (a %= i.getDuration()),
            r = {
                tag: i.tag,
    ...
    ot.loadFromJSON = function(t) {
        ...
        if (3 !== this.saveload)
            for (r = 0,
            n = p.length; r < n; r++)
                (f = p[r]).is_music && 1 === this.saveload || (f.is_music || 2 !== this.saveload) && f.stop();
        for (g in j)
        ...
        t.effects)
            if (t.effects.hasOwnProperty(g))
                ...
                n = (b = t.effects[g]).length; r < n; r++)
                    ...
                    case "convolve":
                        a = x[2],
                        (d = this.getAudioBuffer(a, !1)).bufferObject ? S = new J(d.bufferObject,x[0],x[1],a) : (S = new J(null,x[0],x[1],a),
                        d.normalizeWhenReady = x[0],
                        d.convolveWhenReady = S),
                        ft(g, S);
                        break;
                    case "flanger":
        ...
        for (r = 0,
        n = T.length; r < n; r++)
            3 !== this.saveload && (a = (s = T[r]).buffersrc,
            o = s.is_music,
            h = s.tag,
            c = s.playbackTime,
            l = s.looping,
            ...
            o && 1 === this.saveload || (o || 2 !== this.saveload) && ((f = this.getAudioInstance(a, h, o, l, u)) ? (f.resume_position = s.resume_position,
            f.setPannerEnabled(!!_),
            f.play(l, u, c),
            f.updatePlaybackRate(),
            f.updateVolume(),
            f.doSetMuted(f.is_muted || f.is_silent),
            s.paused && f.pause(),
            s.muted && f.setMuted(!0),
            f.doSetMuted(f.is_muted || f.is_silent),
            _ && (-1 !== v ? (f.objectTracker = f.objectTracker || new nt,
            f.objectTracker.loadUid = v,
            ht.push(f.objectTracker)) : f.setPan(_.x, _.y, _.a, _.ia, _.oa, _.og))) : ((d = this.getAudioBuffer(a, o)).seekWhenReady = c,
            d.pauseWhenReady = s.paused,
            _ && (-1 !== v ? d.panWhenReady.push({
                objUid: v,
                ia: _.ia,
                oa: _.oa,
                og: _.og,
    ...
    ot.afterLoad = function() {
        ...
        e = ht.length; t < e; t++)
            i = ht[t],
            r = this.runtime.getObjectByUID(i.loadUid),
            i.setObject(r),
            i.loadUid = -1,
            r && (_ = r.x,
            v = r.y);
    ...
    ot.onSuspend = function(t) {
        if (!this.playinbackground) {
            var e, i;
            for (!t && l && l.resume && (l.resume(),
            b = !1),
            e = 0,
            i = p.length; e < i; e++)
                p[e].setSuspended(t);
            t && l && l.suspend && (l.suspend(),
            b = !0)
        }
    }
    ,
    ot.tick = function() {
        ...
        e = p.length; t < e; t++)
            (i = p[t]).tick(o),
            0 !== g && i.updatePlaybackRate();
        for (r in j)
            if (j.hasOwnProperty(r))
                for (t = 0,
                e = (n = j[r]).length; t < e; t++)
                    (s = n[t]).tick && s.tick();
        c === a && this.listenerTracker.hasObject() && (this.listenerTracker.tick(o),
        _ = this.listenerTracker.obj.x,
        v = this.listenerTracker.obj.y,
        l.listener.setPosition(this.listenerTracker.obj.x, this.listenerTracker.obj.y, this.listenerZ))
    }
    ;
    var ct = [];
    ot.setPreloadList = function(t) {
        ...
        i = t.length; e < i; ++e)
            n = (r = t[e])[0],
            s = 2 * r[1],
            ((a = n.length > 4 && ".ogg" === n.substr(n.length - 4)) && f || !a && !f) && (ct.push({
                filename: n,
                size: s,
                obj: null
            }),
    ...
    ot.startPreloads = function() {
        ...
        e = ct.length; t < e; ++t)
            i = ct[t],
            r = this.runtime.files_subfolder + i.filename,
            i.obj = this.getAudioBuffer(r, !1)
    }
    ,
    ot.getPreloadedSize = function() {
        ...
        for (t = 0,
        e = ct.length; t < e; ++t)
            (i = ct[t]).obj.isLoadedAndDecoded() || i.obj.hasFailedToLoad() || this.runtime.isDomFree || this.runtime.isAndroidStockBrowser ? r += i.size : i.obj.isLoaded() && (r += Math.floor(i.size / 2));
        return r
    }
    ,
    ...
    ot.getAudioBuffer = function(t, e, i) {
        ...
        return a || i || (P && e && this.releaseAllMusicBuffers(),
        a = new st(t,e),
        u.push(a)),
        a
    }
    ...
    ot.getAudioInstance = function(t, e, i, r, n) {
        ...
        for (s = 0,
        a = p.length; s < a; s++)
            if ((o = p[s]).src === t && (o.canBeRecycled() || i))
                return o.tag = e,
                o;
        var h = this.getAudioBuffer(t, i);
        return h.bufferObject ? (o = new at(h,e),
        p.push(o),
        o) : ("<preload>" !== e && (h.playTagWhenReady = e,
        h.loopWhenReady = r,
        h.volumeWhenReady = n),
        null)
    }
    ...
    function pt(t, e) {
        if (cr.clearArray(lt),
        !t.length)
            return !d || d.hasEnded() ? void 0 : (cr.clearArray(lt),
            void (lt[0] = d));
        var i, r, n;
        for (i = 0,
        r = p.length; i < r; i++)
            n = p[i],
            cr.equals_nocase(t, n.tag) && lt.push(n);
        e && lt.sort(ut)
    }
    function dt(t) {
        var e, i, r, n, s = l.destination;
        if (j.hasOwnProperty(t) && (r = j[t]).length)
            for (s = r[0].getInputNode(),
            e = 0,
            i = r.length; e < i; e++)
                n = r[e],
                e + 1 === i ? n.connectTo(l.destination) : n.connectTo(r[e + 1].getInputNode());
        for (pt(t),
        e = 0,
        i = lt.length; e < i; e++)
            lt[e].reconnect(s);
    ...
    function ft(t, e) {
        j.hasOwnProperty(t) ? j[t].push(e) : j[t] = [e],
        dt(t)
    }
    function gt() {}
    function yt() {}
    ...
    function _t(t, e) {
        var i = null;
        return j.hasOwnProperty(t) && (i = j[t]),
    ...
    gt.prototype.PreloadsComplete = function() {
        ...
        for (t = 0,
        e = u.length; t < e; t++)
            if (!u[t].isLoadedAndDecoded() && !u[t].hasFailedToLoad())
                return !1;
        return !0
    }
    ,
    ...
    ,
    t.cnds = new gt,
    yt.prototype.Play = function(t, e, i, r) {
        if (!y) {
            var n = B(i)
              , s = t[1]
              , a = this.runtime.files_subfolder + t[0] + (f ? ".ogg" : ".m4a");
            (d = this.getAudioInstance(a, r, s, 0 !== e, n)) && (d.setPannerEnabled(!1),
            d.play(0 !== e, n, 0, this.nextPlayTime),
            this.nextPlayTime = 0)
        }
    }
    ,
    yt.prototype.PlayAtPosition = function(t, e, i, r, n, s, a, o, h, c) {
        if (!y) {
            ...
            if (d = this.getAudioInstance(p, c, u, 0 !== e, l))
                d.setPannerEnabled(!0),
                d.setPan(r, n, s, a, o, B(h)),
                d.play(0 !== e, l, 0, this.nextPlayTime),
                this.nextPlayTime = 0;
            else
        ...
        if (!y && r) {
            ...
            if (h) {
                ...
                if (d = this.getAudioInstance(u, o, l, 0 !== e, c)) {
                    ...
                    d.setPan(p, g, cr.to_degrees(h.angle - h.layer.getAngle()), n, s, B(a)),
                    d.setObject(h),
                    d.play(0 !== e, c, 0, this.nextPlayTime),
                    this.nextPlayTime = 0
                } else {
    ...
    yt.prototype.PlayByName = function(t, e, i, r, n) {
        if (!y) {
            ...
            (d = this.getAudioInstance(o, n, a, 0 !== i, s)) && (d.setPannerEnabled(!1),
            d.play(0 !== i, s, 0, this.nextPlayTime),
            this.nextPlayTime = 0)
        }
    }
    ,
    yt.prototype.PlayAtPositionByName = function(t, e, i, r, n, s, a, o, h, c, l) {
        if (!y) {
            ...
            if (d = this.getAudioInstance(g, l, p, 0 !== i, u))
                d.setPannerEnabled(!0),
                d.setPan(n, s, a, o, h, B(c)),
                d.play(0 !== i, u, 0, this.nextPlayTime),
                this.nextPlayTime = 0;
            else
                this.getAudioBuffer(g, p).panWhenReady.push({
                    x: n,
                    y: s,
                    a: a,
                    ia: o,
        ...
        if (!y && n) {
            ...
            if (c) {
                ...
                if (d = this.getAudioInstance(p, h, u, 0 !== i, l)) {
                    ...
                    d.setPan(g, m, cr.to_degrees(c.angle - c.layer.getAngle()), s, a, B(o)),
                    d.setObject(c),
                    d.play(0 !== i, l, 0, this.nextPlayTime),
                    this.nextPlayTime = 0
                } else {
                    this.getAudioBuffer(p, u).panWhenReady.push({
                        obj: c,
    ...
    yt.prototype.AddFilterEffect = function(t, e, i, r, n, s, o) {
        c !== a || e < 0 || e >= q.length || !l.createBiquadFilter || (t = t.toLowerCase(),
        (o /= 100) < 0 && (o = 0),
        o > 1 && (o = 1),
        ft(t, new H(e,i,r,n,s,o)))
    }
    ,
    ...
    yt.prototype.AddFlangerEffect = function(t, e, i, r, n, s) {
        c === a && l.createOscillator && (t = t.toLowerCase(),
        (s /= 100) < 0 && (s = 0),
        s > 1 && (s = 1),
        ft(t, new K(e / 1e3,i / 1e3,r,n / 100,s)))
    }
    ,
    yt.prototype.AddPhaserEffect = function(t, e, i, r, n, s, o) {
        ...
        (o /= 100) < 0 && (o = 0),
        o > 1 && (o = 1),
        ft(t, new Z(e,i,r,n,s,o)))
    }
    ,
    yt.prototype.AddConvolutionEffect = function(t, e, i, r) {
        if (c === a && l.createConvolver) {
            var n, s = 0 === i, o = this.runtime.files_subfolder + e[0] + (f ? ".ogg" : ".m4a"), h = this.getAudioBuffer(o, !1);
            t = t.toLowerCase(),
            (r /= 100) < 0 && (r = 0),
            r > 1 && (r = 1),
            h.bufferObject ? n = new J(h.bufferObject,s,r,o) : (n = new J(null,s,r,o),
            h.normalizeWhenReady = s,
            h.convolveWhenReady = n),
            ft(t, n)
        }
    }
    ,
    ...
    yt.prototype.AddDistortionEffect = function(t, e, i, r, n, s) {
        c === a && l.createWaveShaper && (t = t.toLowerCase(),
        (s /= 100) < 0 && (s = 0),
        s > 1 && (s = 1),
        ft(t, new et(e,i,r,n,s)))
    }
    ,
    ...
    yt.prototype.RemoveEffects = function(t) {
        var e, i, r;
        if (c === a && (t = t.toLowerCase(),
        j.hasOwnProperty(t) && (r = j[t]).length)) {
            for (e = 0,
            i = r.length; e < i; e++)
                r[e].remove();
            cr.clearArray(r),
    ...
    yt.prototype.SetEffectParameter = function(t, e, i, r, n, s) {
        ...
        c === a && (t = t.toLowerCase(),
        e = Math.floor(e),
        j.hasOwnProperty(t) && (o = j[t],
        e < 0 || e >= o.length || o[e].setParam(i, r, n, s)))
    }
    ,
...
function() {
    ...
    ,
    t.cnds = new i,
    r.prototype.AddKey = function(t, e) {
...
function() {
    ...
    i.drawGL = function(t) {}
    ,
    r.prototype.HasFeatureStandalone = function(t) {
    ...
    n.prototype.Translate = function(t) {
        try {
            return window.famobi.__(t) || (console.debug("No translation found for key '" + t + '"'),
            t)
        } catch (t) {
            console.debug(t)
        }
    ...
    n.prototype.trackEventCustom = function(t) {
        try {
            try {
                ...
                return console.warn("Params need to be a valid JSON."),
                !1
            }
    ...
    n.prototype.trackScreen = function(t, e) {
        try {
            t = ["SCREEN_OTHER", "SCREEN_BONUS", "SCREEN_CHARACTER", "SCREEN_CREDITS", "SCREEN_GAMERESULT", "SCREEN_HELP", "SCREEN_HOME", "SCREEN_LEVEL", "SCREEN_LEVELINTRO", "SCREEN_LEVELLOADING", "SCREEN_LEVELRESULT", "SCREEN_LEVELSELECT", "SCREEN_PAUSE", "SCREEN_SETTINGS", "SCREEN_SHOP", "SCREEN_SPLASH", "SCREEN_TUTORIAL"][t],
            window.famobi_analytics.trackScreen(t, e)
        } catch (t) {
            console.debug(t)
        }
    }
    ,
    t.acts = new n,
    s.prototype.GetMoreGamesButtonImage = function(t) {
...
function() {
    ...
    ,
    t.cnds = new a,
    o.prototype.CallFunction = function(t, e) {
        var i = r();
    ...
    ,
    t.acts = new o,
    h.prototype.ReturnValue = function(t) {
        var r = function() {
            if (!e.length)
                return null;
            var t = i + 1;
            return t >= e.length && (t = e.length - 1),
            e[t]
        }();
    ...
    h.prototype.Call = function(t, e) {
        var i, n, a = r();
        for (a.name = e.toLowerCase(),
        a.retVal = 0,
        cr.clearArray(a.params),
        i = 2,
        n = arguments.length; i < n; i++)
            a.params.push(arguments[i]);
...
function() {
    ...
    t.acts = new function() {}
    ,
    n.prototype.LastKeyCode = function(t) {
...
try {
    !function() {
        ...
        i = e = function(t) {
            ...
            for (var a, o = r[t], h = o.deps, c = o.callback, l = [], u = 0, p = h.length; p > u; u++)
                "exports" === h[u] ? l.push(a = {}) : l.push(e(s(h[u])));
            ...
            e.all = function(t) {
                ...
                return new this(function(e, i) {
                    ...
                    for (var c = 0; c < t.length; c++)
                        (a = t[c]) && r(a.then) ? a.then(n(c), i) : s(c, a)
                }
                )
            }
        }),
        t("promise/asap", ["exports"], function(t) {
            ...
            var i, r = "undefined" != typeof window ? window : {}, n = r.MutationObserver || r.WebKitMutationObserver, s = "undefined" != typeof global ? global : void 0 === this ? window : this, a = [];
        ...
        t("promise/promise", ["./config", "./utils", "./all", "./race", "./resolve", "./reject", "./asap", "exports"], function(t, e, i, r, n, s, a, o) {
            ...
            function l(t, e) {
                for (var i = t._subscribers, r = t._detail, n = 0; n < i.length; n += 3)
                    c(e, i[n], i[n + e], r);
                t._subscribers = null
            }
            function u(t, e) {
    ...
    function(t, e) {
            ...
            var r = function(t) {
                ...
                function r() {
                    for (var t = 1; t < arguments.length; t++) {
                        ...
                        if (e)
                            for (var i in e)
                                e.hasOwnProperty(i) && (l(e[i]) ? arguments[0][i] = e[i].slice() : arguments[0][i] = e[i])
                    }
                    return arguments[0]
                }
                function n(t) {
                ...
                return new (function() {
                    function t(e) {
                        ...
                        this.INDEXEDDB = a.INDEXEDDB,
                        this.LOCALSTORAGE = a.LOCALSTORAGE,
                        this.WEBSQL = a.WEBSQL,
                        this._defaultConfig = r({}, h),
                        this._config = r({}, this._defaultConfig, e),
                        ...
                        var r = new Promise(function(e, i) {
                            try {
                                ...
                                for (var l = o.concat("_initStorage"), u = 0; u < l.length; u++) {
                                    var p = l[u];
                                    if (!p || !t[p] || "function" != typeof t[p])
                                        return void i(a)
                                }
                                var d = Promise.resolve(!0);
                                "_support"in t && (d = t._support && "function" == typeof t._support ? t._support() : Promise.resolve(!!t._support)),
                                d.then(function(i) {
                                    c[r] = i,
                                    s[r] = t,
                                    e()
                    ...
                    t.prototype.setDriver = function(t, e, i) {
                        ...
                        return this._driverSet = a.then(function() {
                                ...
                                n._initDriver = function(t) {
                                    return function() {
                                        ...
                                        return function i() {
                                            ...
                                            return n._driverSet = Promise.reject(a),
                                            n._driverSet
                                        }()
                                    }
                                }(s)
                            ...
                            return n._driverSet = Promise.reject(t),
                            n._driverSet
                        }),
            ...
            var i = function(t) {
                function e(e, i) {
                    ...
                    try {
                        ...
                        if ("TypeError" !== s.name)
                            throw s;
                        for (var r = new (t.BlobBuilder || t.MSBlobBuilder || t.MozBlobBuilder || t.WebKitBlobBuilder), n = 0; n < e.length; n += 1)
                            r.append(e[n]);
                ...
                function n(t) {
                    return e([function(t) {
                        for (var e = t.length, i = new ArrayBuffer(e), r = new Uint8Array(i), n = 0; e > n; n++)
                            r[n] = t.charCodeAt(n);
                        return i
                    }(atob(t.data))], {
                        type: t.type
                    ...
                    return new Promise(function(r, n) {
                        ...
                        i && (a.onupgradeneeded = function(i) {
                            ...
                            try {
                                ...
                                i.oldVersion <= 1 && r.createObjectStore(d)
                            } catch (r) {
                        ...
                        a.onsuccess = function() {
                            var t;
                            r(a.result),
                            (t = p[e.name].deferredOperations.pop()) && t.resolve()
                        }
                    }
                    )
                }
                function h(e, i) {
                    ...
                    if (n && (e.version !== i && t.console.warn('The database "' + e.name + "\" can't be downgraded from version " + e.db.version + " to version " + e.version + "."),
                ...
                if (l) {
                    ...
                    return {
                        ...
                        _initStorage: function(t) {
                            ...
                            p[r.name] = s),
                            s.forages.push(i),
                            i._initReady || (i._initReady = i.ready,
                            i.ready = a);
                            ...
                            return Promise.all(c).then(function() {
                                ...
                                return r.db = t,
                                h(r, i._defaultConfig.version) ? function(t) {
                                    return o(t, !0)
                                }(r) : t
                            }).then(function(t) {
                                r.db = s.db = t,
                        ...
                        getItem: function(e, i) {
                            var r = this;
                            "string" != typeof e && (t.console.warn(e + " used as a key, but it is not a string."),
                            e = String(e));
                        ...
                        setItem: function(e, i, n) {
                            ...
                            var a = new Promise(function(t, n) {
                                ...
                                s.ready().then(function() {
                                    return a = s._dbInfo,
                                    i instanceof Blob ? r(a.db).then(function(t) {
                                        return t ? i : function(t) {
                                            return new Promise(function(e, i) {
                                                var r = new FileReader;
                                                r.onerror = i,
                                                r.onloadend = function(i) {
                            ...
                            var i = this
                              , r = new Promise(function(e, r) {
                                return 0 > t ? void e(null) : void i.ready().then(function() {
                                    ...
                                    a.onsuccess = function() {
                                        var i = a.result;
                                        return i ? void (0 === t ? e(i.key) : s ? e(i.key) : (s = !0,
                                        i.advance(t))) : void e(null)
                                    }
                                    ,
                                    a.onerror = function() {
                                        r(a.error)
                            ...
                            var e = this
                              , i = new Promise(function(t, i) {
                                e.ready().then(function() {
                                    ...
                                    n.onsuccess = function() {
                                        var e = n.result;
                                        return e ? (s.push(e.key),
                                        void e.continue()) : void t(s)
                                    }
                                    ,
                                    n.onerror = function() {
                                        i(n.error)
        ...
        , function(t, e, i) {
            ...
            var r = function(t) {
                ...
                var r = null;
                try {
                    if (!(t.localStorage && "setItem"in t.localStorage))
                        return;
                    r = t.localStorage
                } catch (t) {
                    return
                ...
                return {
                        ...
                        var n = this
                          , s = n.ready().then(function() {
                            for (var e = n._dbInfo, i = e.keyPrefix, s = i.length, a = r.length, o = 1, h = 0; a > h; h++) {
                                ...
                                if (0 === c.indexOf(i)) {
                                    var l = r.getItem(c);
                                    if (l && (l = e.serializer.deserialize(l)),
                                    void 0 !== (l = t(l, c.substring(s), o++)))
                                        return l
                                }
                            }
                        });
                    ...
                    getItem: function(i, n) {
                        var s = this;
                        "string" != typeof i && (t.console.warn(i + " used as a key, but it is not a string."),
                        i = String(i));
                    ...
                    keys: function(t) {
                        var i = this
                          , n = i.ready().then(function() {
                            for (var t = i._dbInfo, e = r.length, n = [], s = 0; e > s; s++)
                                0 === r.key(s).indexOf(t.keyPrefix) && n.push(r.key(s).substring(t.keyPrefix.length));
                            return n
                        });
                        return e(n, t),
                        n
        ...
        , function(t, e) {
            ...
            var i = function(t) {
                ...
                function i(t) {
                    var e, i, r, s, a, o = .75 * t.length, h = t.length, c = 0;
                    "=" === t[t.length - 1] && (o--,
                    "=" === t[t.length - 2] && o--);
                ...
                function r(t) {
                    var e, i = new Uint8Array(t), r = "";
                    for (e = 0; e < i.length; e += 3)
                        r += n[i[e] >> 2],
                        r += n[(3 & i[e]) << 4 | i[e + 1] >> 4],
                        r += n[(15 & i[e + 1]) << 2 | i[e + 2] >> 6],
                        r += n[63 & i[e + 2]];
                    return i.length % 3 == 2 ? r = r.substring(0, r.length - 1) + "=" : i.length % 3 == 1 && (r = r.substring(0, r.length - 2) + "=="),
                    r
                }
                ...
                return {
                    serialize: function(t, e) {
                        var i = "";
                        if (t && (i = t.toString()),
                        t && ("[object ArrayBuffer]" === t.toString() || t.buffer && "[object ArrayBuffer]" === t.buffer.toString())) {
                            var n, a = o;
                            t instanceof ArrayBuffer ? (n = t,
                            a += c) : (n = t.buffer,
                            "[object Int8Array]" === i ? a += u : "[object Uint8Array]" === i ? a += p : "[object Uint8ClampedArray]" === i ? a += d : "[object Int16Array]" === i ? a += f : "[object Uint16Array]" === i ? a += y : "[object Int32Array]" === i ? a += g : "[object Uint32Array]" === i ? a += m : "[object Float32Array]" === i ? a += _ : "[object Float64Array]" === i ? a += v : e(new Error("Failed to get type for BinaryArray"))),
                            e(a + r(n))
                    ...
                    deserialize: function(t) {
                        if (t.substring(0, h) !== o)
                            return JSON.parse(t);
                        var r, n = t.substring(b), s = t.substring(h, b);
                        if (s === l && a.test(n)) {
                            var w = n.match(a);
                            r = w[1],
                            n = n.substring(w[0].length)
                        }
                        var x = i(n);
                        switch (s) {
                        case c:
                ...
                if (r)
                    return {
                        ...
                        _initStorage: function(t) {
                            ...
                            if (t)
                                for (var s in t)
                                    n[s] = "string" != typeof t[s] ? t[s].toString() : t[s];
                            var a = new Promise(function(t, i) {
                                try {
                                ...
                                n.ready().then(function() {
                                    ...
                                    r.db.transaction(function(n) {
                                        n.executeSql("SELECT * FROM " + r.storeName + " WHERE key = ? LIMIT 1", [i], function(e, i) {
                                            ...
                                            n && (n = r.serializer.deserialize(n)),
                                            t(n)
                                        }, function(t, i) {
                                            e(i)
                                        })
                                ...
                                i.ready().then(function() {
                                    ...
                                    r.db.transaction(function(i) {
                                        i.executeSql("SELECT key FROM " + r.storeName, [], function(e, i) {
                                            for (var r = [], n = 0; n < i.rows.length; n++)
                                                r.push(i.rows.item(n).key);
                                            t(r)
                                        }, function(t, i) {
                                            e(i)
                                        })
...
function() {
    ...
    ,
    c.Type.prototype.onCreate = function() {}
    ,
    ...
    ,
    c.cnds = new u,
    p.prototype.SetItem = function(i, o) {
        if (localForageInitFailed)
            s(this, "storage failed to initialise - may be disabled in browser settings");
        else {
            var h = a + i;
            this.pendingSets++;
            var c = this;
            localforage.setItem(h, o, function(s, a) {
                ...
                c.pendingSets--,
                s ? (r = n(s),
                c.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, c)) : (t = i,
                e = a,
                c.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAnyItemSet, c),
                c.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemSet, c),
                t = "",
                e = ""),
                0 === c.pendingSets && c.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAllSetsComplete, c)
            })
        }
    }
    ,
    p.prototype.GetItem = function(i) {
        if (localForageInitFailed)
            ...
            localforage.getItem(o, function(s, a) {
                h.pendingGets--,
                s ? (r = n(s),
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, h)) : (t = i,
                void 0 !== (e = a) && null !== e || (e = ""),
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAnyItemGet, h),
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemGet, h),
                t = "",
                e = ""),
                0 === h.pendingGets && h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAllGetsComplete, h)
            })
        }
    }
    ,
    p.prototype.CheckItemExists = function(i) {
        if (localForageInitFailed)
            ...
            localforage.getItem(o, function(s, a) {
                ...
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, h)) : (t = i,
                null === a ? (e = "",
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemMissing, h)) : (e = a,
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemExists, h)),
                t = "",
                e = "")
            })
        }
    ...
    p.prototype.RemoveItem = function(i) {
        if (localForageInitFailed)
            ...
            localforage.removeItem(o, function(s) {
                ...
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, h)) : (t = i,
                e = "",
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnAnyItemRemoved, h),
                h.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnItemRemoved, h),
                t = "")
            })
        }
    }
    ...
    p.prototype.ClearStorage = function() {
        if (localForageInitFailed)
            ...
            localforage.clear(function(s) {
                !0,
                s ? (r = n(s),
                a.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnError, a)) : (t = "",
                e = "",
                cr.clearArray(i),
                a.runtime.trigger(cr.plugins_.LocalStorage.prototype.cnds.OnCleared, a))
            })
        }
    }
    ,
        ...
        if (localForageInitFailed)
            ...
            localforage.keys(function(e, s) {
                ...
                if (e)
                    ...
                    c = s.length; o < c; ++o)
                        h(l = s[o]) && i.push((u = l,
                        a ? h(u) ? u.substr(a.length) : void 0 : u));
...
function() {
    ...
    e.slicePatch = function(t, e, i, r) {
        ...
        return n.width = s,
        n.height = a,
        n.getContext("2d").drawImage(this.texture_img, t, e, s, a, 0, 0, s, a),
        n
    }
    ,
    e.createPatch = function(t, e, i, r) {
        ...
        if (this.runtime.glwrap) {
            ...
            a > t && o > i && (this.webGL_fillTexture = h.loadTexture(this.slicePatch(t, i, a, o), !0, c, l)),
            t > 0 && o > i && (this.webGL_leftTexture = h.loadTexture(this.slicePatch(0, i, t, o), !0, c, l, "repeat-y")),
            e > 0 && o > i && (this.webGL_rightTexture = h.loadTexture(this.slicePatch(a, i, n, o), !0, c, l, "repeat-y")),
            i > 0 && a > t && (this.webGL_topTexture = h.loadTexture(this.slicePatch(t, 0, a, i), !0, c, l, "repeat-x")),
            r > 0 && a > t && (this.webGL_bottomTexture = h.loadTexture(this.slicePatch(t, o, a, s), !0, c, l, "repeat-x"))
        } else {
            if (this.fillPattern)
                return;
            var u = this.runtime.ctx;
            a > t && o > i && (this.fillPattern = u.createPattern(this.slicePatch(t, i, a, o), "repeat")),
            t > 0 && o > i && (this.leftPattern = u.createPattern(this.slicePatch(0, i, t, o), "repeat")),
            e > 0 && o > i && (this.rightPattern = u.createPattern(this.slicePatch(a, i, n, o), "repeat")),
            i > 0 && a > t && (this.topPattern = u.createPattern(this.slicePatch(t, 0, a, i), "repeat")),
            r > 0 && a > t && (this.bottomPattern = u.createPattern(this.slicePatch(t, o, a, s), "repeat"))
        }
    }
    ,
    t.Instance = function(t) {
    ...
    i.draw = function(t) {
        ...
        var u = this.x
          ...
          , d = this.width
          , f = this.height;
        this.runtime.pixel_rounding && (u = Math.round(u),
        p = Math.round(p));
        ...
        var v = g - m
          , b = y - _
          , w = this.seamless ? 1 : 0;
        if (i > 0 && s > 0 && t.drawImage(e, 0, 0, i + w, s + w, v, b, i + w, s + w),
        n > 0 && s > 0 && t.drawImage(e, c - w, 0, n + w, s + w, v + d - n - w, b, n + w, s + w),
        n > 0 && a > 0 && t.drawImage(e, c - w, l - w, n + w, a + w, v + d - n - w, b + f - a - w, n + w, a + w),
        i > 0 && a > 0 && t.drawImage(e, 0, l - w, i + w, a + w, v, b + f - a - w, i + w, a + w),
        0 === this.edges) {
            var x = 2 === this.fill ? 0 : w;
            i > 0 && l > s && r(t, this.type.leftPattern, i, l - s, v, b + s, i + x, f - s - a, 0, 0),
            n > 0 && l > s && r(t, this.type.rightPattern, n, l - s, v + d - n - x, b + s, n + x, f - s - a, x, 0),
            s > 0 && c > i && r(t, this.type.topPattern, c - i, s, v + i, b, d - i - n, s + x, 0, 0),
            a > 0 && c > i && r(t, this.type.bottomPattern, c - i, a, v + i, b + f - a - x, d - i - n, a + x, 0, x)
        } else
            1 === this.edges && (i > 0 && l > s && f - s - a > 0 && t.drawImage(e, 0, s, i, l - s, v, b + s, i, f - s - a),
            n > 0 && l > s && f - s - a > 0 && t.drawImage(e, c, s, n, l - s, v + d - n, b + s, n, f - s - a),
            s > 0 && c > i && d - i - n > 0 && t.drawImage(e, i, 0, c - i, s, v + i, b, d - i - n, s),
            a > 0 && c > i && d - i - n > 0 && t.drawImage(e, i, l, c - i, a, v + i, b + f - a, d - i - n, a));
        l > s && c > i && (0 === this.fill ? r(t, this.type.fillPattern, c - i, l - s, v + i, b + s, d - i - n, f - s - a, 0, 0) : 1 === this.fill && d - i - n > 0 && f - s - a > 0 && t.drawImage(e, i, s, c - i, l - s, v + i, b + s, d - i - n, f - s - a)),
        t.restore()
    }
    ,
    i.drawPatch = function(t, e, i, r, n, s, a, o, h, c) {
        ...
        l.bottom = (r + s) / e.c2height,
        t.quadTex(a, o, a + h, o, a + h, o + c, a, o + c, l)
    }
    ,
    i.tilePatch = function(t, e, i, r, n, s, a, o) {
        ...
        h.left = -a / e.c2width,
        h.top = -o / e.c2height,
        h.right = (n - a) / e.c2width,
        h.bottom = (s - o) / e.c2height,
        t.quadTex(i, r, i + n, r, i + n, r + s, i, r + s, h)
    }
    ,
    ...
    i.drawGL = function(t) {
        ...
        if (e > 0 && r > 0 && this.drawPatch(t, this.type.webGL_texture, 0, 0, e + p, r + p, h, c, e + p, r + p),
        i > 0 && r > 0 && this.drawPatch(t, this.type.webGL_texture, s - p, 0, i + p, r + p, h + l - i - p, c, i + p, r + p),
        i > 0 && n > 0 && this.drawPatch(t, this.type.webGL_texture, s - p, a - p, i + p, n + p, h + l - i - p, c + u - n - p, i + p, n + p),
        e > 0 && n > 0 && this.drawPatch(t, this.type.webGL_texture, 0, a - p, e + p, n + p, h, c + u - n - p, e + p, n + p),
        0 === this.edges) {
            var d = 2 === this.fill ? 0 : p;
            e > 0 && a > r && this.tilePatch(t, this.type.webGL_leftTexture, h, c + r, e + d, u - r - n, 0, 0),
            i > 0 && a > r && this.tilePatch(t, this.type.webGL_rightTexture, h + l - i - d, c + r, i + d, u - r - n, d, 0),
            r > 0 && s > e && this.tilePatch(t, this.type.webGL_topTexture, h + e, c, l - e - i, r + d, 0, 0),
            n > 0 && s > e && this.tilePatch(t, this.type.webGL_bottomTexture, h + e, c + u - n - d, l - e - i, n + d, 0, d)
        } else
            1 === this.edges && (e > 0 && a > r && this.drawPatch(t, this.type.webGL_texture, 0, r, e, a - r, h, c + r, e, u - r - n),
            i > 0 && a > r && this.drawPatch(t, this.type.webGL_texture, s, r, i, a - r, h + l - i, c + r, i, u - r - n),
            r > 0 && s > e && this.drawPatch(t, this.type.webGL_texture, e, 0, s - e, r, h + e, c, l - e - i, r),
            n > 0 && s > e && this.drawPatch(t, this.type.webGL_texture, e, a, s - e, n, h + e, c + u - n, l - e - i, n));
...
function() {
    ...
    i.prototype.tick = function(t) {
        ...
        this.opacity < 0 ? this.opacity = 0 : this.opacity > 1 && (this.opacity = 1)),
    ...
    i.prototype.draw = function(t) {
        ...
        if (0 !== e) {
            ...
            this.owner.runtime.pixel_rounding && (i = i + .5 | 0,
            r = r + .5 | 0),
            t.drawImage(this.owner.type.texture_img, i, r, this.size, this.size)
        }
    }
    ,
    i.prototype.drawGL = function(t) {
        ...
        s = s + .5 | 0),
        r < 1 || 0 === e || (r < t.minPointSize || r > t.maxPointSize ? (t.setOpacity(e),
        t.quad(n, s, n + i, s, n + i, s + i, n, s + i)) : t.point(this.x, this.y, r, e))
    }
    ,
    ...
    r.saveToJSON = function() {
        ...
        e = this.particles.length; t < e; t++)
            i = this.particles[t],
            n.push([i.x, i.y, i.speed, i.angle, i.opacity, i.grow, i.size, i.gs, i.age]);
        return r
    }
    ,
    ...
    r.allocateParticle = function() {
        var t;
        return n.length ? (t = n.pop()).owner = this : t = new i(this),
    ...
    r.tick = function() {
        ...
        if (0 === this.spraytype && this.spraying)
            for (this.particleCreateCounter += a * this.rate,
            r = cr.floor(this.particleCreateCounter),
            this.particleCreateCounter -= r,
            t = 0; t < r; t++)
        ...
        e = this.particles.length; t < e; t++)
            ...
            s++) : n.push(i);
        cr.truncateArray(this.particles, s),
        this.set_bbox_changed(),
        this.first_tick = !1,
    ...
    r.draw = function(t) {
        ...
        for (e = 0,
        i = this.particles.length; e < i; e++)
            (r = this.particles[e]).right() >= n.viewLeft && r.bottom() >= n.viewTop && r.left() <= n.viewRight && r.top() <= n.viewBottom && r.draw(t)
    }
    ,
    r.drawGL = function(t) {
        ...
        for (e = 0,
        i = this.particles.length; e < i; e++)
            (r = this.particles[e]).right() >= n.viewLeft && r.bottom() >= n.viewTop && r.left() <= n.viewRight && r.top() <= n.viewBottom && r.drawGL(t)
    }
    ,
    ...
    ,
    t.cnds = new s,
    a.prototype.SetSpraying = function(t) {
        this.spraying = 0 !== t
    }
    ,
    ...
    ,
    t.acts = new a,
    o.prototype.ParticleCount = function(t) {
...
function() {
        ...
        if (!this.is_family)
            ...
            e = this.animations.length; t < e; t++) {
                ...
                n = s[7].length; r < n; r++)
                    ...
                    (c = this.runtime.findWaitingTexture(a[0])) ? h.texture_img = c : (h.texture_img = new Image,
                    h.texture_img.cr_src = a[0],
                    h.texture_img.cr_filesize = a[1],
                    h.texture_img.c2webGL_texture = null,
                    this.runtime.waitForImageLoad(h.texture_img, a[0])),
                    cr.seal(h),
                    o.frames.push(h),
    ...
    e.preloadCanvas2D = function(t) {
        ...
        i = this.all_frames.length; e < i; ++e)
            n = this.all_frames[e].texture_img,
            -1 === r.indexOf(n) && (t.drawImage(n, 0, 0),
            r.push(n))
    }
    ,
    t.Instance = function(t) {
    ...
    n.onCreate = function() {
        ...
        e = this.type.animations.length; t < e; t++)
            for (i = 0,
            r = (n = this.type.animations[t]).frames.length; i < r; i++)
                0 === (s = n.frames[i]).width && (s.width = s.texture_img.width,
                s.height = s.texture_img.height),
                s.spritesheeted && (o = s.texture_img,
                (a = s.sheetTex).left = s.offx / o.width,
                a.top = s.offy / o.height,
                a.right = (s.offx + s.width) / o.width,
                a.bottom = (s.offy + s.height) / o.height,
                0 === s.offx && 0 === s.offy && s.width === o.width && s.height === o.height && (s.spritesheeted = !1));
    ...
    n.tick = function() {
        ...
        var t, e = this.getNowTime(), i = this.cur_animation, r = i.frames[this.cur_frame], n = r.duration / this.cur_anim_speed;
        this.animPlaying && e >= this.frameStart + n && (this.animForwards ? this.cur_frame++ : this.cur_frame--,
        this.frameStart += n,
    ...
    n.getAnimationByName = function(t) {
        ...
        i = this.type.animations.length; e < i; e++)
            if (r = this.type.animations[e],
            cr.equals_nocase(r.name, t))
                return r;
        return null
    }
    ,
    n.getAnimationBySid = function(t) {
        ...
        for (e = 0,
        i = this.type.animations.length; e < i; e++)
            if ((r = this.type.animations[e]).sid === t)
                return r;
        return null
    }
    ,
    ...
    n.OnFrameChanged = function(t, e) {
        var i, r, n, s = t.width, a = t.height, o = e.width, h = e.height;
        for (s != o && (this.width *= o / s),
        a != h && (this.height *= h / a),
    ...
    n.draw = function(t) {
        ...
        var e = this.curFrame
          ...
          , a = this.width
          , o = this.height;
        if (0 === this.angle && a >= 0 && o >= 0)
            n -= this.hotspotX * a,
            s -= this.hotspotY * o,
            this.runtime.pixel_rounding && (n = Math.round(n),
            s = Math.round(s)),
            i ? t.drawImage(r, e.offx, e.offy, e.width, e.height, n, s, a, o) : t.drawImage(r, n, s, a, o);
        else {
            this.runtime.pixel_rounding && (n = Math.round(n),
            s = Math.round(s)),
            t.save();
            ...
            i ? t.drawImage(r, e.offx, e.offy, e.width, e.height, l, u, cr.abs(a), cr.abs(o)) : t.drawImage(r, l, u, cr.abs(a), cr.abs(o)),
            t.restore()
        }
    }
    ,
    ...
    n.getImagePointIndexByName = function(t) {
        ...
        for (e = 0,
        i = r.image_points.length; e < i; e++)
            if (cr.equals_nocase(t, r.image_points[e][0]))
                return e;
        return -1
    }
    ,
    n.getImagePoint = function(t, e) {
        var i, r = this.curFrame, n = r.image_points;
        if (i = cr.is_string(t) ? this.getImagePointIndexByName(t) : t - 1,
        (i = cr.floor(i)) < 0 || i >= n.length)
    ...
    function p(t, e, i) {
        var r = h(e.uid, i.uid);
        return t.hasOwnProperty(r) ? (u = t[r][2],
        !0) : (u = -2,
        !1)
    }
    var d = [];
    s.prototype.OnCollision = function(t) {
        ...
        e.addDestroyCallback(function(t) {
            !function(t, e) {
                var i, r, n = e.uid;
                for (i in t)
                    t.hasOwnProperty(i) && ((r = t[i])[0] !== n && r[1] !== n || (o(t[i]),
                    delete t[i]))
            }(i.extra.collmemory, t)
        }));
        var s, a, h, f, g, y, m, _, v = r.getCurrentSol(), b = t.getCurrentSol(), w = v.getObjects(), x = this.runtime.tickcount, S = x - 1, T = e.getCurrentEventStack().current_event;
        T.orblock;
        for (a = 0; a < w.length; a++) {
            ...
            f = 0; f < s.length; f++)
                g = s[f],
                e.testOverlap(h, g) || e.checkRegisteredCollision(h, g) ? (_ = !p(n, h, g) || u < S,
                c(n, h, g, x),
                _ && (e.pushCopySol(T.solModifiers),
                y = r.getCurrentSol(),
                m = t.getCurrentSol(),
                y.select_all = !1,
                m.select_all = !1,
                r === t ? (y.instances.length = 2,
                y.instances[0] = h,
                y.instances[1] = g,
                r.applySolToContainer()) : (y.instances.length = 1,
                ...
                t.applySolToContainer()),
                T.retrigger(),
                e.popSol(T.solModifiers))) : l(n, h, g);
            cr.clearArray(d)
        }
        return !1
    }
    ...
    function v(t, e, i) {
        if (!t)
            return !1;
        var r, n, s, a, o, h, c = 0 !== e || 0 !== i, l = !1, u = this.runtime.getCurrentCondition(), p = u.type, d = u.inverted, v = t.getCurrentSol(), b = this.runtime.getCurrentEventStack().current_event.orblock;
        ...
        a = h.length; s < a; s++)
            if (o = h[s],
            this.runtime.testOverlap(this, o)) {
                if (l = !0,
                d)
                    break;
                p !== t && g.add(o)
    ...
    e.finish = function(t) {
        if (y) {
            if (t) {
                var e, i, r, n = this.runtime.getCurrentEventStack().current_event.orblock, s = f.getCurrentSol(), a = g.valuesRef();
                if (s.select_all) {
                    for (s.select_all = !1,
                    ...
                    if (n)
                        ...
                        i = f.instances.length; e < i; ++e)
                            r = f.instances[e],
                            g.contains(r) || s.else_instances.push(r)
                } else if (n) {
                    var o = s.instances.length;
                    for (e = 0,
                    i = a.length; e < i; ++e)
                        s.instances[o + e] = a[e],
                        cr.arrayFindRemove(s.else_instances, a[e])
                } else
                    cr.shallowAssignArray(s.instances, a);
    ...
    b.prototype.Spawn = function(t, e, i) {
        if (t && e) {
            ...
            if (r) {
                ...
                t != this.type && ((o = t.getCurrentSol()).select_all = !1,
                c ? (cr.clearArray(o.instances),
                o.instances[0] = r) : o.instances.push(r),
                r.is_contained))
                    for (n = 0,
                    s = r.siblings.length; n < s; n++)
                        (o = (a = r.siblings[n]).type.getCurrentSol()).select_all = !1,
                        c ? (cr.clearArray(o.instances),
                        o.instances[0] = a) : o.instances.push(a)
            }
        }
    }
    ,
    ...
    b.prototype.SetScale = function(t) {
        var e = this.curFrame
          ...
          , n = e.width * t * i
          , s = e.height * t * r;
        this.width === n && this.height === s || (this.width = n,
        this.height = s,
        this.set_bbox_changed())
    }
    ,
    b.prototype.LoadURL = function(t, e, i) {
        var r = new Image
          ...
          , s = this.curFrame;
        r.onload = function() {
            if (s.texture_img.src === r.src)
                return n.runtime.glwrap && n.curFrame === s && (n.curWebGLTexture = s.webGL_texture),
                0 === e && (n.width = r.width,
                n.height = r.height,
                n.set_bbox_changed()),
                n.runtime.redraw = !0,
            ...
            s.datauri = "",
            s.pixelformat = 0,
            n.runtime.glwrap && (s.webGL_texture && n.runtime.glwrap.deleteTexture(s.webGL_texture),
            s.webGL_texture = n.runtime.glwrap.loadTexture(r, !1, n.runtime.linearSampling),
            n.curFrame === s && (n.curWebGLTexture = s.webGL_texture),
        ...
        ,
        "data:" !== t.substr(0, 5) && 0 === i && (r.crossOrigin = "anonymous"),
        this.runtime.setImageSrc(r, t)
    }
    ,
...
function() {
            ...
            if (this.charWidthJSON)
                if (-1 !== this.charWidthJSON.indexOf('""c2array""'))
                    for (var t = (s = jQuery.parseJSON(this.charWidthJSON.replace(/""/g, '"'))).size[1], e = 0; e < t; e++)
                        for (var i = s.data[1][e][0], r = s.data[0][e][0], n = 0; n < i.length; n++)
                            this.characterWidthList[i.charAt(n)] = r;
                else {
                    var s;
                    for (t = (s = jQuery.parseJSON(this.charWidthJSON)).length,
                    e = 0; e < t; e++)
                        for (i = s[e][1],
                        r = s[e][0],
                        n = 0; n < i.length; n++)
    ...
    i.saveToJSON = function() {
        ...
        for (var e in this.characterWidthList)
            t.cw[e] = this.characterWidthList[e];
        return t
    }
    ,
    i.loadFromJSON = function(t) {
    ...
    function o(t, e, i) {
        if (i) {
            ...
            var s;
            for (s in e)
                Object.prototype.hasOwnProperty.call(e, s) && (a(t, e[s]),
                delete e[s])
        }
    }
    function h(t, e, i) {
        ...
        e >= s.length && s.push(l()),
        (n = s[e]).text = i,
        n.width = t.measureWidth(i),
        t.textWidth = cr.max(t.textWidth, n.width)
    }
    var c = [];
    function l() {
        return s(c, Object)
    ...
    i.SplitSheet = function() {
        for (var t, e, i, r, n, a, o = this.texture_img, h = o.width, c = o.height, l = this.characterWidth, u = this.characterHeight, d = l / h, g = u / c, y = this.characterSet, m = Math.floor(h / l), _ = Math.floor(c / u), v = 0; v < y.length && !(v >= m * _); v++) {
            ...
            n = (b + 1) * d,
            a = (w + 1) * g,
            void 0 === t[e = x] && (t[e] = s(f, cr.rect)),
            t[e].left = i,
            t[e].top = r,
            t[e].right = n,
            t[e].bottom = a) : p(this.clipList, x, b * l, w * u, l, u)
        }
    }
    ;
    var g = [];
            ...
            if (r <= 2)
                ...
                if (e.length * (n * s + a) - a <= r && -1 === e.indexOf("\n")) {
                    ...
                    if (o <= r)
                        ...
                        i[0].width = o,
                        t.textWidth = o,
                        void (t.textHeight = t.characterHeight * s + t.lineHeight)
                }
                t.wrapbyword;
                this.WrapText(t),
                t.textHeight = i.length * (t.characterHeight * s + t.lineHeight)
            }
        } else
            u(i)
    }
    ...
    t.WrapText = function(t) {
        var e, i = t.wrapbyword, n = t.text, s = t.lines, o = t.width;
        i ? (this.TokeniseWords(n),
        e = g) : e = n;
        var l, u, p, d = "", f = 0, y = !1;
        for (u = 0; u < e.length; u++)
            ...
            l = d,
            d += e[u],
            t.measureWidth(r(d)) > o && ("" === l ? (h(t, f, d),
            d = "",
            y = !0) : (h(t, f, l),
            d = e[u]),
            f++,
            i || " " !== d || (d = ""))) : (!0 === y ? y = !1 : (h(t, f, d),
            f++),
            d = "");
        for (r(d).length && (h(t, f, d),
        f++),
        u = f; u < s.length; u++)
            p = s[u],
            a(c, p);
    ...
    i.measureWidth = function(t) {
        for (var e = this.characterSpacing, i = t.length, r = 0, n = 0; n < i; n++)
            r += this.getCharacterWidth(t.charAt(n)) * this.characterScale + e;
        return r -= r > 0 ? e : 0
    }
    ,
    ...
    i.draw = function(t, e) {
        ...
        if ("" !== this.text && null != i) {
            ...
            var r = this.x
              , n = this.y;
            this.runtime.pixel_rounding && (r = r + .5 | 0,
            n = n + .5 | 0),
            t.save(),
            t.translate(r, n),
            t.rotate(this.angle);
            for (var s, a = this.halign, o = this.valign, h = this.characterScale, c = this.characterHeight * h, l = this.lineHeight, u = this.characterSpacing, p = this.lines, d = this.textHeight, f = o * cr.max(0, this.height - d), g = -this.hotspotX * this.width, y = -this.hotspotY * this.height, m = y += f, _ = 0; _ < p.length; _++) {
                var v = p[_].text
                  , b = p[_].width;
                s = g + a * cr.max(0, this.width - b),
                m += l;
                for (var w = 0; w < v.length; w++) {
                    var x = v.charAt(w)
                      , S = this.clipList[x];
                    if (s + this.getCharacterWidth(x) * h > this.width + 1e-5)
                        break;
                    void 0 !== S && t.drawImage(this.texture_img, S.x, S.y, S.w, S.h, Math.round(s), Math.round(m), S.w * h, S.h * h),
                    s += this.getCharacterWidth(x) * h + u
                }
                if ((m += c) + c + l > this.height)
                    break
            }
            t.restore()
        }
    ...
    i.drawGL = function(t) {
        ...
        "" !== this.text) {
            ...
            r = (this.y + .5 | 0) - this.y);
            var n, s, a = this.angle, o = this.halign, h = this.valign, c = this.characterScale, l = this.characterHeight * c, u = this.lineHeight, p = this.characterSpacing, d = this.lines, f = this.textHeight;
            0 !== a && (n = Math.cos(a),
            s = Math.sin(a));
            for (var g, _ = h * cr.max(0, this.height - f), v = e.tlx + i, b = e.tly + r, w = _, x = 0; x < d.length; x++) {
                var S = d[x].text
                  , T = d[x].width;
                g = o * cr.max(0, this.width - T),
                w += u;
                for (var O = 0; O < S.length; O++) {
                    var C = S.charAt(O)
                      , A = this.clipUV[C];
                    if (g + this.getCharacterWidth(C) * c > this.width + 1e-5)
                        break;
                    if (void 0 !== A) {
                        ...
                        0 !== a && m(y, n, s),
                        y.offset(v, b),
                        t.quadTex(y.tlx, y.tly, y.trx, y.try_, y.brx, y.bry, y.blx, y.bly, A)
                    }
                    g += this.getCharacterWidth(C) * c + p
                }
                if ((w += l) + l + u > this.height)
                    break
            }
        }
    }
    ...
    ,
    t.cnds = new _,
    v.prototype.SetText = function(t) {
    ...
    i.SetCharWidth = function(t, e) {
        var i = parseInt(e, 10);
        this.characterWidthList[t] !== i && (this.characterWidthList[t] = i,
        this.text_changed = !0,
        this.runtime.redraw = !0)
    }
    ,
    ...
    ,
    t.acts = new v,
    b.prototype.CharacterWidth = function(t, e) {
...
function() {
    ...
    i.onCreate = function() {
        ...
        this.textWidth = 0,
        this.textHeight = 0,
        this.recycled ? (cr.clearArray(this.lines),
        cr.wipe(this.clipList),
        cr.wipe(this.clipUV),
        cr.wipe(this.characterWidthList)) : (this.lines = [],
        this.clipList = {},
    ...
    i.loadFromJSON = function(t) {
        ...
        this.textHeight = t.th,
        this.last_render_tick = t.lrt,
        t.hasOwnProperty("ha") && (this.halign = t.ha),
        t.hasOwnProperty("va") && (this.valign = t.va),
        t.cw)
            this.characterWidthList[e] = t.cw[e];
        this.text_changed = !0,
        this.lastwrapwidth = this.width
    ...
    i.draw = function(t, e) {
        ...
        if ("" !== this.text && null != i) {
            ...
            for (var c, l, u, p, d = this.angle, f = this.halign, g = this.valign, y = this.characterScale, m = this.characterHeight * y, _ = this.lineHeight, v = this.characterSpacing, b = this.lines, w = this.textHeight, x = g * cr.max(0, this.height - w), S = -this.hotspotX * this.width, T = -this.hotspotY * this.height, O = T += x, C = 0; C < b.length; C++) {
                var A = b[C].text
                  , k = b[C].width;
                if (l = S + f * cr.max(0, this.width - k),
                O += _,
                0 === d && n + O + m < a)
                    O += m;
                else {
                    for (var E = 0; E < A.length; E++) {
                        ...
                        if (0 === d && r + l + c * y + v < s)
                            ...
                            if (l + c * y > this.width + 1e-5)
                                break;
                            if (void 0 !== L && (u = l,
                            p = O,
                            0 === d && 1 === y && (u = Math.round(u),
                            p = Math.round(p)),
                            t.drawImage(this.texture_img, L.x, L.y, L.w, L.h, u, p, L.w * y, L.h * y)),
                            l += c * y + v,
                            0 === d && r + l > o)
                                break
                        }
    ...
    i.drawGL = function(t) {
        ...
        !(this.height < this.characterHeight * this.characterScale + this.lineHeight))) {
            ...
            var n, s, a, o = this.layer.viewLeft, h = this.layer.viewTop, c = this.layer.viewRight, l = this.layer.viewBottom, u = this.angle, p = this.halign, d = this.valign, f = this.characterScale, g = this.characterHeight * f, _ = this.lineHeight, v = this.characterSpacing, b = this.lines, w = this.textHeight;
            0 !== u && (s = Math.cos(u),
            a = Math.sin(u));
            for (var x, S, T, O = d * cr.max(0, this.height - w), C = e.tlx + i, A = e.tly + r, k = O, E = 0; E < b.length; E++) {
                var P = b[E].text
                  , L = b[E].width;
                if (x = p * cr.max(0, this.width - L),
                k += _,
                0 === u && A + k + g < h)
                    k += g;
                else {
                    for (var I = 0; I < P.length; I++) {
                        ...
                        if (0 === u && C + x + n * f + v < o)
                            ...
                            if (void 0 !== N) {
                                ...
                                0 !== u && m(y, s, a),
                                y.offset(C, A),
                                t.quadTex(y.tlx, y.tly, y.trx, y.try_, y.brx, y.bry, y.blx, y.bly, N)
                            }
                            if (x += n * f + v,
                            0 === u && C + x > c)
                                break
...
function() {
    ...
    i.draw = function(t) {
        ...
        s < 0 && (s += this.texture_img.width),
        a < 0 && (a += this.texture_img.height),
        t.translate(e, i),
        t.rotate(this.angle),
        t.translate(s, a),
        t.fillRect(r - s, n - a, this.width, this.height),
        t.restore()
    }
    ,
    i.drawGL_earlyZPass = function(t) {
    ...
    i.drawGL = function(t) {
        ...
        if (this.runtime.pixel_rounding) {
            ...
            t.quadTex(i.tlx, i.tly, i.trx, i.try_, i.brx, i.bry, i.blx, i.bly, e)
    }
    ,
    ...
    n.prototype.LoadURL = function(t, e) {
        ...
        i.onload = function() {
            ...
            r.webGL_texture = r.runtime.glwrap.loadTexture(i, !0, r.runtime.linearSampling)) : r.pattern = r.runtime.ctx.createPattern(i, "repeat"),
            r.has_own_texture = !0,
            r.runtime.redraw = !0,
            r.runtime.trigger(cr.plugins_.TiledBg.prototype.cnds.OnURLLoaded, r)
        }
        ,
    ...
    ,
    t.acts = new n,
    s.prototype.ImageWidth = function(t) {
...
function() {
    ...
    function h(t, e, i, r) {
        var n;
        return (n = o.length ? o.pop() : new l).init(t, e, i, r),
        n
    }
    function c(t) {
    ...
    e.onCreate = function() {
        ...
        this.isWindows8) {
            ...
            o && (o.reportInterval = Math.max(o.minimumReportInterval, 16),
            o.addEventListener("readingchanged", n)),
            document.addEventListener("visibilitychange", function(t) {
                document.hidden || document.msHidden ? (s && s.removeEventListener("readingchanged", r),
                o && o.removeEventListener("readingchanged", n)) : (s && s.addEventListener("readingchanged", r),
                o && o.addEventListener("readingchanged", n))
            }, !1)
        } else
    ...
    e.onPointerStart = function(t) {
        if (t.pointerType !== t.MSPOINTER_TYPE_MOUSE && "mouse" !== t.pointerType) {
            ...
            this.touches.push(h(r, n, t.pointerId, this.trigger_index)),
            this.runtime.isInUserInputEvent = !0,
    ...
    e.onTouchStart = function(t) {
        ...
        e = 0,
        r = t.changedTouches.length; e < r; e++)
            if (n = t.changedTouches[e],
            -1 === this.findTouch(n.identifier)) {
                var a = n.pageX - s.left
                  , o = n.pageY - s.top;
                this.trigger_index = this.touches.length,
                this.trigger_id = n.identifier,
                this.touches.push(h(a, o, n.identifier, this.trigger_index)),
                this.runtime.trigger(cr.plugins_.Touch.prototype.cnds.OnNthTouchStart, this),
                this.runtime.trigger(cr.plugins_.Touch.prototype.cnds.OnTouchStart, this),
                this.curTouchX = a,
                this.curTouchY = o,
    ...
    e.onTouchEnd = function(t, e) {
        ...
        r = t.changedTouches.length; i < r; i++)
            ...
            (s = this.findTouch(n.identifier)) >= 0 && (this.trigger_index = this.touches[s].startindex,
    ...
    e.tick2 = function() {
        ...
        e = this.touches.length; t < e; ++t)
            (i = this.touches[t]).time <= r - 50 && (i.lasttime = r),
    ...
    g.prototype.IsTouchingObject = function(t) {
        if (!t)
            return !1;
        var e, i, r, n, s, a, o = t.getCurrentSol(), h = o.getObjects();
        for (r = 0,
        n = h.length; r < n; r++) {
            var c = h[r];
            for (c.update_bbox(),
            s = 0,
            a = this.touches.length; s < a; s++) {
        ...
        return !!y.length && (o.select_all = !1,
        cr.shallowAssignArray(o.instances, y),
        t.applySolToContainer(),
        cr.clearArray(y),
        !0)
    }
    ...
    g.prototype.CompareOrientation = function(t, e, i) {
        var r = 0;
        return r = 0 === t ? this.getAlpha() : 1 === t ? this.getBeta() : this.getGamma(),
        cr.do_cmp(r, e, i)
    }
    ,
    g.prototype.CompareAcceleration = function(t, e, i) {
        var r = 0;
        return 0 === t ? r = this.acc_g_x : 1 === t ? r = this.acc_g_y : 2 === t ? r = this.acc_g_z : 3 === t ? r = this.acc_x : 4 === t ? r = this.acc_y : 5 === t && (r = this.acc_z),
        cr.do_cmp(r, e, i)
    }
    ,
    ...
    m.prototype.X = function(t, e) {
        ...
        o < 0 || o >= this.touches.length ? t.set_float(0) : cr.is_undefined(e) ? (r = (i = this.runtime.getLayerByNumber(0)).scale,
        n = i.zoomRate,
        s = i.parallaxX,
        a = i.angle,
        i.scale = 1,
        ...
        i.parallaxX = 1,
        i.angle = 0,
        t.set_float(i.canvasToLayer(this.touches[o].x, this.touches[o].y, !0)),
        i.scale = r,
        i.zoomRate = n,
        i.parallaxX = s,
        i.angle = a) : (i = cr.is_number(e) ? this.runtime.getLayerByNumber(e) : this.runtime.getLayerByName(e)) ? t.set_float(i.canvasToLayer(this.touches[o].x, this.touches[o].y, !0)) : t.set_float(0)
    }
    ,
    m.prototype.XAt = function(t, e, i) {
        var r, n, s, a, o;
        (e = Math.floor(e)) < 0 || e >= this.touches.length ? t.set_float(0) : cr.is_undefined(i) ? (n = (r = this.runtime.getLayerByNumber(0)).scale,
        s = r.zoomRate,
        a = r.parallaxX,
        o = r.angle,
        r.scale = 1,
        ...
        r.parallaxX = 1,
        r.angle = 0,
        t.set_float(r.canvasToLayer(this.touches[e].x, this.touches[e].y, !0)),
        r.scale = n,
        r.zoomRate = s,
        r.parallaxX = a,
        r.angle = o) : (r = cr.is_number(i) ? this.runtime.getLayerByNumber(i) : this.runtime.getLayerByName(i)) ? t.set_float(r.canvasToLayer(this.touches[e].x, this.touches[e].y, !0)) : t.set_float(0)
    }
    ,
    m.prototype.XForID = function(t, e, i) {
        ...
        if (r < 0)
            ...
            cr.is_undefined(i) ? (s = (n = this.runtime.getLayerByNumber(0)).scale,
            a = n.zoomRate,
            o = n.parallaxX,
            h = n.angle,
            n.scale = 1,
            ...
            n.parallaxX = 1,
            n.angle = 0,
            t.set_float(n.canvasToLayer(c.x, c.y, !0)),
            n.scale = s,
            n.zoomRate = a,
            n.parallaxX = o,
            n.angle = h) : (n = cr.is_number(i) ? this.runtime.getLayerByNumber(i) : this.runtime.getLayerByName(i)) ? t.set_float(n.canvasToLayer(c.x, c.y, !0)) : t.set_float(0)
        }
    }
    ,
    m.prototype.Y = function(t, e) {
        ...
        i.parallaxY = 1,
        i.angle = 0,
        t.set_float(i.canvasToLayer(this.touches[o].x, this.touches[o].y, !1)),
        i.scale = r,
        i.zoomRate = n,
        i.parallaxY = s,
        i.angle = a) : (i = cr.is_number(e) ? this.runtime.getLayerByNumber(e) : this.runtime.getLayerByName(e)) ? t.set_float(i.canvasToLayer(this.touches[o].x, this.touches[o].y, !1)) : t.set_float(0)
    }
    ,
    m.prototype.YAt = function(t, e, i) {
        ...
        r.parallaxY = 1,
        r.angle = 0,
        t.set_float(r.canvasToLayer(this.touches[e].x, this.touches[e].y, !1)),
        r.scale = n,
        r.zoomRate = s,
        r.parallaxY = a,
        r.angle = o) : (r = cr.is_number(i) ? this.runtime.getLayerByNumber(i) : this.runtime.getLayerByName(i)) ? t.set_float(r.canvasToLayer(this.touches[e].x, this.touches[e].y, !1)) : t.set_float(0)
    }
    ,
    m.prototype.YForID = function(t, e, i) {
        ...
        if (r < 0)
            ...
            n.parallaxY = 1,
            n.angle = 0,
            t.set_float(n.canvasToLayer(c.x, c.y, !1)),
            n.scale = s,
            n.zoomRate = a,
            n.parallaxY = o,
            n.angle = h) : (n = cr.is_number(i) ? this.runtime.getLayerByNumber(i) : this.runtime.getLayerByName(i)) ? t.set_float(n.canvasToLayer(c.x, c.y, !1)) : t.set_float(0)
        }
    }
    ,
...
function() {
    ...
    e.tick = function() {
        if (this.enabled) {
            var t, e = this.inst.layer, i = this.inst, r = this.inst.bbox;
            0 === this.anch_left ? (i.update_bbox(),
            0 !== (t = e.viewLeft + this.xleft - r.left) && (i.x += t,
            i.set_bbox_changed())) : 1 === this.anch_left && (i.update_bbox(),
            0 !== (t = e.viewRight - this.xright - r.left) && (i.x += t,
            i.set_bbox_changed())),
            0 === this.anch_top ? (i.update_bbox(),
            0 !== (t = e.viewTop + this.ytop - r.top) && (i.y += t,
            i.set_bbox_changed())) : 1 === this.anch_top && (i.update_bbox(),
            0 !== (t = e.viewBottom - this.ybottom - r.top) && (i.y += t,
            i.set_bbox_changed())),
            1 === this.anch_right && (i.update_bbox(),
            0 !== (t = e.viewRight - this.rdiff - r.right) && (i.width += t,
            i.width < 0 && (i.width = 0),
            i.set_bbox_changed())),
            1 === this.anch_bottom && (i.update_bbox(),
            0 !== (t = e.viewBottom - this.bdiff - r.bottom) && (i.height += t,
...
function() {
    ...
    ,
    t.cnds = new i,
    r.prototype.StartFade = function() {
        this.activeAtStart || this.setMaxOpacity || (this.maxOpacity = this.inst.opacity ? this.inst.opacity : 1,
        ...
        if (this.pinObject) {
            ...
            if (3 === this.mode || 4 === this.mode) {
                ...
                if (i > this.pinDist || 4 === this.mode && i < this.pinDist) {
                    ...
                    t = this.pinObject.x + Math.cos(r) * this.pinDist,
                    e = this.pinObject.y + Math.sin(r) * this.pinDist
                }
            } else
...
function() {
    ...
    ,
    t.Type.prototype.onCreate = function() {
        cr.plugins_.Sprite ? (this.imgptX_get = cr.plugins_.Sprite.prototype.exps.ImagePointX,
        this.imgptY_get = cr.plugins_.Sprite.prototype.exps.ImagePointY) : (this.imgptX_get = null,
    ...
    e.imgptX_get = function(t, e) {
        return this.type.imgptX_get.call(t, i, e),
        i.value
    }
    ,
    e.imgptY_get = function(t, e) {
        return this.type.imgptY_get.call(t, i, e),
        i.value
    }
    ,
    e.tick2 = function() {
        if (this.pinObject && this.type.imgptX_get && this.type.imgptY_get) {
            ...
            if (this.inst.x === t && this.inst.y === e || (this.inst.x = t,
            this.inst.y = e,
            this.inst.set_bbox_changed()),
            1 == this.mode) {
                this.lastKnownAngle !== this.inst.angle && (this.myStartAngle = cr.clamp_angle(this.myStartAngle + (this.inst.angle - this.lastKnownAngle)));
            ...
            1 == this.mode && this.inst.angle !== i && (this.inst.angle = i,
            this.inst.set_bbox_changed())
        }
    }
    ,
    t.cnds = new r,
    r.prototype.IsPinned = function() {
        return !!this.pinObject
    }
    ,
    t.acts = new n,
    n.prototype.Pin = function(t, e, i) {
        if (t) {
    ...
    ,
    t.exps = new s,
    s.prototype.PinnedUID = function(t) {
        t.set_int(this.pinObject ? this.pinObject.uid : -1)
    }
}(),
...
function() {
    ...
    e.updateFromPhase = function() {
        ...
        case 6:
            ...
            this.inst.opacity < 0 ? this.inst.opacity = 0 : this.inst.opacity > 1 && (this.inst.opacity = 1);
            break;
        case 8:
            this.inst.x !== this.lastKnownValue && (this.initialValue += this.inst.x - this.lastKnownValue),
    ...
    ,
    t.cnds = new s,
    a.prototype.SetActive = function(t) {
        this.active = 1 === t
    }
    ,
    ...
    ,
    t.acts = new a,
    o.prototype.CyclePosition = function(t) {
...
function() {
    ...
    ,
    t.cnds = new i,
    r.prototype.StartTimer = function(t, e, i) {
...
function() {
    ...
    e.tick2 = function() {
        if (this.enabled) {
            ...
            (0 != e || 0 != i || 1 === this.behavior.shakeEnforcePosition && this.behavior.shakeStart > 0) && (this.inst.x = this.behavior.shakeEnforcePosition ? this.behavior.shakeOriginalX + e : this.inst.x + e,
            this.inst.y = this.behavior.shakeEnforcePosition ? this.behavior.shakeOriginalY + i : this.inst.y + i,
            this.inst.set_bbox_changed(),
            1 === this.behavior.shakeEnforcePosition && t > this.behavior.shakeEnd && (this.behavior.shakeStart = 0))
        }
    }
    ,
    i.prototype.Shake = function(t, e, i, r) {
        ...
        this.behavior.shakeEnforcePosition = r,
...
function easeOutBouncefunc(t) {
    return (t /= 1) < 1 / 2.75 ? result = 7.5625 * t * t * 1 + 0 : result = t < 2 / 2.75 ? 1 * (7.5625 * (t -= 1.5 / 2.75) * t + .75) + 0 : t < 2.5 / 2.75 ? 1 * (7.5625 * (t -= 2.25 / 2.75) * t + .9375) + 0 : 1 * (7.5625 * (t -= 2.625 / 2.75) * t + .984375) + 0,
    result
}
...
function easeFunc(t, e, i, r, n, s, a) {
    ...
    case 18:
        if (a.optimized)
            o = easeInOutBack[integerize(e, n)];
        else {
            h = a.s;
    ...
    case 19:
        if (a.optimized)
            o = easeInElasticArray[integerize(e, n)];
        else {
            var c = a.a
              , l = a.p;
            h = 0;
            ...
            0 == c || c < Math.abs(r))
                ...
                h = l / (2 * Math.PI) * Math.asin(r / c);
            o = -c * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * n - h) * (2 * Math.PI) / l) + i
        }
        break;
    case 20:
        if (a.optimized)
            o = easeOutElasticArray[integerize(e, n)];
        else {
            c = a.a,
            l = a.p,
            h = 0;
    ...
    case 21:
        if (a.optimized)
            o = easeInOutElasticArray[integerize(e, n)];
        else {
            c = a.a,
            l = a.p,
            h = 0;
...
!function() {
    for (var t = 0, e = 0, i = 0, r = 0, n = 0, s = 0; s <= litetween_precision; s++) {
        if (r = s / litetween_precision,
        t = (r /= 1) < 1 / 2.75 ? 7.5625 * r * r * 1 + 0 : r < 2 / 2.75 ? 1 * (7.5625 * (r -= 1.5 / 2.75) * r + .75) + 0 : r < 2.5 / 2.75 ? 1 * (7.5625 * (r -= 2.25 / 2.75) * r + .9375) + 0 : 1 * (7.5625 * (r -= 2.625 / 2.75) * r + .984375) + 0,
        easeOutBounceArray[s] = t,
        e = 0,
        i = 0,
        0 == (r = s / litetween_precision) && (t = 0),
        1 == (r /= 1) && (t = 1),
        0 == i && (i = .3),
        0 == e || e < Math.abs(1)) {
            e = 1;
            ...
            n = i / (2 * Math.PI) * Math.asin(1 / e);
        if (t = -e * Math.pow(2, 10 * (r -= 1)) * Math.sin((1 * r - n) * (2 * Math.PI) / i) + 0,
        easeInElasticArray[s] = t,
        e = 0,
        i = 0,
        0 == (r = s / litetween_precision) && (t = 0),
        1 == (r /= 1) && (t = 1),
        ...
        0 == e || e < Math.abs(1)) {
            ...
            n = i / (2 * Math.PI) * Math.asin(1 / e);
        if (t = e * Math.pow(2, -10 * r) * Math.sin((1 * r - n) * (2 * Math.PI) / i) + 1 + 0,
        easeOutElasticArray[s] = t,
        e = 0,
        i = 0,
        0 == (r = s / litetween_precision) && (t = 0),
        2 == (r /= .5) && (t = 1),
        ...
        0 == e || e < Math.abs(1)) {
            ...
            n = i / (2 * Math.PI) * Math.asin(1 / e);
        t = r < 1 ? e * Math.pow(2, 10 * (r -= 1)) * Math.sin((1 * r - n) * (2 * Math.PI) / i) * -.5 + 0 : e * Math.pow(2, -10 * (r -= 1)) * Math.sin((1 * r - n) * (2 * Math.PI) / i) * .5 + 1 + 0,
        easeInOutElasticArray[s] = t,
        r = s / litetween_precision,
        easeInCircle[s] = -(Math.sqrt(1 - r * r) - 1),
        r = s / litetween_precision,
        easeOutCircle[s] = Math.sqrt(1 - (r - 1) * (r - 1)),
        r = s / litetween_precision,
        t = (r /= .5) < 1 ? -.5 * (Math.sqrt(1 - r * r) - 1) + 0 : .5 * (Math.sqrt(1 - (r -= 2) * r) + 1) + 0,
        easeInOutCircle[s] = t,
        r = s / litetween_precision,
        0 == (n = 0) && (n = 1.70158),
        t = 1 * (r /= 1) * r * ((n + 1) * r - n) + 0,
        ...
        r = s / litetween_precision,
        0 == (n = 0) && (n = 1.70158),
        t = 1 * ((r = r / 1 - 1) * r * ((n + 1) * r + n) + 1) + 0,
        easeOutBack[s] = t,
        r = s / litetween_precision,
        0 == (n = 0) && (n = 1.70158),
        t = (r /= .5) < 1 ? r * r * ((1 + (n *= 1.525)) * r - n) * .5 + 0 : .5 * ((r -= 2) * r * ((1 + (n *= 1.525)) * r + n) + 2) + 0,
        easeInOutBack[s] = t
    }
}();
var TweenObject = function(t, e, i, r, n, s, a) {
    ...
    for (var o = 0; o < 28; o++)
        this.easingparam[o] = {},
        this.easingparam[o].a = 0,
        this.easingparam[o].p = 0,
        this.easingparam[o].t = 0,
        this.easingparam[o].s = 0,
        this.easingparam[o].optimized = !0
};
function trim(t) {
...
TweenObject.prototype.OnTick = function(t) {
    if (0 === this.state)
        return -1;
    if (1 === this.state && (this.progress += t),
    ...
    if (this.progress > this.duration)
        ...
        1;
    if (this.flipEase)
        var e = easeFunc(this.easefunc, this.duration - this.progress, 0, 1, this.duration, this.flipEase, this.easingparam[this.easefunc]);
    else
        e = easeFunc(this.easefunc, this.progress, 0, 1, this.duration, this.flipEase, this.easingparam[this.easefunc]);
    return e
}
,
...
function() {
    ...
    e.startTween = function(t) {
        for (var e in this.tween_list) {
            ...
            i.onStart = !0,
            i.state = 1),
            1 === t && (i.state = i.lastState),
            2 !== t && 4 !== t || (i.progress = 1e-6,
            i.lastKnownValue = 0,
            i.lastKnownValue2 = 0,
            i.onStart = !0,
            2 == t && (i.state = 4),
    ...
    e.updateTween = function(t, e) {
        if (0 === t.tweened)
            t.enforce ? (this.inst.x = t.initialparam1 + (t.targetparam1 - t.initialparam1) * e,
            ...
            t.enforce ? (this.inst.width = t.initialparam1 + (t.targetparam1 - t.initialparam1) * e,
            ...
            t.enforce ? this.inst.width = t.initialparam1 + (t.targetparam1 - t.initialparam1) * e : (this.inst.width += (t.targetparam1 - t.initialparam1) * e - t.lastKnownValue,
            t.lastKnownValue = (t.targetparam1 - t.initialparam1) * e);
        else if (3 === t.tweened)
            t.enforce ? this.inst.height = t.initialparam2 + (t.targetparam2 - t.initialparam2) * e : (this.inst.height += (t.targetparam2 - t.initialparam2) * e - t.lastKnownValue2,
            t.lastKnownValue2 = (t.targetparam2 - t.initialparam2) * e);
        else if (4 === t.tweened)
            if (t.enforce) {
                ...
                this.inst.angle = cr.clamp_angle(this.inst.angle + cr.to_radians(i)),
                t.lastKnownValue = (t.targetparam1 - t.initialparam1) * e
            }
        else if (5 === t.tweened)
            t.enforce ? this.inst.opacity = (t.initialparam1 + (t.targetparam1 - t.initialparam1) * e) / 100 : (this.inst.opacity += ((t.targetparam1 - t.initialparam1) * e - t.lastKnownValue) / 100,
            t.lastKnownValue = (t.targetparam1 - t.initialparam1) * e);
        else if (6 === t.tweened)
            t.enforce ? this.value = t.initialparam1 + (t.targetparam1 - t.initialparam1) * e : (this.value += (t.targetparam1 - t.initialparam1) * e - t.lastKnownValue,
            t.lastKnownValue = (t.targetparam1 - t.initialparam1) * e);
        else if (7 === t.tweened)
            t.enforce ? this.inst.x = t.initialparam1 + (t.targetparam1 - t.initialparam1) * e : (this.inst.x += (t.targetparam1 - t.initialparam1) * e - t.lastKnownValue,
            t.lastKnownValue = (t.targetparam1 - t.initialparam1) * e);
        else if (8 === t.tweened)
            t.enforce ? this.inst.y = t.initialparam2 + (t.targetparam2 - t.initialparam2) * e : (this.inst.y += (t.targetparam2 - t.initialparam2) * e - t.lastKnownValue2,
            t.lastKnownValue2 = (t.targetparam2 - t.initialparam2) * e);
        else if (9 === t.tweened) {
            var r = t.initialparam1 + (t.targetparam1 - t.initialparam1) * e
              , n = t.initialparam2 + (t.targetparam2 - t.initialparam2) * e;
            this.inst.width < 0 && (r = t.initialparam1 + (t.targetparam1 + t.initialparam1) * -e),
            this.inst.height < 0 && (n = t.initialparam2 + (t.targetparam2 + t.initialparam2) * -e),
            t.enforce ? (this.inst.width = this.inst.curFrame.width * r,
            this.inst.height = this.inst.curFrame.height * n) : (this.inst.width < 0 ? (this.inst.width = r * (this.inst.width / (-1 + t.lastKnownValue)),
            t.lastKnownValue = r + 1) : (this.inst.width = r * (this.inst.width / (1 + t.lastKnownValue)),
            t.lastKnownValue = r - 1),
            this.inst.height < 0 ? (this.inst.height = n * (this.inst.height / (-1 + t.lastKnownValue2)),
            t.lastKnownValue2 = n + 1) : (this.inst.height = n * (this.inst.height / (1 + t.lastKnownValue2)),
            t.lastKnownValue2 = n - 1))
        }
        this.inst.set_bbox_changed()
    }
    ,
    e.tick = function() {
        ...
        if (0 !== e.state) {
            e.onStart && (this.runtime.trigger(cr.behaviors.lunarray_LiteTween.prototype.cnds.OnStart, this.inst),
            e.onStart = !1),
    ...
    i.OnThreshold = function(t, e) {
        ...
        return r && (this.oldthreshold = this.threshold),
        r
    }
    ,
    i.OnStart = function() {
    ...
    r.SetEasingParam = function(t, e, i, r, n) {
        ...
        this.tween_list.default.easingparam[t].t = r,
    ...
    r.SetParameter = function(t, e, i, r, n) {
        if (void 0 === this.tween_list.default)
            this.addToTweenList("default", t, e, initial, i, r, n, 0);
        else {
            var s = this.tween_list.default;
            s.tweened = t,
            s.easefunc = e,
            s.setInitial(this.parseCurrent(t, "current")),
            s.setTarget(this.parseCurrent(t, i)),
            s.duration = r,
            s.enforce = 1 === n
        }
    }
