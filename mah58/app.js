    ...
    here.set_type = function (obj, type) {
        ...
        function app_txt_type(spr) {
            if (here.isIE11) {
                ...
                spr.avk.txt = here.get_text_3d((spr.properties.str ? PROJECT.STR.get(spr.properties.str) : '.'), (spr.properties.sz ? Math.floor(spr.p_h / spr.properties.sz) : spr.p_h), (spr.properties.tint ? '#' + spr.properties.tint.substr(2, 6) : '#FFF95E'));
                spr.addChild(spr.avk.txt);
                spr.avk.img.push(spr.avk.txt);
                spr.avk.txt.spr = spr;
