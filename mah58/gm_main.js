PROJECT.PRT.MAIN = function (app) {
        ...
        if (here.selected_cube) {
            ...
            if (cube.is_free()) {
                ...
                if (cube.game_id != here.selected_cube.game_id) {
                    ...
                    here.selected_cube.material.color.r = 1.25;
                    here.selected_cube.material.color.g = 0.59;
                    here.selected_cube.material.color.b = 0.14;
    ...
    function try_light_cube(cube) {
        ...
        if (here.light_cube.is_free()){
            ...
            here.light_cube.material.color.r = 1.25;
            here.light_cube.material.color.g = 0.59;
            here.light_cube.material.color.b = 0.14;
        }
        else {
