...
// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','game.mjd-loader','game.ark-game-boot','plugins.ark-fonts','plugins.ark-anytween','plugins.ark-loader','plugins.ark-eventbus','plugins.ark-ui-components','plugins.ark-tileimage','plugins.ark-fonts-fnt-reader').defines(function(){var TILES_COUNT=49;new ArkLoader().addResources([{id:'popup_quit_bg',src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_quit_bg.png',resourceType:'image'},{id:'popup_quit_btn',src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_quit_btn.png',resourceType:'image'}]);for(var i=1;i<=TILES_COUNT;i++){new ig.Image('s'+i,{src:'s'+i+'.png',hd:true});}
new ig.Image('slider_guildline',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'slider_guildline.png'});new ig.Image('slider_slider',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'slider_slider.png'});new ig.Image('bullet',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'bullet.png'});new ArkLoader().addResources([{id:'mahjongg_leveldata_0',src:'assets/levels/mahjongg_leveldata_0.xml'},{id:'mahjongg_leveldata_1',src:'assets/levels/mahjongg_leveldata_1.xml'},{id:'mahjongg_leveldata_2',src:'assets/levels/mahjongg_leveldata_2.xml'}],true);new ArkFontManager().registerFont('bitmap-fnt',{src:'adventPro-40.png',fontDescriptorSrc:'adventPro-40.xml',fontName:'AgencyFBBoldFont',fontSize:40});new ArkFontManager().registerFont('bitmap-fnt',{src:'adventPro-60.png',fontDescriptorSrc:'adventPro-60.xml',fontName:'AgencyFBBoldFont',fontSize:60});new ArkFontManager().registerFont('bitmap-fnt',{src:'adventPro-70.png',fontDescriptorSrc:'adventPro-70.xml',fontName:'AgencyFBBoldFont',fontSize:70});new ArkFontManager().registerFont('bitmap-fnt',{src:'adventPro-120.png',fontDescriptorSrc:'adventPro-120.xml',fontName:'AgencyFBBoldFont',fontSize:120});new ArkFontManager().registerFont('bitmap-fnt',{src:'arialbold-22.png',fontDescriptorSrc:'arialbold-22.xml',fontName:'ArialBold',fontSize:22});var fontPrefix='';if(ig.ua.useHD!==true){fontPrefix='sd_';}
new ArkFontManager().registerFont('bitmap-fnt',{src:fontPrefix+'multimatch.png',fontDescriptorSrc:fontPrefix+'multimatch.xml',fontName:'multimatch',fontSize:35});new ArkFontManager().registerFont('bitmap-fnt',{src:fontPrefix+'speedmatch.png',fontDescriptorSrc:fontPrefix+'speedmatch.xml',fontName:'speedmatch',fontSize:35});var soundSprite={url:'assets/sounds/audio-spriteY',map:{'silence':[0,1],'makeAudioWorks':[20.8,0.1],'game_opening_sting':[1.7,5],'click_tile':[8.9,0.5],'level_end':[10.95,2],'out_of_time_sting':[13.96,6],'play_button_press':[20.8,0.3],'reshuffle_1':[22.96,2.5],'rotate':[26.96,0.8],'sfx_multimatch':[29,1.5],'tilematch1':[31.8,2],'tilematch10':[34.85,2.5],'tilematch11':[38.85,2.5],'tilematch12':[42.85,2.5],'tilematch13':[46.85,2.5],'tilematch14':[50.85,2.5],'tilematch15':[53.85,2.5],'tilematch16':[56.85,2.5],'tilematch2':[59.85,2.5],'tilematch3':[63.85,2.5],'tilematch4':[67.85,2.5],'tilematch5':[71.85,2.5],'tilematch6':[75.75,2.5],'tilematch7':[79.85,2.5],'tilematch8':[83.85,2.5],'tilematch9':[87.8,2.5],'correct_sound_1':[91.75,2.5],'correct_sound_2':[95.75,2.5],'correct_sound_3':[99.75,2.5],'error_sound_1':[103.7,1.2],'error_sound_2':[105.7,1.5],'error_sound_3':[108.7,1.2],'timer_warning':[111.7,1.8]}};var musicFileList={'music_loop':'assets/sounds/music_loop'};ARK_game_soundLib=new ARK_soundLib({soundSpriteUrl:soundSprite.url,soundSpriteMap:soundSprite.map,musicList:musicFileList,loadInProgress:function(percent){},loadDone:function(){}});ArkGame=ig.Game.extend({assetScalePath:ig.ua.useHD?"HD/ui/":"SD/ui/",assetsScaleFactor:ig.ua.useHD?2:1,startScreenLogo:new ig.Image('MJD_logo',{src:'MJD_logo.png',hd:true}),uiButtons:new ig.Image('uiButtons',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_options_quit_sound.png'}),uiRotateArrowL:new ig.Image('uiRotateArrowL',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'rotateArrowL.png'}),uiRotateArrowR:new ig.Image('uiRotateArrowR',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'rotateArrowR.png'}),gameBG:new ig.Image('introBG',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'intro_bg.jpg'}),help_speedmatch:new ig.Image('help_speedmatch',{src:'help_icon_04.png',localized:true}),help_multimatch:new ig.Image('help_multimatch',{src:'help_icon_05.png',localized:true}),popup_close:new ig.Image('popupClose',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_close.png'}),popup_help_bg:new ig.Image('popup_help_bg',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_help_bg.png'}),popup_win_bg:new ig.Image('popup_win_bg',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_win_bg.png'}),popup_lose_bg:new ig.Image('popup_lose_bg',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_lose_bg.png'}),popup_options_bg:new ig.Image('popup_options_bg',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_options_bg.png'}),popup_options_bullet:new ig.Image('popup_options_bullet',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'bullet.png'}),popup_quit_bg:new ig.Image('popup_quit_bg',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_quit_bg.png'}),popup_quit_btn:new ig.Image('popup_quit_btn',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_quit_btn.png'}),popup_chrome_btn:new ig.Image('popup_chrome_btn',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_chrome_btn.png'}),popup_help_image_1:new ig.Image('popup_help_image_1',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_1.png'}),popup_help_image_2:new ig.Image('popup_help_image_2',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_2.png'}),popup_help_image_3:new ig.Image('popup_help_image_3',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_3.png'}),popup_help_image_4:new ig.Image('popup_help_image_4',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_4.png'}),popup_help_image_5:new ig.Image('popup_help_image_5',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_5.png'}),popup_help_image_6:new ig.Image('popup_help_image_6',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_6.png'}),popup_help_image_7:new ig.Image('popup_help_image_7',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_7.png'}),popup_help_image_8:new ig.Image('popup_help_image_8',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'help_8.png'}),popup_help_lbtn:new ig.Image('popup_help_lbtn',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_help_lbtn.png'}),popup_help_rbtn:new ig.Image('popup_help_rbtn',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'popup_help_rbtn.png'}),game_icon_timer:new ig.Image('game_icon_timer',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'time_icon.png'}),game_icon_score:new ig.Image('game_icon_score',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'score-icon.png'}),game_icon_preview:new ig.Image('game_icon_preview',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'preview-tile-icon.png'}),game_icon_meTV:new ig.Image('game_icon_meTV',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'meTV-logo.png'}),logoWhite:new ig.Image('logoWhite',{src:'logo-white.svg'}),cubeWhite:new ig.Image('cube_white',{src:'cube_white.png',hd:true}),cubeWhiteSelect:new ig.Image('cube_white_select',{src:'cube_white_select.png',hd:true}),cubeDestroy:new ig.AnimationSheet('cube_destroy',ig.ua.useHD?119:60,ig.ua.useHD?131:66,{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'cube_destroy.png'}),cubeDestroyS:new ig.AnimationSheet('cube_destroyS',ig.ua.useHD?119:60,ig.ua.useHD?131:66,{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'cube_destroy_small.png'}),playAgainButton:new ig.Image('playAgain',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'playAgain.png'}),objectsList:new Array(),degree:0,needDegree:0,time:320,gameInFocus:true,rotateCubeRight:function(){ig.game.needDegree+=90;ig.game.playSound('rotate');ARK_game_arena_connector.fireEventToArena('event_change');},rotateCubeLeft:function(){ig.game.needDegree-=90;ig.game.playSound('rotate');ARK_game_arena_connector.fireEventToArena('event_change');},inputScale:0.5,inputMask:new Object(),cubeApear:0,levelStartX:0,levelStartY:0,reshuffleLeft:0,levelStartXCallibration:0,levelStartYCallibration:0,levelLimit:[0,0,0,0],selectedCube:undefined,absoluteDegree:0,score:0,popupIsOpen:false,isVertical:false,currentLevel:0,lastMatchTime:0,speedMatchComboMult:0,multimatchComboMult:0,lastMatchTileName:null,matchScore:100,lastTimerValue:-1,initialized:false,LAST_LEVEL_INDEX:2,CUBE_PROPERTIES:{cube:{image:null,normal:null,select:null,}},CUBE_HD_PROPERTIES:{cube:{info:{0:[0,0,224,224,0,0],15:[224,0,224,224,0,0],30:[448,0,224,224,0,0],45:[672,0,224,224,0,0],60:[896,0,224,224,0,0],75:[1120,0,224,224,0,0]}}},CUBE_SD_PROPERTIES:{cube:{info:{0:[0,0,112,112,0,0],15:[112,0,112,112,0,0],30:[224,0,112,112,0,0],45:[336,0,112,112,0,0],60:[448,0,112,112,0,0],75:[560,0,112,112,0,0]}}},timeWarningTicker:{},levelData:[],turnSoundOff:navigator.userAgent.match(/Windows Phone/i)||navigator.userAgent.match(/(Silk)/i)||(isAndroid()&&!isChromeBrowser()),prerenderedCubeTilesCache:{},scoreBG:new ig.Image('score_bg',{src:(ig.ua.useHD?"HD/ui/":"SD/ui/")+'score_bg.png'}),initialSoundOn:true,initializationProgress:0,initPhases:null,initPhaseIndex:0,freeSpeedmatchBonusAnimations:[],freeMultimatchBonusAnimations:[],usedSpeedmatchBonusAnimations:[],usedMultimatchBonusAnimations:[],init:function(){this.perormanceMultiplayer=navigator.userAgent.match(/Trident/i)?1:ig.ua.performancePixelRatio===ig.ua.pixelRatio?1:2;ARK_game_soundLib.init();this.initialSoundOn=ARK_game_soundLib.soundStatus();console.log('initialSoundOn = '+this.initialSoundOn);this.CUBE_PROPERTIES.cube.image=ig.game.cubeWhite;this.CUBE_PROPERTIES.cube.normal=ig.game.cubeWhite;this.CUBE_PROPERTIES.cube.select=ig.game.cubeWhiteSelect;ig.merge(this.CUBE_PROPERTIES,ig.ua.useHD?this.CUBE_HD_PROPERTIES:this.CUBE_SD_PROPERTIES);arkCubePositionList.degree=ig.ua.useHD?arkCubePositionList.degreeHD:arkCubePositionList.degreeSD;this.soundsEnabled=true;var div=document.getElementById('game_gameContainer');document.addEventListener("keydown",this.handleKeyDownEvent);ARK_eventbus.on("tilesMatch").register(this.onTilesMatch.bind(this));ARK_eventbus.on("deleteCube").register(this.onCubeDelete.bind(this));ig.game.openPopup=function(name){ig.game.popupIsOpen=true;ig.game.openPopupName=name;ig.modules['plugins.ark-ui'].body().show('over');ig.modules['plugins.ark-ui'].body().show(name);ig.modules['plugins.ark-ui'].body()._findItem(name).alpha=0;ig.modules['plugins.ark-ui'].body()._findItem(name).fade=2;ig.modules['plugins.ark-ui'].body()._findItem('over').alpha=0;ig.modules['plugins.ark-ui'].body()._findItem('over').fade=2;};ig.game.closePopup=function(name){if(ig.game.openPopupName===name){ig.game.openPopupName=null;}
ig.game.popupIsOpen=false;ig.modules['plugins.ark-ui'].body()._findItem(name).alpha=1;ig.modules['plugins.ark-ui'].body()._findItem(name).fade=-2;ig.modules['plugins.ark-ui'].body()._findItem('over').alpha=1;ig.modules['plugins.ark-ui'].body()._findItem('over').fade=-2;setTimeout(function(){if(ig.game.popupIsOpen===false){ig.modules['plugins.ark-ui'].body().hide('over');ig.modules['plugins.ark-ui'].body().hide(name);ARK_renderCubesData.renderTouchCanvas=true;}},1100)};this.tweenAnimationManager=new ArkTweenAnimationManager();this.initPhases=[this.createFont1Phase.bind(this),this.createFont2Phase.bind(this),this.createFont3Phase.bind(this),this.createFont4Phase.bind(this),this.createFont5Phase.bind(this),this.createFont6Phase.bind(this),this.createFont7Phase.bind(this),this.createFont8Phase.bind(this),this.createFont9Phase.bind(this),this.createFont10Phase.bind(this),this.createFont11Phase.bind(this),this.createFont12Phase.bind(this),this.createUIPhase.bind(this),this.createLevelPhase.bind(this)];this.touchCanvas=document.getElementById('touchCanvas');this.touchCanvasContext=this.touchCanvas.getContext('2d');ARK_game_arena_connector.registerAction('pause',this.pause.bind(this,false));ARK_game_arena_connector.registerAction('resume',this.unpause.bind(this,false));ig.modules['plugins.ark-ui'].body().show('over');},handleKeyDownEvent:function(e){"use strict";console.log(e);if(ig.game.needDegree==ig.game.degree){if(e.keyCode===65||e.keyCode===37){ig.game.rotateCubeLeft();}
if(e.keyCode===68||e.keyCode===39){ig.game.rotateCubeRight();}}},startGame:function(){if(ig.game.initialSoundOn){ig.game.playSound('game_opening_sting');}
var bgPath=ig.ua.useHD?"url(assets/images/HD/ui/bg.jpg)":"url(assets/images/SD/ui/bg.jpg)";ARK_gameJQ('#bgCanvas').css({'background-image':bgPath,'background-size':'cover'});ig.system.resizeManager.width=0;ig.modules['plugins.ark-ui'].body().hide('over');ig.modules['plugins.ark-ui'].body()._findItem('over').alpha=1;ig.modules['plugins.ark-ui'].body()._findItem('over').fade=-2;ig.modules['plugins.ark-ui'].body().hide('uiPlayButton');ig.modules['plugins.ark-ui'].body().hide('uiPlayButtonText');ig.modules['plugins.ark-ui'].body().hide('uiVersionNumber');createjs.Tween.removeTweens(ig.game.playButtonAnimationData);ig.modules['plugins.ark-ui'].body().hide('uiMJDLogo');if(ig.system.height<ig.system.width){ig.modules['plugins.ark-ui'].body().show('uiCont');ig.modules['plugins.ark-ui'].body().hide('uiContV');ig.game.isVertical=false;}else{ig.modules['plugins.ark-ui'].body().hide('uiCont');ig.modules['plugins.ark-ui'].body().show('uiContV');ig.game.isVertical=true;}
ig.modules['plugins.ark-ui'].body().show('rotateLeft');ig.modules['plugins.ark-ui'].body().show('rotateRight');ig.modules['plugins.ark-ui'].body().show('scoreCont');ig.modules['plugins.ark-ui'].body().show('timeCont');ig.game.setGameState('game_play');ARK_game_arena_connector.fireEventToArena('game_start');if(ARK_game_soundLib.canPlayMusic()){if(ARK_game_soundLib.musicStatus()){ARK_game_soundLib.playMusic({musicName:'music_loop',looping:true});}}else{var showCorrectSoundButton=function(){if(ig.game.initialSoundOn){if(ig.system.height<ig.system.width){ig.modules['plugins.ark-ui'].body().hide('uiSoundOn');ig.modules['plugins.ark-ui'].body().show('uiSoundOff');}else{ig.modules['plugins.ark-ui'].body().hide('uiSoundOnV');ig.modules['plugins.ark-ui'].body().show('uiSoundOffV');}}else{if(ig.system.height<ig.system.width){ig.modules['plugins.ark-ui'].body().show('uiSoundOn');ig.modules['plugins.ark-ui'].body().hide('uiSoundOff');}else{ig.modules['plugins.ark-ui'].body().show('uiSoundOnV');ig.modules['plugins.ark-ui'].body().hide('uiSoundOffV');}}};showCorrectSoundButton();setTimeout(showCorrectSoundButton,600);}},getInitializationProgress:function(){return this.initializationProgress;},doNextInitPhase:function(){if(this.initPhaseIndex<this.initPhases.length){this.initPhases[this.initPhaseIndex++]();}},createFont1Phase:function(){new ArkFontManager().requireFont('AgencyBold40Yellow','bitmap-fnt','AgencyFBBoldFont',40,{color:'#ffca0b'});ig.game.initializationProgress=0.05;},createFont2Phase:function(){new ArkFontManager().requireFont('AgencyBold40White','bitmap-fnt','AgencyFBBoldFont',40,{color:'#ffffff'});ig.game.initializationProgress=0.1;},createFont3Phase:function(){new ArkFontManager().requireFont('AgencyBold40Black','bitmap-fnt','AgencyFBBoldFont',40,{color:'#000000'});ig.game.initializationProgress=0.1;},createFont4Phase:function(){new ArkFontManager().requireFont('TimeValueWhite','bitmap-fnt','AgencyFBBoldFont',60,{color:'#ffffff'});ig.game.initializationProgress=0.15;},createFont5Phase:function(){new ArkFontManager().requireFont('TimeValueRed','bitmap-fnt','AgencyFBBoldFont',60,{color:'#ff0000'});ig.game.initializationProgress=0.2;},createFont6Phase:function(){new ArkFontManager().requireFont('AgencyBold60White','bitmap-fnt','AgencyFBBoldFont',60,{color:'#ffffff'});ig.game.initializationProgress=0.25;},createFont7Phase:function(){new ArkFontManager().requireFont('AgencyBoldSettings','bitmap-fnt','AgencyFBBoldFont',70,{color:'#66FFFF'});ig.game.initializationProgress=0.3;},createFont8Phase:function(){new ArkFontManager().requireFont('AgencyBold70Blue','bitmap-fnt','AgencyFBBoldFont',70,{color:'#407489'});ig.game.initializationProgress=0.35;},createFont9Phase:function(){new ArkFontManager().requireFont('AgencyBold120Brown','bitmap-fnt','AgencyFBBoldFont',120,{color:'#993f02'});ig.game.initializationProgress=0.4;},createFont10Phase:function(){new ArkFontManager().requireFont('AgencyBold120Blue','bitmap-fnt','AgencyFBBoldFont',120,{color:'#39668c'});ig.game.initializationProgress=0.45;},createFont11Phase:function(){new ArkFontManager().requireFont('ArialBold23White','system','Arial',26,{color:'#ffffff'});ig.game.initializationProgress=0.5;},createFont12Phase:function(){new ArkFontManager().requireFont('ArialBold23Aqua','bitmap-fnt','ArialBold',22,{color:'#08ecef'});ig.game.initializationProgress=0.55;},createUIPhase:function(){createUI();ig.game.initializationProgress=0.85;ARK_game_arena_connector.registerAction("test_action",this.testActionHandler.bind(this));ARK_game_arena_connector.initTestingEnvironment();},testActionHandler:function(params){for(var i=0;i<params.length;i++){var obj=params[i];if(obj.name=="test_object")
{var testingParams=obj.value.split(";");var testing_action=testingParams[0];this.processTestAction(testing_action);break;}}},processTestAction:function(action){switch(action){case"game_end":{break;}
case"play_game":{this.startGame();break;}
case"quit_game":{ARK_game_arena_connector.changeScore(1);this.showGameEndReally();break;}
case"draw_border":{var div=document.createElement('div');div.setAttribute("style","background: #ff0000;position: fixed;z-index: 999999;height: 100%;width: 100%;border: 5px solid #00ff00;box-sizing: border-box;");document.body.appendChild(div);break;}
default:{ARK_game_arena_connector.fireEventToArena(action);}}},createLevelPhase:function(){if(ig.ua.useHD){var scale=2;if(navigator.userAgent.match(/Android/i)){ig.game.cubeDestroy.image.resize(0.01);ig.game.cubeDestroyS.image.resize(scale);ig.game.cubeDestroyS.width=ig.game.cubeDestroyS.width*scale;ig.game.cubeDestroyS.height=ig.game.cubeDestroyS.height*scale;}else{ig.game.cubeDestroyS.image.resize(0.01);ig.game.cubeDestroy.image.resize(scale);ig.game.cubeDestroy.width=ig.game.cubeDestroy.width*scale;ig.game.cubeDestroy.height=ig.game.cubeDestroy.height*scale;}}
...
var bonusesScale=ig.game.levelInfo.scale;var i,bonusObject;for(i=0;i<this.freeSpeedmatchBonusAnimations.length;++i){bonusObject=this.freeSpeedmatchBonusAnimations[i];bonusObject.factorLabel.scale.x=bonusesScale;bonusObject.factorLabel.scale.y=bonusesScale;bonusObject.bonusText.scale.x=bonusesScale;bonusObject.bonusText.scale.y=bonusesScale;}
for(i=0;i<this.freeMultimatchBonusAnimations.length;++i){bonusObject=this.freeMultimatchBonusAnimations[i];bonusObject.factorLabel.scale.x=bonusesScale;bonusObject.factorLabel.scale.y=bonusesScale;bonusObject.bonusText.scale.x=bonusesScale;bonusObject.bonusText.scale.y=bonusesScale;}
for(i=0;i<this.usedSpeedmatchBonusAnimations.length;++i){bonusObject=this.usedSpeedmatchBonusAnimations[i];bonusObject.factorLabel.scale.x=bonusesScale;bonusObject.factorLabel.scale.y=bonusesScale;bonusObject.bonusText.scale.x=bonusesScale;bonusObject.bonusText.scale.y=bonusesScale;}
for(i=0;i<this.usedMultimatchBonusAnimations.length;++i){bonusObject=this.usedMultimatchBonusAnimations[i];bonusObject.factorLabel.scale.x=bonusesScale;bonusObject.factorLabel.scale.y=bonusesScale;bonusObject.bonusText.scale.x=bonusesScale;bonusObject.bonusText.scale.y=bonusesScale;}
...
if(ig.game.currentStateName==='game_play'){if(ig.system.height<ig.system.width*0.8){ig.modules['plugins.ark-ui'].body().show('uiCont');ig.modules['plugins.ark-ui'].body().hide('uiContV');ig.game.isVertical=false;var selectedCubePadding=ig.ua.useHD?205:135;ARK_renderCubesData.selectedCubeY=-(((ig.system.height/2)-(ig.game.levelStartY*ig.game.levelInfo.scale))/ig.game.levelInfo.scale)+(selectedCubePadding*ig.game.levelInfo.scale/ig.game.levelInfo.scale);}else{ig.modules['plugins.ark-ui'].body().hide('uiCont');ig.modules['plugins.ark-ui'].body().show('uiContV');var selectedCubePadding=ig.ua.useHD?105:90;ig.game.isVertical=true;ARK_renderCubesData.selectedCubeY=-(((ig.system.height/2)-(ig.game.levelStartY*ig.game.levelInfo.scale))/ig.game.levelInfo.scale)+(selectedCubePadding*ig.game.levelInfo.scale/ig.game.levelInfo.scale);}}
ARK_renderCubesData.sX=(ig.system.width/2)-(ig.game.levelStartX*ig.game.levelInfo.scale);ARK_renderCubesData.sY=(ig.system.height/2)-(ig.game.levelStartY*ig.game.levelInfo.scale);ARK_renderCubesData.tc_scale=(ig.game.levelInfo.scale*ig.game.inputScale).toFixed(3);},cleanUnusedTileImagesAfterLoad:function(){var i,j,k;var x,y,z;var levelData;var allTileNames={};for(i=1;i<TILES_COUNT;i++){allTileNames['s'+i]=true;}
...
if(!speedmatch&&!multimatch){ig.game.playSound('tilematch1');}},setScore:function(newValue){this.score=newValue;ig.modules['plugins.ark-ui'].body()._findItem('uiScore').text=''+Math.round(ig.game.score).toString().replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g,'$1,');},updateScore:function(deltaValue,reason){this.setScore(this.score+Math.round(deltaValue));ARK_game_arena_connector.changeScore(this.score,reason);},onCubeDelete:function(){--ig.game.levelInfo.tileCount;ig.modules['plugins.ark-ui'].body().hide('game_icon_preview');if(ig.game.levelInfo.tileCount<=0){ig.modules['plugins.ark-ui'].body().show('over');ig.modules['plugins.ark-ui'].body()._findItem('over').alpha=0;if(ig.game.openPopupName!=null){ig.game.closePopup(ig.game.openPopupName);}
...
ig.game.freeMultimatchBonusAnimations.push(this.animationHolder);console.log('multimatch pools: used = '+ig.game.usedMultimatchBonusAnimations.length+', free = '+ig.game.freeMultimatchBonusAnimations.length);});createjs.Tween.get(animationObject.bonusText,{override:true}).to({top:animationObject.bonusText.top-animDistance,alpha:0},animTime).call(function(){ig.modules['plugins.ark-ui'].body().hide(this.name);});ig.modules['plugins.ark-ui'].body().show(animationObject.factorLabel.name);ig.modules['plugins.ark-ui'].body().show(animationObject.bonusText.name);},getMultiMatchAnimationUITemplate:function(index){var multiMatchFactorLabel={name:'multiMatchFactor'+index,text:'X',font:new ArkFontManager().getFont('MultiMatch'),top:0,left:'50%',align:ig.Font.ALIGN.CENTER,scale:.5*ig.game.assetsScaleFactor};var multiMatchText={name:'multiMatchText'+index,text:LocalizationManager.getText('game_play.multimatch.bonus.name'),font:new ArkFontManager().getFont('MultiMatch'),top:40,left:'50%',align:ig.Font.ALIGN.CENTER,scale:.5*ig.game.assetsScaleFactor};return[multiMatchFactorLabel,multiMatchText];},pause:function(isUserAction){ig.game.gameInFocus=false;eachXYZ(ig.game.objectsList,function(obj){obj.fading=-2;});ARK_gameJQ('#focusDrop').show();this.muteSound();this.muteMusic();},unpause:function(isUserAction){ig.game.gameInFocus=true;eachXYZ(ig.game.objectsList,function(obj){obj.fading=2;});ARK_gameJQ('#focusDrop').hide();this.unmuteSound();this.unmuteMusic();ARK_gameJQ("#game_gameContainer").focus();setTimeout((function(){ARK_renderCubesData.prevKnowDegree=ARK_renderCubesData.knowDegree;ig.game.touchCanvasContext.clearRect(0,0,ig.game.touchCanvas.width,ig.game.touchCanvas.height);ARK_renderCubesData.renderTouchCanvas=true;}).bind(this),100)},playSound:function(soundName){if(ig.game.turnSoundOff||!this.soundsEnabled){return}
...
if(this.currentStateName==='game_play'){if(ARK_game_soundLib.canPlayMusic()&&ARK_game_soundLib.musicStatus()){ARK_game_soundLib.playMusic({musicName:'music_loop',looping:true});}}},pageVisibilityHander:function(pageStatus){if(pageStatus==='visible'){this.unpause(false);}else{this.pause(false);}}});});