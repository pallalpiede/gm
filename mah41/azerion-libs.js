...
var _azerionIntegration = {
    ...
    playBtn: true,
    cp: false,
    build: { version: "tc-8", timeStamp: 1686561940572, h: "4ddb89d4" },
...
(() => {
    var i = {
                    ...
                    (e.prototype.emit = function (t, e, n, i, r, o) {
                        ...
                        if (l.fn) {
                            ...
                            for (var c, u = l.length, h = 0; h < u; h++)
                                switch ((l[h].once && this.removeListener(t, l[h].fn, void 0, !0), d)) {
                                    case 1:
                                    ...
                                    case 4:
                                        ...
                                        break;
                                    default:
                                        if (!s) for (c = 1, s = new Array(d - 1); c < d; c++) s[c - 1] = arguments[c];
                        ...
                        Object.defineProperty(e, "__esModule", { value: !0 }),
                            ...
                            (n.prototype.preloadAd = function (t, e, n) {
                                void 0 === t && (t = i.AdType.interstitial),
                                    ...
                                    t === i.AdType.interstitial && this.jioGamesSP.cacheAdMidRoll(e, n),
                                    t === i.AdType.rewarded && this.jioGamesSP.cacheAdRewardedVideo(e, n);
                            }),
                        ...
                        Object.defineProperty(e, "__esModule", { value: !0 }),
                            ...
                            (r.prototype.showAd = function (t) {
                                var e = this,
                                    n =
                                        (void 0 === t && (t = i.AdType.interstitial),
                                        console.log("[Dummy]: Ad type requested = ", t === i.AdType.interstitial ? "interstitial" : "rewarded"),
                    ...
                    (e = function (t, e, r, n) {
                        ...
                        function a(t) {
                            ...
                            (window.GD_OPTIONS = {
                                ...
                                (t = "gamedistribution-jssdk"),
                                (n = (e = document).getElementsByTagName("script")[0]),
                                e.getElementById(t) || (((e = e.createElement("script")).id = t), (e.src = "main.min.js"), n.parentNode && n.parentNode.insertBefore(e, n));
                        }
                        Object.defineProperty(e, "__esModule", { value: !0 }),
                            ...
                            (a.prototype.getBanner = function (t) {
                                return this.adsEnabled
                                    ? ((t = new n.GameDistributionBanner(t)).loadBanner().catch(function () {
                    ...
                    (e = function (t, e, i) {
                        ...
                        function n(t) {
                            ...
                            (this.adsEnabled = !1),
                                ...
                                n.getElementById(e) ||
                                    ((n = n.createElement("script")).addEventListener("load", function () {
                                        r.initialize();
                                    }),
                                    (n.id = e),
        ...
        t = (function t(e) {
            var n = r[e];
            return (void 0 !== n ? n : ((n = r[e] = { exports: {} }), i[e].call(n.exports, n, n.exports, t), n)).exports;
        })(729);
    self.h5ads = t;
})(),
    (function (t, e) {
        ...
        t(function (t, z) {
            ...
            function h(t, e, n) {
                var i, r;
                e.constructor === t.constructor && n === d && e.constructor.resolve === c
                    ? ((i = t),
                      (r = e)._state === B
                          ? f(i, r._result)
                          : r._state === L
                ...
                (this._instanceConstructor = t),
                    ...
                    w(e)
                        ? ((this.length = e.length),
                          ...
                          (0 !== this.length && ((this.length = this.length || 0), this._enumerate(e), 0 !== this._remaining)) || f(this.promise, this._result))
                        : m(this.promise, new Error("Array Methods must be provided an Array"));
            }
            function r(t) {
            ...
            t.exports =
                ...
                (A = (A = t || {}).MutationObserver || A.WebKitMutationObserver),
                ...
                (E = D
                    ...
                    ? ((O = 0),
                      ...
                      D.observe(P, { characterData: !0 }),
                      function () {
                          P.data = O = ++O % 2;
                      })
                    : x
                    ? (((T = new MessageChannel()).port1.onmessage = n),
                      function () {
                ...
                (i.prototype._eachEntry = function (e, t) {
                    ...
                    if (i === c) {
                        ...
                        o === d && e._state !== C
                            ...
                            : n === R
                            ? ((r = new n(u)), s ? m(r, a) : h(r, e, o), this._willSettleAt(r, t))
                            : this._willSettleAt(
                                  new n(function (t) {
                                      return t(e);
                                  }),
        ...
        (o.BrandingDomain = void 0),
            ((T = o.BrandingDomain || (o.BrandingDomain = {}))[(T.Neutral = 0)] = "Neutral"),
            (T[(T.Yepi = 1)] = "Yepi"),
            (T[(T.Spele = 2)] = "Spele"),
        ...
        function p() {}
        (o.UtmTargets = void 0),
            ((T = o.UtmTargets || (o.UtmTargets = {}))[(T.splashscreen = 0)] = "splashscreen"),
            (T[(T.logo = 1)] = "logo"),
            (T[(T.facebook = 2)] = "facebook"),
            (T[(T.twitter = 3)] = "twitter"),
            (T[(T.playstore = 4)] = "playstore"),
            (T[(T.appstore = 5)] = "appstore"),
            (T[(T.more_games = 6)] = "more_games"),
            (T[(T.download_game = 7)] = "download_game"),
            (T[(T.walkthrough = 8)] = "walkthrough"),
            (T[(T.disclaimer = 9)] = "disclaimer"),
            (T[(T.highscores = 10)] = "highscores"),
            (m.getProtocol = function (t) {
                return t ? "https://" : "//";
            }),
            ...
            (m.getPromoURL = function (t, e, n, i, r) {
                return window.hasOwnProperty("_YaSDK") || window.hasOwnProperty("YaGames")
                    ? "https://".concat(h.getYandexBaseURL(), "/games/developer?name=Azerion")
        ...
        w.loadPortalScript = function (t) {
            t &&
                ...
                -1 !== t.minijuegos.indexOf(D.getSourceSite()) &&
                (void 0 !== window.mpConfig ? (window.mpConfig.partner = "orange-games") : (window.mpConfig = { partner: "orange-games" }), g("https://ext.minijuegosgratis.com/external-host/main.js", Date.now() / 1e3)),
                t &&
                    t.hasOwnProperty("kongregate") &&
                    -1 !== t.kongregate.indexOf(D.getSourceSite()) &&
                    g("https://cdn1.kongregate.com/javascripts/kongregate_api.js", Date.now() / 1e3, function () {
        ...
        (A.preload = function (t) {
            ...
            Object.defineProperty(A, "brandingLogoUrl", {
                get: function () {
                    var t;
                    switch (
                        (D.isOnDevice() || h.isAirfi() ? (D.ASSET_LOCATION = "assets/") : "fbrq.io" === D.getSourceSite(!0) && (D.ASSET_LOCATION = "https://" + window.location.host + "/@azerion/splash/assets/"), D.getBrandingDomain())
                    ) {
                        case o.BrandingDomain.Spele:
                            t = "spele";
                            break;
            ...
            (A.hostMatchesList = function (t) {
                t = t || [];
                for (var e = D.getSourceSite(), n = 0; n < t.length; n++) if (e === t[n]) return !0;
                return !1;
            }),
        ...
        (x.loadHost = function () {
            ...
            (x.getSourceSite = function (t) {
                var e = x.HOST;
                return (
                    -1 !== (e = (t = void 0 !== t && t) ? window.location.host : e).indexOf("embed.gamedistribution.com") &&
                                ...
                                !function () {
                                    var c,
                                        ...
                                        v =
                                            ...
                                            (E.prototype.seek = function (t) {
                                                ...
                                                return (
                                                    this._timestamp + t === 0 ||
                                                        ((this._timestamp = e - t), this.isPlaying()) ||
                                                        ((this._isTweening = !0),
                                                        (this._isPaused = !1),
                                                        O(this, this._timestamp, this._delay, this._duration, this._currentState, this._originalState, this._targetState, this._easing, this._step, this._scheduleFunction, e),
                                                        this.pause()),
                                                    this
                                                );
                                            }),
                                            (E.prototype.stop = function (t) {
                                                return (
                                                    ...
                                                    t &&
                                                        (T(this, "beforeTween"),
                                                        x(1, this._currentState, this._originalState, this._targetState, 1, 0, this._easing),
                                                        T(this, "afterTween"),
                                            ...
                                            A(E, { now: f, each: _, tweenProps: x, tweenProp: S, applyFilter: T, shallowCopy: A, defaults: D, composeEasingObject: P }),
                                            "function" == typeof SHIFTY_DEBUG_NOW && (w.timeoutHandler = O),
                                            "object" == typeof j ? (I.exports = E) : void 0 === w.Tweenable && (w.Tweenable = E),
                                            E);
                                    function b() {}
                                    function _(t, e) {
                                    ...
                                    function O(t, e, n, i, r, o, a, s, l, d, c) {
                                        (p = e + n + i),
                                            ...
                                            t.isPlaying() &&
                                                (h
                                                    ? (l(a, t._attachment, p), t.stop(!0))
                                                    : ((t._scheduleId = d(t._timeoutHandler, 1e3 / 60)), T(t, "beforeTween"), u < e + n ? x(1, r, o, a, 1, 1, s) : x(u, r, o, a, i, e + n, s), T(t, "afterTween"), l(r, t._attachment, p)));
                                    }
                                    function P(t, e) {
                                        var n = {},
                                            i = typeof e;
                                    ...
                                    v.shallowCopy(v.prototype.formula, {
                                        ...
                                        ((s = new v())._filterArgs = []),
                                        (v.interpolate = function (t, e, n, i, r) {
                        ...
                        5: [
                            function (t, e, n) {
                                function i(t, e) {
                                    ...
                                    (e = l.extend({ duration: 800, easing: "linear", from: {}, to: {}, step: function () {} }, e)),
                                        (t = l.isString(t) ? document.querySelector(t) : t),
                                        (this.path = t),
                                        (this._opts = e),
                                    ...
                                    (i.prototype.animate = function (t, n, e) {
                                        ...
                                        (this._tweenable = new s()),
                                            this._tweenable.tween({
                                                from: l.extend({ offset: o }, i.from),
                                                to: l.extend({ offset: t }, i.to),
                                                duration: n.duration,
                                                easing: r,
                                                step: function (t) {
                                    ...
                                    (i.prototype._warnContainerAspectRatio = function (t) {
                                        ...
                                        this.containerAspectRatio &&
                                            ...
                                            o.floatEquals(this.containerAspectRatio, n / i) ||
                                                (console.warn("Incorrect aspect ratio of container", "#" + t.id, "detected:", e.getPropertyValue("width") + "(width)", "/", e.getPropertyValue("height") + "(height)", "=", n / i),
                            ...
                            switch (t.label) {
                                case 0:
                                    return (
                                        ...
                                        (this.circleLoader = new S.Circle("#h5branding-bar", { strokeWidth: 3, color: this.options.barColor })),
                        ...
                        return u(this, function (t) {
                            switch (t.label) {
                                ...
                                case 1:
                                    return (
                                        t.sent(),
                                        (e = document.getElementById("h5branding-background")) && (e.style.backgroundColor = _.brandingBackgroundColor),
                                        (e = document.getElementById("h5branding-logo")) &&
                                            D.getBrandingDomain() !== o.BrandingDomain.Neutral &&
                                            (((n = document.createElement("img")).src = _.brandingLogoUrl.replace("_small", "")), e.appendChild(n)),
                                        [2]
                                    );
                            }
                        });
        ...
        (o.Branding = _), (o.Domain = i), (o.Hosts = h), (o.SplashLoader = T), (o.Utils = D), Object.defineProperty(o, "__esModule", { value: !0 });
    });
